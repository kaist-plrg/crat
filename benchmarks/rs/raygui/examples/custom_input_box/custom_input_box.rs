...
pub static mut guiFloatingPointIndex: libc::c_int = 0 as libc::c_int;
unsafe fn main_0() -> libc::c_int {
    InitWindow(
        250 as libc::c_int,
        100 as libc::c_int,
        b"Basic calculator\0" as *const u8 as *const libc::c_char,
    );
    SetTargetFPS(60 as libc::c_int);
    let mut variableA: libc::c_float = 0.0f32;
    let mut variableB: libc::c_float = 0.0f32;
    let mut result: libc::c_float = 0.0f32;
    let mut operation: [libc::c_char; 2] = [0; 2];
    operation[0 as libc::c_int as usize] = '+' as i32 as libc::c_char;
    operation[1 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
    let mut variableAMode: bool = 0 as libc::c_int != 0;
    let mut variableBMode: bool = 0 as libc::c_int != 0;
    while !WindowShouldClose() {
        ...
        if GuiFloatBox(
            ...
            0 as *const libc::c_char,
            &mut variableA,
            -1000000.0f64 as libc::c_int,
            1000000.0f64 as libc::c_int,
            variableAMode,
        ) != 0
        {
            variableAMode = !variableAMode;
        }
        if GuiFloatBox(
            {
                let mut init = Rectangle {
        ...
        {
            variableBMode = !variableBMode;
        }
        if GuiButton(
            {
                let mut init = Rectangle {
                    x: 10 as libc::c_int as libc::c_float,
                    y: 70 as libc::c_int as libc::c_float,
        ...
        if GuiButton(
            {
                let mut init = Rectangle {
                    x: 130 as libc::c_int as libc::c_float,
                    y: 70 as libc::c_int as libc::c_float,
                    width: 50 as libc::c_int as libc::c_float,
                    height: 20 as libc::c_int as libc::c_float,
                };
        ...
        GuiFloatBox(
            {
                let mut init = Rectangle {
                    ...
                    width: 135 as libc::c_int as libc::c_float,
                    height: 20 as libc::c_int as libc::c_float,
                };
                init
            },
...
pub unsafe extern "C" fn GuiFloatBox(
    mut bounds: Rectangle,
    mut text: *const libc::c_char,
    mut value: *mut libc::c_float,
    mut minValue: libc::c_int,
    ...
    if !text.is_null() {
        ...
        textBounds
            ...
            + GuiGetStyle(VALUEBOX as libc::c_int, TEXT_PADDING as libc::c_int)
                as libc::c_float;
        textBounds
            .y = bounds.y + bounds.height / 2.0f32
            - GuiGetStyle(DEFAULT as libc::c_int, TEXT_SIZE as libc::c_int)
        ...
        && !guiLocked && !guiControlExclusiveMode
    {
        ...
        let mut valueHasChanged: bool = 0 as libc::c_int != 0;
        let mut keyCount: libc::c_int = strlen(textValue.as_mut_ptr()) as libc::c_int
        ...
        if editMode {
            ...
            if keyCount < 32 as libc::c_int {
                if (GetTextWidth(textValue.as_mut_ptr()) as libc::c_float) < bounds.width
                {
                    ...
                    {
                        if guiFloatingPointIndex != 0
                            && guiFloatingPointIndex != 4 as libc::c_int
                        {
                            guiFloatingPointIndex -= 1;
                            guiFloatingPointIndex;
                        }
                        textValue[keyCount as usize] = key as libc::c_char;
                        keyCount += 1;
            ...
            if keyCount > 0 as libc::c_int {
                if IsKeyPressed(KEY_BACKSPACE as libc::c_int) {
                    if guiFloatingPointIndex < 4 as libc::c_int {
                        guiFloatingPointIndex += 1;
                        guiFloatingPointIndex;
                    }
                    keyCount -= 1;
            ...
            if IsKeyPressed(KEY_MINUS as libc::c_int) {
                if textValue[0 as libc::c_int as usize] as libc::c_int == '+' as i32 {
                    textValue[0 as libc::c_int as usize] = '-' as i32 as libc::c_char;
                } else if textValue[0 as libc::c_int as usize] as libc::c_int
                    == '-' as i32
                {
                    textValue[0 as libc::c_int as usize] = '+' as i32 as libc::c_char;
                }
            ...
            if (IsKeyPressed(KEY_COMMA as libc::c_int) as libc::c_int != 0
                || IsKeyPressed(KEY_PERIOD as libc::c_int) as libc::c_int != 0)
                && guiFloatingPointIndex == 4 as libc::c_int
            {
                guiFloatingPointIndex -= 1;
                guiFloatingPointIndex;
            ...
            if valueHasChanged {
                *value = atof(textValue.as_mut_ptr()) as libc::c_float;
            }
            if IsKeyPressed(KEY_ENTER as libc::c_int) as libc::c_int != 0
                || !CheckCollisionPointRec(mousePoint, bounds)
                    && IsMouseButtonPressed(MOUSE_BUTTON_LEFT as libc::c_int)
                        as libc::c_int != 0
            {
                guiFloatingPointIndex = 0 as libc::c_int;
                result = 1 as libc::c_int;
            }
        } else {
            if *value > maxValue as libc::c_float {
                *value = maxValue as libc::c_float;
            } else if *value < minValue as libc::c_float {
                *value = minValue as libc::c_float;
            }
            if CheckCollisionPointRec(mousePoint, bounds) {
                state = STATE_FOCUSED;
                if IsMouseButtonPressed(MOUSE_BUTTON_LEFT as libc::c_int) {
    ...
    if state as libc::c_uint == STATE_PRESSED as libc::c_int as libc::c_uint {
        ...
        textValue[(strlen(textValue.as_mut_ptr()) as libc::c_int - guiFloatingPointIndex)
    ...
    if editMode {
        let mut cursor: Rectangle = {
            let mut init = Rectangle {
                x: bounds.x
                    + GetTextWidth(textValue.as_mut_ptr()) as libc::c_float / 2.0f32
                    + bounds.width / 2.0f32 + 1 as libc::c_int as libc::c_float,
                y: bounds.y
                    + 2.0f32
                        * GuiGetStyle(
                            VALUEBOX as libc::c_int,
