...
unsafe fn main_0() -> libc::c_int {
    ...
    let mut screenHeight: libc::c_int = 450 as libc::c_int;
    InitWindow(
        screenWidth,
        screenHeight,
        b"raygui - custom sliders\0" as *const u8 as *const libc::c_char,
    );
    let mut value: libc::c_float = 0.5f32;
    let mut sliderEditMode: bool = 0 as libc::c_int != 0;
    let mut vSliderEditMode: bool = 0 as libc::c_int != 0;
    let mut vSliderBarEditMode: bool = 0 as libc::c_int != 0;
    ...
    while !WindowShouldClose() {
        ...
        if vSliderEditMode as libc::c_int != 0 || vSliderBarEditMode as libc::c_int != 0
        {
            GuiLock();
        } else {
            GuiUnlock();
        ...
        GuiGroupBox(
            {
                let mut init = Rectangle {
                    x: 66 as libc::c_int as libc::c_float,
                    y: 24 as libc::c_int as libc::c_float,
                    width: 276 as libc::c_int as libc::c_float,
                    height: 312 as libc::c_int as libc::c_float,
                };
                init
            },
        ...
        GuiSlider(
            {
                let mut init = Rectangle {
                    ...
                    width: 216 as libc::c_int as libc::c_float,
                    height: 16 as libc::c_int as libc::c_float,
                };
                init
            },
            TextFormat(
                b"%0.2f\0" as *const u8 as *const libc::c_char,
        ...
        value = GuiVerticalSlider(
            {
                let mut init = Rectangle {
                    x: 120 as libc::c_int as libc::c_float,
                    y: 120 as libc::c_int as libc::c_float,
                    width: 24 as libc::c_int as libc::c_float,
                    height: 192 as libc::c_int as libc::c_float,
                };
                init
            },
            TextFormat(
        ...
        value = GuiVerticalSliderBar(
            {
                let mut init = Rectangle {
                    x: 264 as libc::c_int as libc::c_float,
                    y: 120 as libc::c_int as libc::c_float,
                    width: 24 as libc::c_int as libc::c_float,
                    height: 192 as libc::c_int as libc::c_float,
                };
        ...
        GuiGroupBox(
            {
                let mut init = Rectangle {
                    x: 378 as libc::c_int as libc::c_float,
                    y: 24 as libc::c_int as libc::c_float,
                    width: 276 as libc::c_int as libc::c_float,
                    height: 312 as libc::c_int as libc::c_float,
                };
            ...
            b"OWNING\0" as *const u8 as *const libc::c_char,
        );
        if GuiSliderOwning(
            {
                let mut init = Rectangle {
                    x: 408 as libc::c_int as libc::c_float,
                    y: 48 as libc::c_int as libc::c_float,
                    width: 216 as libc::c_int as libc::c_float,
                    height: 16 as libc::c_int as libc::c_float,
                };
        ...
        if GuiVerticalSliderOwning(
            ...
            vSliderEditMode = !vSliderEditMode;
        }
        if GuiVerticalSliderBarOwning(
            {
                let mut init = Rectangle {
                    x: 576 as libc::c_int as libc::c_float,
                    y: 120 as libc::c_int as libc::c_float,
                    width: 24 as libc::c_int as libc::c_float,
                    height: 192 as libc::c_int as libc::c_float,
                };
            ...
            vSliderBarEditMode = !vSliderBarEditMode;
        }
        EndDrawing();
    }
    CloseWindow();
...
pub unsafe extern "C" fn GuiVerticalSliderPro(
    mut bounds: Rectangle,
    mut textTop: *const libc::c_char,
    mut textBottom: *const libc::c_char,
    mut value: libc::c_float,
    mut minValue: libc::c_float,
    mut maxValue: libc::c_float,
    mut sliderHeight: libc::c_int,
) -> libc::c_float {
    let mut state: GuiState = GuiGetState() as GuiState;
    let mut sliderValue: libc::c_int = ((value - minValue) / (maxValue - minValue)
        * (bounds.height
            - (2 as libc::c_int
                * GuiGetStyle(SLIDER as libc::c_int, BORDER_WIDTH as libc::c_int))
                as libc::c_float)) as libc::c_int;
    let mut slider: Rectangle = {
        let mut init = Rectangle {
            x: bounds.x
                ...
                + GuiGetStyle(SLIDER as libc::c_int, SLIDER_PADDING as libc::c_int)
                    as libc::c_float,
            y: bounds.y + bounds.height - sliderValue as libc::c_float,
            width: bounds.width
                - (2 as libc::c_int
                    * GuiGetStyle(SLIDER as libc::c_int, BORDER_WIDTH as libc::c_int))
                    as libc::c_float
    ...
    if sliderHeight > 0 as libc::c_int {
        slider.y -= (sliderHeight / 2 as libc::c_int) as libc::c_float;
        slider.height = sliderHeight as libc::c_float;
    } else if sliderHeight == 0 as libc::c_int {
        slider.y
            -= GuiGetStyle(SLIDER as libc::c_int, BORDER_WIDTH as libc::c_int)
                as libc::c_float;
        slider.height = sliderValue as libc::c_float;
    }
    if state as libc::c_uint != STATE_DISABLED as libc::c_int as libc::c_uint
        && !guiLocked
    {
        ...
        if CheckCollisionPointRec(mousePoint, bounds) {
            if IsMouseButtonDown(MOUSE_BUTTON_LEFT as libc::c_int) {
                state = STATE_PRESSED;
                let mut normalizedValue: libc::c_float = (bounds.y + bounds.height
                    - mousePoint.y - (sliderHeight / 2 as libc::c_int) as libc::c_float)
                    / (bounds.height - sliderHeight as libc::c_float);
                ...
                if sliderHeight > 0 as libc::c_int {
                    ...
                    slider
                        .height = bounds.y + bounds.height - slider.y
                        - GuiGetStyle(SLIDER as libc::c_int, BORDER_WIDTH as libc::c_int)
                            as libc::c_float;
                }
            } else {
    ...
    if sliderHeight > 0 as libc::c_int {
                    ...
                    as libc::c_float
        {
            slider
                ...
                + GuiGetStyle(SLIDER as libc::c_int, BORDER_WIDTH as libc::c_int)
                    as libc::c_float;
        } else if slider.y + slider.height >= bounds.y + bounds.height {
            slider
                .y = bounds.y + bounds.height - slider.height
                - GuiGetStyle(SLIDER as libc::c_int, BORDER_WIDTH as libc::c_int)
                    as libc::c_float;
        }
    } else if sliderHeight == 0 as libc::c_int {
            ...
            GetColor(
                GuiGetStyle(
                    ...
                    if state as libc::c_uint
                        != STATE_DISABLED as libc::c_int as libc::c_uint
                    {
                        BASE_COLOR_NORMAL as libc::c_int
                    } else {
                        BASE_COLOR_DISABLED as libc::c_int
    ...
    if state as libc::c_uint == STATE_NORMAL as libc::c_int as libc::c_uint
        || state as libc::c_uint == STATE_PRESSED as libc::c_int as libc::c_uint
    {
        GuiDrawRectangle(
            slider,
            0 as libc::c_int,
    ...
    if !textTop.is_null() {
        ...
        textBounds.width = GetTextWidth(textTop) as libc::c_float;
        textBounds
            .height = GuiGetStyle(DEFAULT as libc::c_int, TEXT_SIZE as libc::c_int)
            as libc::c_float;
        textBounds
    ...
    if !textBottom.is_null() {
        ...
        textBounds_0.width = GetTextWidth(textBottom) as libc::c_float;
        textBounds_0
            .height = GuiGetStyle(DEFAULT as libc::c_int, TEXT_SIZE as libc::c_int)
            as libc::c_float;
        textBounds_0
            .x = bounds.x + bounds.width / 2 as libc::c_int as libc::c_float
            - textBounds_0.width / 2 as libc::c_int as libc::c_float;
        textBounds_0
...
pub unsafe extern "C" fn GuiVerticalSlider(
    mut bounds: Rectangle,
    mut textTop: *const libc::c_char,
    mut textBottom: *const libc::c_char,
    mut value: libc::c_float,
...
pub unsafe extern "C" fn GuiVerticalSliderBar(
    mut bounds: Rectangle,
    mut textTop: *const libc::c_char,
    mut textBottom: *const libc::c_char,
    mut value: libc::c_float,
...
pub unsafe extern "C" fn GuiSliderProOwning(
    mut bounds: Rectangle,
    mut textLeft: *const libc::c_char,
    mut textRight: *const libc::c_char,
    mut value: *mut libc::c_float,
    ...
    let mut state: GuiState = GuiGetState() as GuiState;
    let mut tempValue: libc::c_float = *value;
    let mut pressed: bool = 0 as libc::c_int != 0;
    let mut sliderValue: libc::c_int = ((tempValue - minValue) / (maxValue - minValue)
        * (bounds.width
            - (2 as libc::c_int
                * GuiGetStyle(SLIDER as libc::c_int, BORDER_WIDTH as libc::c_int))
                as libc::c_float)) as libc::c_int;
    ...
    if sliderWidth > 0 as libc::c_int {
        slider.x += (sliderValue - sliderWidth / 2 as libc::c_int) as libc::c_float;
        slider.width = sliderWidth as libc::c_float;
    } else if sliderWidth == 0 as libc::c_int {
        slider.x
            += GuiGetStyle(SLIDER as libc::c_int, BORDER_WIDTH as libc::c_int)
                as libc::c_float;
        slider.width = sliderValue as libc::c_float;
    }
    if state as libc::c_uint != STATE_DISABLED as libc::c_int as libc::c_uint
        && (editMode as libc::c_int != 0 || !guiLocked)
    {
        let mut mousePoint: Vector2 = GetMousePosition();
        if IsMouseButtonPressed(MOUSE_BUTTON_LEFT as libc::c_int) {
            if CheckCollisionPointRec(mousePoint, bounds) {
        ...
        } else if IsMouseButtonReleased(MOUSE_BUTTON_LEFT as libc::c_int) as libc::c_int
            != 0 && editMode as libc::c_int != 0
        {
            pressed = 1 as libc::c_int != 0;
        }
        if editMode {
            ...
            tempValue = (maxValue - minValue)
                * (mousePoint.x
                    - (bounds.x + (sliderWidth / 2 as libc::c_int) as libc::c_float))
                / (bounds.width - sliderWidth as libc::c_float) + minValue;
            if sliderWidth > 0 as libc::c_int {
                slider
                    .x = mousePoint.x - slider.width / 2 as libc::c_int as libc::c_float;
            } else if sliderWidth == 0 as libc::c_int {
                slider.width = sliderValue as libc::c_float;
            }
        } else if CheckCollisionPointRec(mousePoint, bounds) {
...
pub unsafe extern "C" fn GuiSliderOwning(
    mut bounds: Rectangle,
    mut textLeft: *const libc::c_char,
    mut textRight: *const libc::c_char,
    mut value: *mut libc::c_float,
...
pub unsafe extern "C" fn GuiSliderBarOwning(
    mut bounds: Rectangle,
    mut textLeft: *const libc::c_char,
    mut textRight: *const libc::c_char,
    mut value: *mut libc::c_float,
...
pub unsafe extern "C" fn GuiVerticalSliderProOwning(
    mut bounds: Rectangle,
    mut textTop: *const libc::c_char,
    mut textBottom: *const libc::c_char,
    mut value: *mut libc::c_float,
...
pub unsafe extern "C" fn GuiVerticalSliderOwning(
    mut bounds: Rectangle,
    mut textTop: *const libc::c_char,
    mut textBottom: *const libc::c_char,
    mut value: *mut libc::c_float,
    ...
    return GuiVerticalSliderProOwning(
        bounds,
        textTop,
        textBottom,
        value,
...
pub unsafe extern "C" fn GuiVerticalSliderBarOwning(
    mut bounds: Rectangle,
    mut textTop: *const libc::c_char,
    mut textBottom: *const libc::c_char,
    mut value: *mut libc::c_float,
