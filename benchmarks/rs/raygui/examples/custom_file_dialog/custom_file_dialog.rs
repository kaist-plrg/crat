...
extern "C" {
    ...
    fn FileExists(fileName: *const libc::c_char) -> bool;
    fn DirectoryExists(dirPath: *const libc::c_char) -> bool;
    ...
    fn GetPrevDirectoryPath(dirPath: *const libc::c_char) -> *const libc::c_char;
    fn GetWorkingDirectory() -> *const libc::c_char;
    fn IsPathFile(path: *const libc::c_char) -> bool;
    fn LoadDirectoryFilesEx(
        basePath: *const libc::c_char,
    ...
    fn LoadTexture(fileName: *const libc::c_char) -> Texture2D;
    ...
    fn TextIsEqual(text1: *const libc::c_char, text2: *const libc::c_char) -> bool;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct GuiWindowFileDialogState {
    pub windowActive: bool,
    pub windowBounds: Rectangle,
    pub panOffset: Vector2,
    pub dragMode: bool,
    pub supportDrag: bool,
    pub dirPathEditMode: bool,
    pub dirPathText: [libc::c_char; 1024],
    pub filesListScrollIndex: libc::c_int,
    pub filesListEditMode: bool,
    pub filesListActive: libc::c_int,
    pub fileNameEditMode: bool,
    pub fileNameText: [libc::c_char; 1024],
    pub SelectFilePressed: bool,
    pub CancelFilePressed: bool,
    pub fileTypeActive: libc::c_int,
    pub itemFocused: libc::c_int,
    pub dirFiles: FilePathList,
    pub filterExt: [libc::c_char; 256],
    pub dirPathTextCopy: [libc::c_char; 1024],
    pub fileNameTextCopy: [libc::c_char; 1024],
    pub prevFilesListActive: libc::c_int,
    pub saveFileMode: bool,
}
pub type FileInfo = *mut libc::c_char;
...
pub static mut dirFilesIcon: *mut FileInfo = 0 as *const FileInfo as *mut FileInfo;
pub unsafe extern "C" fn InitGuiWindowFileDialog(
    mut initPath: *const libc::c_char,
) -> GuiWindowFileDialogState {
    let mut state: GuiWindowFileDialogState = {
        let mut init = GuiWindowFileDialogState {
            windowActive: 0 as libc::c_int != 0,
            ...
            filterExt: [0; 256],
            dirPathTextCopy: [0; 1024],
            fileNameTextCopy: [0; 1024],
            prevFilesListActive: 0,
            saveFileMode: false,
        };
        init
    };
    state
        .windowBounds = {
        let mut init = Rectangle {
            x: (GetScreenWidth() / 2 as libc::c_int
                - 440 as libc::c_int / 2 as libc::c_int) as libc::c_float,
            y: (GetScreenHeight() / 2 as libc::c_int
                - 310 as libc::c_int / 2 as libc::c_int) as libc::c_float,
            width: 440 as libc::c_int as libc::c_float,
            height: 310 as libc::c_int as libc::c_float,
        };
        init
    };
    state.windowActive = 0 as libc::c_int != 0;
    state.supportDrag = 1 as libc::c_int != 0;
    state.dragMode = 0 as libc::c_int != 0;
    state
        .panOffset = {
        let mut init = Vector2 {
            x: 0 as libc::c_int as libc::c_float,
    ...
    state.dirPathEditMode = 0 as libc::c_int != 0;
    state.filesListActive = -(1 as libc::c_int);
    state.prevFilesListActive = state.filesListActive;
    state.filesListScrollIndex = 0 as libc::c_int;
    state.fileNameEditMode = 0 as libc::c_int != 0;
    state.SelectFilePressed = 0 as libc::c_int != 0;
    state.CancelFilePressed = 0 as libc::c_int != 0;
    state.fileTypeActive = 0 as libc::c_int;
    strcpy(
        (state.fileNameText).as_mut_ptr(),
        b"\0\0" as *const u8 as *const libc::c_char,
    );
    if !initPath.is_null() && DirectoryExists(initPath) as libc::c_int != 0 {
        strcpy((state.dirPathText).as_mut_ptr(), initPath);
    } else if !initPath.is_null() && FileExists(initPath) as libc::c_int != 0 {
        strcpy((state.dirPathText).as_mut_ptr(), GetDirectoryPath(initPath));
        strcpy((state.fileNameText).as_mut_ptr(), GetFileName(initPath));
    } else {
        strcpy((state.dirPathText).as_mut_ptr(), GetWorkingDirectory());
    }
    strcpy((state.dirPathTextCopy).as_mut_ptr(), (state.dirPathText).as_mut_ptr());
    strcpy((state.fileNameTextCopy).as_mut_ptr(), (state.fileNameText).as_mut_ptr());
    state.filterExt[0 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
    state.dirFiles.count = 0 as libc::c_int as libc::c_uint;
    return state;
}
pub unsafe extern "C" fn GuiWindowFileDialog(mut state: *mut GuiWindowFileDialogState) {
    if (*state).windowActive {
        if (*state).supportDrag {
            ...
            if IsMouseButtonPressed(MOUSE_BUTTON_LEFT as libc::c_int) {
                if CheckCollisionPointRec(
                    ...
                    (*state).dragMode = 1 as libc::c_int != 0;
            ...
            if (*state).dragMode {
                ...
                if (*state).windowBounds.x < 0 as libc::c_int as libc::c_float {
                    (*state).windowBounds.x = 0 as libc::c_int as libc::c_float;
                } else if (*state).windowBounds.x
                    > GetScreenWidth() as libc::c_float - (*state).windowBounds.width
                {
                    (*state)
                        .windowBounds
                        .x = GetScreenWidth() as libc::c_float
                        - (*state).windowBounds.width;
                }
                if (*state).windowBounds.y < 0 as libc::c_int as libc::c_float {
                    (*state).windowBounds.y = 0 as libc::c_int as libc::c_float;
                } else if (*state).windowBounds.y
                    > GetScreenHeight() as libc::c_float - (*state).windowBounds.height
                {
                    (*state)
                        .windowBounds
                        .y = GetScreenHeight() as libc::c_float
        ...
        if dirFilesIcon.is_null() {
            dirFilesIcon = calloc(
                2048 as libc::c_int as libc::c_ulong,
                ::std::mem::size_of::<FileInfo>() as libc::c_ulong,
            ) as *mut FileInfo;
            let mut i: libc::c_int = 0 as libc::c_int;
            while i < 2048 as libc::c_int {
                let ref mut fresh2 = *dirFilesIcon.offset(i as isize);
                *fresh2 = calloc(
        ...
        if ((*state).dirFiles.paths).is_null() {
            ReloadDirectoryFiles(state);
        }
        (*state)
            .windowActive = GuiWindowBox(
            (*state).windowBounds,
            b"#198# Select File Dialog\0" as *const u8 as *const libc::c_char,
        ) == 0;
        if GuiButton(
            {
                let mut init = Rectangle {
                    x: (*state).windowBounds.x + (*state).windowBounds.width
                        - 48 as libc::c_int as libc::c_float,
                    y: (*state).windowBounds.y + 24 as libc::c_int as libc::c_float
                        + 12 as libc::c_int as libc::c_float,
                    width: 40 as libc::c_int as libc::c_float,
                    height: 24 as libc::c_int as libc::c_float,
                };
                init
            },
        ...
        {
            strcpy(
                ((*state).dirPathText).as_mut_ptr(),
                GetPrevDirectoryPath(((*state).dirPathText).as_mut_ptr()),
            );
            ReloadDirectoryFiles(state);
            (*state).filesListActive = -(1 as libc::c_int);
            memset(
                ((*state).fileNameText).as_mut_ptr() as *mut libc::c_void,
                0 as libc::c_int,
                1024 as libc::c_int as libc::c_ulong,
            );
            memset(
                ((*state).fileNameTextCopy).as_mut_ptr() as *mut libc::c_void,
                0 as libc::c_int,
                1024 as libc::c_int as libc::c_ulong,
            );
        }
        if GuiTextBox(
            {
                let mut init = Rectangle {
                    x: (*state).windowBounds.x + 8 as libc::c_int as libc::c_float,
                    y: (*state).windowBounds.y + 24 as libc::c_int as libc::c_float
                        + 12 as libc::c_int as libc::c_float,
                    width: (*state).windowBounds.width
                        - 48 as libc::c_int as libc::c_float
        ...
        ) != 0
        {
            if (*state).dirPathEditMode {
                if DirectoryExists(((*state).dirPathText).as_mut_ptr()) {
                    ReloadDirectoryFiles(state);
                    strcpy(
                        ((*state).dirPathTextCopy).as_mut_ptr(),
                        ((*state).dirPathText).as_mut_ptr(),
                    );
                } else {
                    strcpy(
        ...
        let mut prevElementsHeight: libc::c_int = GuiGetStyle(
            LISTVIEW as libc::c_int,
            LIST_ITEMS_HEIGHT as libc::c_int,
        );
        GuiSetStyle(
        ...
        GuiListViewEx(
            {
                let mut init = Rectangle {
                    x: (*state).windowBounds.x + 8 as libc::c_int as libc::c_float,
                    y: (*state).windowBounds.y + 48 as libc::c_int as libc::c_float
            ...
            dirFilesIcon as *mut *const libc::c_char,
            (*state).dirFiles.count as libc::c_int,
            &mut (*state).filesListScrollIndex,
            &mut (*state).filesListActive,
            &mut (*state).itemFocused,
        );
        GuiSetStyle(
            LISTVIEW as libc::c_int,
            TEXT_ALIGNMENT as libc::c_int,
        ...
        if (*state).filesListActive >= 0 as libc::c_int
            && (*state).filesListActive != (*state).prevFilesListActive
        {
            strcpy(
                ((*state).fileNameText).as_mut_ptr(),
                GetFileName(
                    *((*state).dirFiles.paths).offset((*state).filesListActive as isize),
                ),
            );
            if DirectoryExists(
                TextFormat(
                    ...
                    strcpy(
                        ...
                        TextFormat(
                            ...
                            ) == 0 as libc::c_int
                            {
                                ...
                                ((*state).dirPathText).as_mut_ptr() as *const libc::c_char
                            },
                            ((*state).fileNameText).as_mut_ptr(),
                        ),
                    );
                ...
                strcpy(
                    ((*state).fileNameTextCopy).as_mut_ptr(),
                    ((*state).fileNameText).as_mut_ptr(),
                );
            }
            (*state).prevFilesListActive = (*state).filesListActive;
        ...
        GuiLabel(
            {
                let mut init = Rectangle {
                    x: (*state).windowBounds.x + 8 as libc::c_int as libc::c_float,
                    y: (*state).windowBounds.y + (*state).windowBounds.height
                        - 68 as libc::c_int as libc::c_float,
                    width: 60 as libc::c_int as libc::c_float,
                    height: 24 as libc::c_int as libc::c_float,
                };
                init
            },
        ...
        if GuiTextBox(
            {
                let mut init = Rectangle {
                    x: (*state).windowBounds.x + 72 as libc::c_int as libc::c_float,
                    y: (*state).windowBounds.y + (*state).windowBounds.height
                        - 68 as libc::c_int as libc::c_float,
                    width: (*state).windowBounds.width
                        - 184 as libc::c_int as libc::c_float,
                    height: 24 as libc::c_int as libc::c_float,
                };
                init
            },
        ...
        {
            if *((*state).fileNameText).as_mut_ptr() != 0 {
                if FileExists(
                    TextFormat(
                        b"%s/%s\0" as *const u8 as *const libc::c_char,
                        ((*state).dirPathText).as_mut_ptr(),
                    ...
                    let mut i_0: libc::c_int = 0 as libc::c_int;
                    while (i_0 as libc::c_uint) < (*state).dirFiles.count {
                        if TextIsEqual(
                            ((*state).fileNameText).as_mut_ptr(),
                            *((*state).dirFiles.paths).offset(i_0 as isize),
                        ) {
                            (*state).filesListActive = i_0;
                            strcpy(
                                ((*state).fileNameTextCopy).as_mut_ptr(),
                                ((*state).fileNameText).as_mut_ptr(),
                            );
        ...
        GuiLabel(
            {
                let mut init = Rectangle {
                    ...
                    y: (*state).windowBounds.y + (*state).windowBounds.height
                        - 24 as libc::c_int as libc::c_float
                        - 12 as libc::c_int as libc::c_float,
                    width: 68 as libc::c_int as libc::c_float,
                    height: 24 as libc::c_int as libc::c_float,
                };
                init
            },
            b"File filter:\0" as *const u8 as *const libc::c_char,
        );
        GuiComboBox(
            {
                let mut init = Rectangle {
            ...
            b"All files\0" as *const u8 as *const libc::c_char,
            &mut (*state).fileTypeActive,
        );
        (*state)
            .SelectFilePressed = GuiButton(
            {
                let mut init = Rectangle {
                    ...
                    y: (*state).windowBounds.y + (*state).windowBounds.height
                        - 68 as libc::c_int as libc::c_float,
                    width: 96 as libc::c_int as libc::c_float,
                    height: 24 as libc::c_int as libc::c_float,
                };
                init
            },
        ...
        if !(*state).windowActive {
            let mut i_1: libc::c_int = 0 as libc::c_int;
            while i_1 < 2048 as libc::c_int {
                free(*dirFilesIcon.offset(i_1 as isize) as *mut libc::c_void);
                i_1 += 1;
                i_1;
            }
            free(dirFilesIcon as *mut libc::c_void);
            dirFilesIcon = 0 as *mut FileInfo;
            UnloadDirectoryFiles((*state).dirFiles);
            (*state).dirFiles.count = 0 as libc::c_int as libc::c_uint;
            (*state).dirFiles.capacity = 0 as libc::c_int as libc::c_uint;
            (*state).dirFiles.paths = 0 as *mut *mut libc::c_char;
        }
    }
}
unsafe extern "C" fn ReloadDirectoryFiles(mut state: *mut GuiWindowFileDialogState) {
    UnloadDirectoryFiles((*state).dirFiles);
    (*state)
        .dirFiles = LoadDirectoryFilesEx(
        ((*state).dirPathText).as_mut_ptr(),
        if (*state).filterExt[0 as libc::c_int as usize] as libc::c_int == '\0' as i32 {
            0 as *mut libc::c_char
        } else {
            ((*state).filterExt).as_mut_ptr()
        },
        0 as libc::c_int != 0,
    );
    (*state).itemFocused = 0 as libc::c_int;
    let mut i: libc::c_int = 0 as libc::c_int;
    while i < 2048 as libc::c_int {
        memset(
            *dirFilesIcon.offset(i as isize) as *mut libc::c_void,
            0 as libc::c_int,
            512 as libc::c_int as libc::c_ulong,
        );
        i += 1;
    ...
    let mut i_0: libc::c_int = 0 as libc::c_int;
    while (i_0 as libc::c_uint) < (*state).dirFiles.count {
        if IsPathFile(*((*state).dirFiles.paths).offset(i_0 as isize)) {
            if IsFileExtension(
                *((*state).dirFiles.paths).offset(i_0 as isize),
                b".png;.bmp;.tga;.gif;.jpg;.jpeg;.psd;.hdr;.qoi;.dds;.pkm;.ktx;.pvr;.astc\0"
                    as *const u8 as *const libc::c_char,
            ) {
                strcpy(
                    *dirFilesIcon.offset(i_0 as isize),
                    TextFormat(
                        b"#12#%s\0" as *const u8 as *const libc::c_char,
                        GetFileName(*((*state).dirFiles.paths).offset(i_0 as isize)),
                    ),
                );
            } else if IsFileExtension(
                *((*state).dirFiles.paths).offset(i_0 as isize),
                b".wav;.mp3;.ogg;.flac;.xm;.mod;.it;.wma;.aiff\0" as *const u8
                    as *const libc::c_char,
            ) {
                strcpy(
                    *dirFilesIcon.offset(i_0 as isize),
                    TextFormat(
                        b"#11#%s\0" as *const u8 as *const libc::c_char,
                        GetFileName(*((*state).dirFiles.paths).offset(i_0 as isize)),
                    ),
                );
            } else if IsFileExtension(
                *((*state).dirFiles.paths).offset(i_0 as isize),
                b".txt;.info;.md;.nfo;.xml;.json;.c;.cpp;.cs;.lua;.py;.glsl;.vs;.fs\0"
                    as *const u8 as *const libc::c_char,
            ) {
                strcpy(
                    *dirFilesIcon.offset(i_0 as isize),
                    TextFormat(
                        b"#10#%s\0" as *const u8 as *const libc::c_char,
                        GetFileName(*((*state).dirFiles.paths).offset(i_0 as isize)),
                    ),
                );
            } else if IsFileExtension(
                *((*state).dirFiles.paths).offset(i_0 as isize),
                b".exe;.bin;.raw;.msi\0" as *const u8 as *const libc::c_char,
            ) {
                strcpy(
                    *dirFilesIcon.offset(i_0 as isize),
                    TextFormat(
                        b"#200#%s\0" as *const u8 as *const libc::c_char,
                        GetFileName(*((*state).dirFiles.paths).offset(i_0 as isize)),
                    ),
                );
            } else {
                strcpy(
                    *dirFilesIcon.offset(i_0 as isize),
                    TextFormat(
                        b"#218#%s\0" as *const u8 as *const libc::c_char,
                        GetFileName(*((*state).dirFiles.paths).offset(i_0 as isize)),
                    ),
                );
            }
            ...
            strcpy(
                *dirFilesIcon.offset(i_0 as isize),
                TextFormat(
                    b"#1#%s\0" as *const u8 as *const libc::c_char,
                    GetFileName(*((*state).dirFiles.paths).offset(i_0 as isize)),
                ),
            );
        }
...
unsafe fn main_0() -> libc::c_int {
    let mut screenWidth: libc::c_int = 800 as libc::c_int;
    let mut screenHeight: libc::c_int = 560 as libc::c_int;
    InitWindow(
        screenWidth,
        screenHeight,
        b"raygui - custom modal dialog\0" as *const u8 as *const libc::c_char,
    );
    SetExitKey(0 as libc::c_int);
    let mut fileDialogState: GuiWindowFileDialogState = InitGuiWindowFileDialog(
        GetWorkingDirectory(),
    );
    let mut exitWindow: bool = 0 as libc::c_int != 0;
    let mut fileNameToLoad: [libc::c_char; 512] = [
        0 as libc::c_int as libc::c_char,
        0,
        0,
        0,
    ...
    while !exitWindow {
        ...
        if fileDialogState.SelectFilePressed {
            if IsFileExtension(
                (fileDialogState.fileNameText).as_mut_ptr(),
                b".png\0" as *const u8 as *const libc::c_char,
            ) {
                strcpy(
                    fileNameToLoad.as_mut_ptr(),
                    TextFormat(
                        b"%s/%s\0" as *const u8 as *const libc::c_char,
                        (fileDialogState.dirPathText).as_mut_ptr(),
                        (fileDialogState.fileNameText).as_mut_ptr(),
                    ),
                );
                UnloadTexture(texture);
                texture = LoadTexture(fileNameToLoad.as_mut_ptr());
            }
            fileDialogState.SelectFilePressed = 0 as libc::c_int != 0;
        }
        BeginDrawing();
        ClearBackground(
            GetColor(
        ...
        DrawTexture(
            texture,
            GetScreenWidth() / 2 as libc::c_int - texture.width / 2 as libc::c_int,
            GetScreenHeight() / 2 as libc::c_int - texture.height / 2 as libc::c_int
                - 5 as libc::c_int,
            {
                let mut init = Color {
                    r: 255 as libc::c_int as libc::c_uchar,
        ...
        DrawText(
            fileNameToLoad.as_mut_ptr(),
            208 as libc::c_int,
            GetScreenHeight() - 20 as libc::c_int,
            10 as libc::c_int,
            {
                let mut init = Color {
                    r: 130 as libc::c_int as libc::c_uchar,
                    g: 130 as libc::c_int as libc::c_uchar,
        ...
        if GuiButton(
            {
                let mut init = Rectangle {
                    ...
                    width: 140 as libc::c_int as libc::c_float,
                    height: 30 as libc::c_int as libc::c_float,
                };
                init
            },
            GuiIconText(
                ICON_FILE_OPEN as libc::c_int,
                b"Open Image\0" as *const u8 as *const libc::c_char,
            ),
        ) != 0
        {
            fileDialogState.windowActive = 1 as libc::c_int != 0;
        }
        GuiUnlock();
        GuiWindowFileDialog(&mut fileDialogState);
        EndDrawing();
    }
    UnloadTexture(texture);
    CloseWindow();
