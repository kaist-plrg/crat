...
unsafe fn main_0() -> libc::c_int {
    ...
    InitWindow(
        screenWidth,
        screenHeight,
        b"raygui - GuiScrollPanel()\0" as *const u8 as *const libc::c_char,
    );
    let mut panelRec: Rectangle = {
        let mut init = Rectangle {
            x: 20 as libc::c_int as libc::c_float,
            y: 40 as libc::c_int as libc::c_float,
            width: 200 as libc::c_int as libc::c_float,
            height: 150 as libc::c_int as libc::c_float,
        };
        init
    };
    let mut panelContentRec: Rectangle = {
        let mut init = Rectangle {
            x: 0 as libc::c_int as libc::c_float,
            y: 0 as libc::c_int as libc::c_float,
            width: 340 as libc::c_int as libc::c_float,
            height: 340 as libc::c_int as libc::c_float,
        };
        init
    };
    let mut panelView: Rectangle = {
        let mut init = Rectangle {
            x: 0 as libc::c_int as libc::c_float,
            y: 0.,
            width: 0.,
    ...
    let mut panelScroll: Vector2 = {
        let mut init = Vector2 {
            x: 99 as libc::c_int as libc::c_float,
            y: -(20 as libc::c_int) as libc::c_float,
        };
        init
    };
    let mut showContentArea: bool = 1 as libc::c_int != 0;
    SetTargetFPS(60 as libc::c_int);
    while !WindowShouldClose() {
        BeginDrawing();
        ClearBackground({
            let mut init = Color {
                r: 245 as libc::c_int as libc::c_uchar,
                g: 245 as libc::c_int as libc::c_uchar,
        ...
        DrawText(
            TextFormat(
                ...
                panelScroll.x as libc::c_double,
                panelScroll.y as libc::c_double,
            ),
            4 as libc::c_int,
            4 as libc::c_int,
            20 as libc::c_int,
            {
                let mut init = Color {
                    ...
                    g: 41 as libc::c_int as libc::c_uchar,
                    b: 55 as libc::c_int as libc::c_uchar,
                    a: 255 as libc::c_int as libc::c_uchar,
                };
                init
            },
        ...
        BeginScissorMode(
            panelView.x as libc::c_int,
            panelView.y as libc::c_int,
            panelView.width as libc::c_int,
            panelView.height as libc::c_int,
        );
        GuiGrid(
            {
                let mut init = Rectangle {
        ...
        if showContentArea {
            DrawRectangle(
                (panelRec.x + panelScroll.x) as libc::c_int,
                (panelRec.y + panelScroll.y) as libc::c_int,
                panelContentRec.width as libc::c_int,
                panelContentRec.height as libc::c_int,
                Fade(
                    {
                        let mut init = Color {
                            r: 230 as libc::c_int as libc::c_uchar,
        ...
        GuiCheckBox(
            {
                let mut init = Rectangle {
                    x: 565 as libc::c_int as libc::c_float,
                    y: 80 as libc::c_int as libc::c_float,
                    width: 20 as libc::c_int as libc::c_float,
                    height: 20 as libc::c_int as libc::c_float,
                };
                init
            },
            b"SHOW CONTENT AREA\0" as *const u8 as *const libc::c_char,
            &mut showContentArea,
        );
        GuiSliderBar(
            {
                let mut init = Rectangle {
                    x: 590 as libc::c_int as libc::c_float,
                    y: 385 as libc::c_int as libc::c_float,
                    width: 145 as libc::c_int as libc::c_float,
                    height: 15 as libc::c_int as libc::c_float,
                };
                init
            },
        ...
        GuiSliderBar(
            {
                let mut init = Rectangle {
                    x: 590 as libc::c_int as libc::c_float,
                    y: 410 as libc::c_int as libc::c_float,
                    width: 145 as libc::c_int as libc::c_float,
                    height: 15 as libc::c_int as libc::c_float,
                };
                init
...
unsafe extern "C" fn DrawStyleEditControls() {
    GuiGroupBox(
        {
            let mut init = Rectangle {
                x: 550 as libc::c_int as libc::c_float,
                y: 170 as libc::c_int as libc::c_float,
                width: 220 as libc::c_int as libc::c_float,
                height: 205 as libc::c_int as libc::c_float,
            };
            init
        },
        b"SCROLLBAR STYLE\0" as *const u8 as *const libc::c_char,
    );
    let mut style: libc::c_int = GuiGetStyle(
        SCROLLBAR as libc::c_int,
        BORDER_WIDTH as libc::c_int,
    );
    GuiLabel(
        {
            let mut init = Rectangle {
                x: 555 as libc::c_int as libc::c_float,
                y: 195 as libc::c_int as libc::c_float,
                width: 110 as libc::c_int as libc::c_float,
                height: 10 as libc::c_int as libc::c_float,
            };
            init
        },
        b"BORDER_WIDTH\0" as *const u8 as *const libc::c_char,
    );
    GuiSpinner(
        {
            let mut init = Rectangle {
                x: 670 as libc::c_int as libc::c_float,
                y: 190 as libc::c_int as libc::c_float,
                width: 90 as libc::c_int as libc::c_float,
                height: 20 as libc::c_int as libc::c_float,
            };
            init
        },
    ...
    GuiSetStyle(SCROLLBAR as libc::c_int, BORDER_WIDTH as libc::c_int, style);
    style = GuiGetStyle(SCROLLBAR as libc::c_int, ARROWS_SIZE as libc::c_int);
    GuiLabel(
        {
            let mut init = Rectangle {
                x: 555 as libc::c_int as libc::c_float,
                y: 220 as libc::c_int as libc::c_float,
                width: 110 as libc::c_int as libc::c_float,
                height: 10 as libc::c_int as libc::c_float,
            };
            init
        },
        b"ARROWS_SIZE\0" as *const u8 as *const libc::c_char,
    );
    GuiSpinner(
        {
            let mut init = Rectangle {
                x: 670 as libc::c_int as libc::c_float,
                y: 215 as libc::c_int as libc::c_float,
                width: 90 as libc::c_int as libc::c_float,
                height: 20 as libc::c_int as libc::c_float,
            };
            init
    ...
    GuiSetStyle(SCROLLBAR as libc::c_int, ARROWS_SIZE as libc::c_int, style);
    style = GuiGetStyle(SCROLLBAR as libc::c_int, SLIDER_PADDING as libc::c_int);
    GuiLabel(
        {
            let mut init = Rectangle {
                x: 555 as libc::c_int as libc::c_float,
                y: 245 as libc::c_int as libc::c_float,
                width: 110 as libc::c_int as libc::c_float,
                height: 10 as libc::c_int as libc::c_float,
            };
            init
        },
        b"SLIDER_PADDING\0" as *const u8 as *const libc::c_char,
    );
    GuiSpinner(
        {
            let mut init = Rectangle {
                x: 670 as libc::c_int as libc::c_float,
                y: 240 as libc::c_int as libc::c_float,
                width: 90 as libc::c_int as libc::c_float,
                height: 20 as libc::c_int as libc::c_float,
            };
            init
    ...
    GuiSetStyle(SCROLLBAR as libc::c_int, SLIDER_PADDING as libc::c_int, style);
    let mut scrollBarArrows: bool = GuiGetStyle(
        SCROLLBAR as libc::c_int,
        ARROWS_VISIBLE as libc::c_int,
    ) != 0;
    GuiCheckBox(
        {
            let mut init = Rectangle {
                x: 565 as libc::c_int as libc::c_float,
                y: 280 as libc::c_int as libc::c_float,
                width: 20 as libc::c_int as libc::c_float,
                height: 20 as libc::c_int as libc::c_float,
            };
            init
        },
        b"ARROWS_VISIBLE\0" as *const u8 as *const libc::c_char,
        &mut scrollBarArrows,
    );
    GuiSetStyle(
        SCROLLBAR as libc::c_int,
        ARROWS_VISIBLE as libc::c_int,
        scrollBarArrows as libc::c_int,
    );
    style = GuiGetStyle(SCROLLBAR as libc::c_int, SLIDER_PADDING as libc::c_int);
    GuiLabel(
        {
            let mut init = Rectangle {
                x: 555 as libc::c_int as libc::c_float,
                y: 325 as libc::c_int as libc::c_float,
                width: 110 as libc::c_int as libc::c_float,
                height: 10 as libc::c_int as libc::c_float,
            };
            init
    ...
    GuiSetStyle(SCROLLBAR as libc::c_int, SLIDER_PADDING as libc::c_int, style);
    style = GuiGetStyle(SCROLLBAR as libc::c_int, SLIDER_WIDTH as libc::c_int);
    GuiLabel(
        {
            let mut init = Rectangle {
                x: 555 as libc::c_int as libc::c_float,
                y: 350 as libc::c_int as libc::c_float,
                width: 110 as libc::c_int as libc::c_float,
                height: 10 as libc::c_int as libc::c_float,
            };
            init
        },
        b"SLIDER_WIDTH\0" as *const u8 as *const libc::c_char,
    );
    GuiSpinner(
        {
            let mut init = Rectangle {
                x: 670 as libc::c_int as libc::c_float,
                y: 345 as libc::c_int as libc::c_float,
                width: 90 as libc::c_int as libc::c_float,
                height: 20 as libc::c_int as libc::c_float,
            };
            init
    ...
    GuiSetStyle(SCROLLBAR as libc::c_int, SLIDER_WIDTH as libc::c_int, style);
    let mut text: *const libc::c_char = if GuiGetStyle(
        LISTVIEW as libc::c_int,
        SCROLLBAR_SIDE as libc::c_int,
    ) == 0 as libc::c_int
    {
        b"SCROLLBAR: LEFT\0" as *const u8 as *const libc::c_char
    } else {
        b"SCROLLBAR: RIGHT\0" as *const u8 as *const libc::c_char
    };
    let mut toggleScrollBarSide: bool = GuiGetStyle(
        LISTVIEW as libc::c_int,
        SCROLLBAR_SIDE as libc::c_int,
    ) != 0;
    GuiToggle(
        {
            let mut init = Rectangle {
                x: 560 as libc::c_int as libc::c_float,
                y: 110 as libc::c_int as libc::c_float,
                width: 200 as libc::c_int as libc::c_float,
                height: 35 as libc::c_int as libc::c_float,
            };
            init
        },
        text,
        &mut toggleScrollBarSide,
    );
    GuiSetStyle(
        LISTVIEW as libc::c_int,
        SCROLLBAR_SIDE as libc::c_int,
        toggleScrollBarSide as libc::c_int,
    );
    GuiGroupBox(
        {
            let mut init = Rectangle {
                ...
                y: 20 as libc::c_int as libc::c_float,
                width: 220 as libc::c_int as libc::c_float,
                height: 135 as libc::c_int as libc::c_float,
            };
            init
        },
        b"SCROLLPANEL STYLE\0" as *const u8 as *const libc::c_char,
    );
    style = GuiGetStyle(LISTVIEW as libc::c_int, SCROLLBAR_WIDTH as libc::c_int);
    GuiLabel(
        {
            let mut init = Rectangle {
                x: 555 as libc::c_int as libc::c_float,
                y: 35 as libc::c_int as libc::c_float,
                width: 110 as libc::c_int as libc::c_float,
                height: 10 as libc::c_int as libc::c_float,
            };
            init
        },
        b"SCROLLBAR_WIDTH\0" as *const u8 as *const libc::c_char,
    );
    GuiSpinner(
        {
            let mut init = Rectangle {
    ...
    GuiSetStyle(LISTVIEW as libc::c_int, SCROLLBAR_WIDTH as libc::c_int, style);
    style = GuiGetStyle(DEFAULT as libc::c_int, BORDER_WIDTH as libc::c_int);
    GuiLabel(
        {
            let mut init = Rectangle {
                x: 555 as libc::c_int as libc::c_float,
                y: 60 as libc::c_int as libc::c_float,
                width: 110 as libc::c_int as libc::c_float,
                height: 10 as libc::c_int as libc::c_float,
            };
            init
    ...
    GuiSpinner(
        {
            let mut init = Rectangle {
                x: 670 as libc::c_int as libc::c_float,
                y: 55 as libc::c_int as libc::c_float,
                width: 90 as libc::c_int as libc::c_float,
                height: 20 as libc::c_int as libc::c_float,
            };
            init
    ...
    GuiSetStyle(DEFAULT as libc::c_int, BORDER_WIDTH as libc::c_int, style);
}
pub fn main() {
