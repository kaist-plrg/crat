...
pub const COPYRIGHT_YEAR: C2RustUnnamed = 2020;
...
pub unsafe extern "C" fn emit_bug_reporting_address() {
    ...
    printf(
        ...
        b"bug-hello@gnu.org\0" as *const u8 as *const libc::c_char,
    );
    printf(
        dcgettext(
            0 as *const libc::c_char,
        ...
        b"https://www.gnu.org/software/hello/\0" as *const u8 as *const libc::c_char,
    );
    printf(
        dcgettext(
            0 as *const libc::c_char,
