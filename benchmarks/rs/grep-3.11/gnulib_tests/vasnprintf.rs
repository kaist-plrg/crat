        ...
        *__errno_location() = 22 as libc::c_int;
                ...
                .wrapping_div(::std::mem::size_of::<libc::c_char>() as libc::c_ulong)
        {
            ...
            if buf_memsize == 18446744073709551615 as libc::c_ulong {
                current_block = 792482401437676440;
            } else {
            ...
            match current_block {
                ...
                _ => {
                    *__errno_location() = 12 as libc::c_int;
                    current_block = 8049537985730263645;
                }
            }
        }
        match current_block {
                    ...
                    if cp != (*dp).dir_start {
                        ...
                        if augmented_length > allocated {
                            ...
                            if memory_size == 18446744073709551615 as libc::c_ulong {
                                current_block = 14369873504282889481;
                                break;
                            }
                            if result == resultbuf {
                            ...
                            match type_0 as libc::c_uint {
                                9 | 10 => {
                                    ...
                                    *fresh15 = 'l' as i32 as libc::c_char;
                                    current_block_105 = 17872859965306173922;
                                }
                            ...
                            loop {
                                ...
                                *__errno_location() = 0 as libc::c_int;
                                ...
                                if count < 0 as libc::c_int {
                                    ...
                                    current_block = 333670544643162290;
                                    break 's_92;
                                    ...
                                    as libc::c_ulong >= maxlen
                                {
                                    ...
                                    {
                                        current_block = 14222228389032310941;
                                        break 's_92;
                                    }
