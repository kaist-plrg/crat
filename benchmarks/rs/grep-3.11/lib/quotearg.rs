...
unsafe extern "C" fn quotearg_buffer_restyled(
    ...
    '_process_input: loop {
        ...
        match quoting_style as libc::c_uint {
            ...
            4 => {
                current_block_47 = 16879755157937198308;
            }
            2 => {
                current_block_47 = 5973987756615789860;
            }
            0 => {
                elide_outer_quotes = 0 as libc::c_int != 0;
                current_block_47 = 14775119014532381840;
        ...
        } == 0
        {
            ...
            {
                if elide_outer_quotes {
                    current_block = 2793420211842065092;
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 9532432129209566691;
                            match current_block {
                                9532432129209566691 => {
                                    if elide_outer_quotes {
                                        current_block = 2793420211842065092;
                        ...
                        5 => {
                            current_block = 1744910570668747089;
                            match current_block {
                                9532432129209566691 => {
                                    if elide_outer_quotes {
                                        current_block = 2793420211842065092;
                ...
                7 => {
                    ...
                    current_block = 8901118448483701130;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 1585332402732103534;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 16923273562355781813;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 7917865377606567102;
                    }
                }
                35 | 126 => {
                    current_block = 7917865377606567102;
                ...
                32 => {
                    current_block = 6716361682389510605;
                }
                33 => {
                    current_block = 8175499866402809331;
                }
                34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 => {
                    current_block = 16830457071696022641;
                }
                62 | 91 | 94 => {
