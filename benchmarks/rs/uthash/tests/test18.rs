...
unsafe fn main_0() -> libc::c_int {
    ...
    while i < 10 as libc::c_int {
        ...
        match _hj_k {
            11 => {
                ...
                current_block_58 = 17511492282867121744;
            }
            10 => {
                current_block_58 = 17511492282867121744;
            }
            9 => {
                current_block_58 = 12158238213704438830;
            }
            8 => {
                current_block_58 = 4018888698153793706;
            }
            7 => {
                current_block_58 = 17102632830190198796;
            }
            6 => {
                current_block_58 = 3076935168517599790;
            }
            5 => {
                current_block_58 = 7194926018552694444;
            }
            4 => {
                current_block_58 = 5545972317539803128;
            }
            3 => {
                current_block_58 = 3718603950830734535;
            }
            2 => {
                current_block_58 = 13672916069198990452;
            }
            1 => {
                current_block_58 = 1518543153892965623;
            }
            _ => {
    ...
    while !users.is_null() {
        printf(b"deleting id %i\n\0" as *const u8 as *const libc::c_char, (*users).id);
        let mut _hd_hh_del: *mut UT_hash_handle = &mut (*users).hh;
