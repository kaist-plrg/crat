...
unsafe fn main_0() -> libc::c_int {
    ...
    if !headA.is_null() {} else {
        __assert_fail(
            ...
            b"test68.c\0" as *const u8 as *const libc::c_char,
    ...
    if headA == &mut *els.as_mut_ptr().offset(0 as libc::c_int as isize) as *mut el {
        ...
        if (els[0 as libc::c_int as usize].next).is_null() {
            els[4 as libc::c_int as usize]
                .prev = &mut *els.as_mut_ptr().offset(4 as libc::c_int as isize)
                as *mut el;
        } else {
    ...
    if headA == &mut *els.as_mut_ptr().offset(6 as libc::c_int as isize) as *mut el {
        ...
        if (els[6 as libc::c_int as usize].next).is_null() {
            els[7 as libc::c_int as usize]
                .prev = &mut *els.as_mut_ptr().offset(7 as libc::c_int as isize)
                as *mut el;
        } else {
    ...
    if headA == &mut *els.as_mut_ptr().offset(1 as libc::c_int as isize) as *mut el {
        ...
        if (els[1 as libc::c_int as usize].next).is_null() {
            els[8 as libc::c_int as usize]
                .prev = &mut *els.as_mut_ptr().offset(8 as libc::c_int as isize)
                as *mut el;
        } else {
    ...
    if headA == &mut *els.as_mut_ptr().offset(2 as libc::c_int as isize) as *mut el {
        ...
        if (els[2 as libc::c_int as usize].next).is_null() {
            els[9 as libc::c_int as usize]
                .prev = &mut *els.as_mut_ptr().offset(9 as libc::c_int as isize)
                as *mut el;
        } else {
    ...
    if headB == &mut *els.as_mut_ptr().offset(18 as libc::c_int as isize) as *mut el {
        ...
        if (els[18 as libc::c_int as usize].next).is_null() {
            els[19 as libc::c_int as usize]
                .prev = &mut *els.as_mut_ptr().offset(19 as libc::c_int as isize)
                as *mut el;
        } else {
