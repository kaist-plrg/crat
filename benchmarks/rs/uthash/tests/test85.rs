...
unsafe fn main_0() -> libc::c_int {
    ...
    while i < 10 as libc::c_int {
        ...
        match _hj_k {
            11 => {
                ...
                current_block_58 = 12929965944955185528;
            }
            10 => {
                current_block_58 = 12929965944955185528;
            }
            9 => {
                current_block_58 = 12707192422510106455;
            }
            8 => {
                current_block_58 = 15815895561923348273;
            }
            7 => {
                current_block_58 = 806649079849583205;
            }
            6 => {
                current_block_58 = 4214080202178923430;
            }
            5 => {
                current_block_58 = 18180927576286139199;
            }
            4 => {
                current_block_58 = 2147467507124728288;
            }
            3 => {
                current_block_58 = 4663762606472428349;
            }
            2 => {
                current_block_58 = 4075303062396226477;
            }
            1 => {
                current_block_58 = 8613174255720370651;
            }
            _ => {
    ...
    let mut s: size_t = if !users.is_null() {
        ((*(*users).hh.tbl).num_items as libc::c_ulong)
            .wrapping_mul(::std::mem::size_of::<UT_hash_handle>() as libc::c_ulong)
            .wrapping_add(
            ...
            .wrapping_add(::std::mem::size_of::<UT_hash_table>() as libc::c_ulong)
            .wrapping_add(0 as libc::c_uint as libc::c_ulong)
    } else {
        0 as libc::c_uint as libc::c_ulong
    };
    printf(
        b"overhead %s\n\0" as *const u8 as *const libc::c_char,
        if s == 0 as libc::c_uint as libc::c_ulong {
