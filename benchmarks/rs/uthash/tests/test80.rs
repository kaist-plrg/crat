...
unsafe fn main_0() -> libc::c_int {
    ...
    i = 11 as libc::c_int;
    if 11 as libc::c_int as libc::c_uint > (*a).i {
        let mut _ut_i: libc::c_uint = 0;
        if (*a).i > 11 as libc::c_int as libc::c_uint {
            if ((*a).icd.dtor).is_some() {
                _ut_i = 11 as libc::c_int as libc::c_uint;
                while _ut_i < (*a).i {
                    ((*a).icd.dtor)
                        .unwrap()(
                        ((*a).d)
        ...
        } else if (*a).i < 11 as libc::c_int as libc::c_uint {
            if ((*a).i)
                .wrapping_add((11 as libc::c_int as libc::c_uint).wrapping_sub((*a).i))
                > (*a).n
            {
                let mut utarray_tmp_0: *mut libc::c_char = 0 as *mut libc::c_char;
                while ((*a).i)
                    .wrapping_add(
                        (11 as libc::c_int as libc::c_uint).wrapping_sub((*a).i),
                    ) > (*a).n
                {
                    (*a)
                        .n = if (*a).n != 0 {
            ...
            if ((*a).icd.init).is_some() {
                _ut_i = (*a).i;
                while _ut_i < 11 as libc::c_int as libc::c_uint {
                    ((*a).icd.init)
                        .unwrap()(
                        ((*a).d)
                            .offset(
        ...
        (*a).i = 11 as libc::c_int as libc::c_uint;
    }
    if ((*a).i).wrapping_add(1 as libc::c_int as libc::c_uint) > (*a).n {
    ...
    if (11 as libc::c_int as libc::c_uint) < (*a).i {
        memmove(
            ...
            ((*a).d)
                .offset(
                    ((*a).icd.sz).wrapping_mul(11 as libc::c_int as libc::c_ulong)
                        as isize,
                ) as *mut libc::c_void,
            (((*a).i).wrapping_sub(11 as libc::c_int as libc::c_uint) as libc::c_ulong)
