...
unsafe fn main_0() -> libc::c_int {
    ...
    let mut b: *mut UT_array = 0 as *mut UT_array;
    ...
    (*a).icd = ut_int_icd;
    b = malloc(::std::mem::size_of::<UT_array>() as libc::c_ulong) as *mut UT_array;
    if b.is_null() {
        exit(-(1 as libc::c_int));
    }
    memset(
    ...
    if !((*a).i == 0 as libc::c_int as libc::c_uint) {
        if 10 as libc::c_int as libc::c_uint > (*b).i {
            let mut _ut_i: libc::c_uint = 0;
            if (*b).i > 10 as libc::c_int as libc::c_uint {
                if ((*b).icd.dtor).is_some() {
                    ...
                    while _ut_i < (*b).i {
                        ((*b).icd.dtor)
                            ...
                            ((*b).d)
                                .offset(
                                    ((*b).icd.sz).wrapping_mul(_ut_i as libc::c_ulong) as isize,
                                ) as *mut libc::c_void,
                        );
            ...
            } else if (*b).i < 10 as libc::c_int as libc::c_uint {
                if ((*b).i)
                    .wrapping_add(
                        (10 as libc::c_int as libc::c_uint).wrapping_sub((*b).i),
                    ) > (*b).n
                {
                        ...
                        ) > (*b).n
                    {
                        (*b)
                            .n = if (*b).n != 0 {
                            (2 as libc::c_int as libc::c_uint).wrapping_mul((*b).n)
                        } else {
                            8 as libc::c_int as libc::c_uint
                        };
                    }
                    utarray_tmp_0 = realloc(
                        ...
                        ((*b).n as libc::c_ulong).wrapping_mul((*b).icd.sz),
                    ) as *mut libc::c_char;
                ...
                if ((*b).icd.init).is_some() {
                    ...
                    memset(
                        ((*b).d)
                            .offset(
                                ((*b).icd.sz).wrapping_mul((*b).i as libc::c_ulong) as isize,
                            ) as *mut libc::c_void,
                        0 as libc::c_int,
                        ((*b).icd.sz)
                            .wrapping_mul(
            ...
            (*b).i = 10 as libc::c_int as libc::c_uint;
        }
        if ((*b).i).wrapping_add((*a).i) > (*b).n {
            let mut utarray_tmp_1: *mut libc::c_char = 0 as *mut libc::c_char;
            while ((*b).i).wrapping_add((*a).i) > (*b).n {
                (*b)
                    .n = if (*b).n != 0 {
                    (2 as libc::c_int as libc::c_uint).wrapping_mul((*b).n)
                } else {
            ...
            memmove(
                ((*b).d)
                    .offset(
                        ((*b).icd.sz)
                            .wrapping_mul(
                                (10 as libc::c_int as libc::c_uint).wrapping_add((*a).i)
                                    as libc::c_ulong,
                            ) as isize,
                    ) as *mut libc::c_void,
                ((*b).d)
                    .offset(
                        ((*b).icd.sz).wrapping_mul(10 as libc::c_int as libc::c_ulong)
                            as isize,
                    ) as *mut libc::c_void,
                (((*b).i).wrapping_sub(10 as libc::c_int as libc::c_uint)
                    as libc::c_ulong)
                    .wrapping_mul((*b).icd.sz),
            );
        }
        if ((*b).icd.copy).is_some() {
                ...
                ((*b).icd.copy)
                    ...
                    ((*b).d)
                        .offset(
                            ((*b).icd.sz)
                                .wrapping_mul(
                                    (10 as libc::c_int as libc::c_uint).wrapping_add(_ut_i_0)
                                        as libc::c_ulong,
                                ) as isize,
                        ) as *mut libc::c_void,
                    ((*a).d)
                        .offset(
                            ((*a).icd.sz).wrapping_mul(_ut_i_0 as libc::c_ulong) as isize,
                        ) as *mut libc::c_void,
                );
            ...
            memcpy(
                ...
                ((*a).i as libc::c_ulong).wrapping_mul((*b).icd.sz),
            );
        }
    ...
    p = (if (*b).i != 0 {
        ((*b).d)
            .offset(
                ((*b).icd.sz).wrapping_mul(0 as libc::c_int as libc::c_ulong) as isize,
            ) as *mut libc::c_void
    } else {
        0 as *mut libc::c_void
    }) as *mut libc::c_int;
    while !p.is_null() {
        ...
        p = (if p.is_null() {
            if (*b).i != 0 {
                ((*b).d)
                    .offset(
                        ((*b).icd.sz).wrapping_mul(0 as libc::c_int as libc::c_ulong)
                            as isize,
                    ) as *mut libc::c_void
            } else {
                0 as *mut libc::c_void
            }
        } else if (*b).i as libc::c_ulong
            != ((p as *mut libc::c_char).offset_from((*b).d) as libc::c_long
                as libc::c_ulong)
                .wrapping_div((*b).icd.sz)
                .wrapping_add(1 as libc::c_int as libc::c_ulong)
        {
            ((*b).d)
                .offset(
    ...
    printf(b"len: %u\n\n\0" as *const u8 as *const libc::c_char, (*b).i);
    if !((*a).i == 0 as libc::c_int as libc::c_uint) {
        if 0 as libc::c_int as libc::c_uint > (*b).i {
            let mut _ut_i_1: libc::c_uint = 0;
            if (*b).i > 0 as libc::c_int as libc::c_uint {
                if ((*b).icd.dtor).is_some() {
                    ...
                    while _ut_i_1 < (*b).i {
                        ((*b).icd.dtor)
                            ...
                            ((*b).d)
                                .offset(
                                    ((*b).icd.sz).wrapping_mul(_ut_i_1 as libc::c_ulong)
                                        as isize,
                                ) as *mut libc::c_void,
                        );
            ...
            } else if (*b).i < 0 as libc::c_int as libc::c_uint {
                if ((*b).i)
                    .wrapping_add(
                        (0 as libc::c_int as libc::c_uint).wrapping_sub((*b).i),
                    ) > (*b).n
                {
                ...
                if ((*b).icd.init).is_some() {
                    _ut_i_1 = (*b).i;
                    while _ut_i_1 < 0 as libc::c_int as libc::c_uint {
                        ((*b).icd.init)
                            .unwrap()(
                            ((*b).d)
                                .offset(
            ...
            (*b).i = 0 as libc::c_int as libc::c_uint;
        }
        if ((*b).i).wrapping_add((*a).i) > (*b).n {
            ...
            memmove(
                ((*b).d)
                    .offset(
                        ((*b).icd.sz)
                            .wrapping_mul(
                                (0 as libc::c_int as libc::c_uint).wrapping_add((*a).i)
                                    as libc::c_ulong,
                            ) as isize,
                    ) as *mut libc::c_void,
                ((*b).d)
                ...
                (((*b).i).wrapping_sub(0 as libc::c_int as libc::c_uint)
                    as libc::c_ulong)
                    .wrapping_mul((*b).icd.sz),
            );
        }
        if ((*b).icd.copy).is_some() {
            ...
            while _ut_i_2 < (*a).i {
                ((*b).icd.copy)
                    ...
                    ((*a).d)
                        .offset(
                            ((*a).icd.sz).wrapping_mul(_ut_i_2 as libc::c_ulong) as isize,
                        ) as *mut libc::c_void,
                );
    ...
    printf(b"len: %u\n\n\0" as *const u8 as *const libc::c_char, (*b).i);
    if !((*a).i == 0 as libc::c_int as libc::c_uint) {
        if 25 as libc::c_int as libc::c_uint > (*b).i {
            let mut _ut_i_3: libc::c_uint = 0;
            if (*b).i > 25 as libc::c_int as libc::c_uint {
                if ((*b).icd.dtor).is_some() {
                    _ut_i_3 = 25 as libc::c_int as libc::c_uint;
                    while _ut_i_3 < (*b).i {
                        ((*b).icd.dtor)
                            .unwrap()(
                            ((*b).d)
                                .offset(
                                    ((*b).icd.sz).wrapping_mul(_ut_i_3 as libc::c_ulong)
                                        as isize,
                                ) as *mut libc::c_void,
                        );
            ...
            } else if (*b).i < 25 as libc::c_int as libc::c_uint {
                if ((*b).i)
                    .wrapping_add(
                        (25 as libc::c_int as libc::c_uint).wrapping_sub((*b).i),
                    ) > (*b).n
                {
                ...
                if ((*b).icd.init).is_some() {
                    _ut_i_3 = (*b).i;
                    while _ut_i_3 < 25 as libc::c_int as libc::c_uint {
                        ((*b).icd.init)
                            .unwrap()(
                            ((*b).d)
                                .offset(
            ...
            (*b).i = 25 as libc::c_int as libc::c_uint;
        }
        if ((*b).i).wrapping_add((*a).i) > (*b).n {
            ...
            memmove(
                ((*b).d)
                    .offset(
                        ((*b).icd.sz)
                            .wrapping_mul(
                                (25 as libc::c_int as libc::c_uint).wrapping_add((*a).i)
                                    as libc::c_ulong,
                            ) as isize,
                    ) as *mut libc::c_void,
                ((*b).d)
                    .offset(
                        ((*b).icd.sz).wrapping_mul(25 as libc::c_int as libc::c_ulong)
                            as isize,
                    ) as *mut libc::c_void,
                (((*b).i).wrapping_sub(25 as libc::c_int as libc::c_uint)
                    as libc::c_ulong)
                    .wrapping_mul((*b).icd.sz),
            );
        }
                ...
                ((*b).icd.copy)
                    ...
                    ((*b).d)
                        .offset(
                            ((*b).icd.sz)
                                .wrapping_mul(
                                    (25 as libc::c_int as libc::c_uint).wrapping_add(_ut_i_4)
                                        as libc::c_ulong,
                                ) as isize,
                        ) as *mut libc::c_void,
                    ((*a).d)
            ...
            while _ut_i_5 < (*a).i {
                ((*a).icd.dtor)
                    ...
                    if _ut_i_5 < (*a).i {
                        ((*a).d)
                            .offset(
                                ((*a).icd.sz).wrapping_mul(_ut_i_5 as libc::c_ulong)
                                    as isize,
                            ) as *mut libc::c_void
                    } else {
                        0 as *mut libc::c_void
            ...
            while _ut_i_6 < (*b).i {
                ((*b).icd.dtor)
                    ...
                    if _ut_i_6 < (*b).i {
                        ((*b).d)
                            .offset(
                                ((*b).icd.sz).wrapping_mul(_ut_i_6 as libc::c_ulong)
                                    as isize,
                            ) as *mut libc::c_void
                    } else {
                        0 as *mut libc::c_void
    ...
    (*b).n = 0 as libc::c_int as libc::c_uint;
