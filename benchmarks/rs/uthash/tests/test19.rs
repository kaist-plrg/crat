...
unsafe extern "C" fn ascending_sort(
    ...
    return if (*a).id < (*b).id { -(1 as libc::c_int) } else { 1 as libc::c_int };
}
unsafe extern "C" fn descending_sort(
    mut _a: *mut libc::c_void,
    mut _b: *mut libc::c_void,
) -> libc::c_int {
    let mut a: *mut example_user_t = _a as *mut example_user_t;
...
unsafe fn main_0() -> libc::c_int {
    ...
    while i < 1000 as libc::c_int {
        ...
        if i < 10 as libc::c_int {
            ...
            match _hj_k {
                11 => {
                    ...
                    current_block_58 = 10177291096672844826;
                }
                10 => {
                    current_block_58 = 10177291096672844826;
                }
                9 => {
                    current_block_58 = 8774609621973780662;
                }
                8 => {
                    current_block_58 = 5966575339309657317;
                }
                7 => {
                    current_block_58 = 9826229305481651428;
                }
                6 => {
                    current_block_58 = 14289885115936774980;
                }
                5 => {
                    current_block_58 = 4883355296355629752;
                }
                4 => {
                    current_block_58 = 11209861905166583429;
                }
                3 => {
                    current_block_58 = 9464056307011524751;
                }
                2 => {
                    current_block_58 = 5346162617587206604;
                }
                1 => {
                    current_block_58 = 10303093320086046217;
                }
                _ => {
        ...
        match _hj_k_0 {
            11 => {
                ...
                current_block_251 = 12207942584542961383;
            }
            10 => {
                current_block_251 = 12207942584542961383;
            }
            9 => {
                current_block_251 = 10213527007967979201;
            }
            8 => {
                current_block_251 = 7877609712483693419;
            }
            7 => {
                current_block_251 = 11026693166592709250;
            }
            6 => {
                current_block_251 = 8663876389390588228;
            }
            5 => {
                current_block_251 = 2721638304048114319;
            }
            4 => {
                current_block_251 = 1213061787114207634;
            }
            3 => {
                current_block_251 = 3732536794790205646;
            }
            2 => {
                current_block_251 = 3719550582736615466;
            }
            1 => {
                current_block_251 = 9419450120397016587;
            }
            _ => {
    ...
    printf(b"sorting users ascending\n\0" as *const u8 as *const libc::c_char);
    ...
    printf(b"sorting altusers descending\n\0" as *const u8 as *const libc::c_char);
    ...
    if !altusers.is_null() {
        ...
        while _hs_looping_0 != 0 as libc::c_uint {
            ...
            if _hs_nmerges_0 <= 1 as libc::c_uint {
                ...
                (*(*altusers).alth.tbl).tail = _hs_tail_0;
                altusers = (_hs_list_0 as *mut libc::c_char)
                    .offset(-((*(*altusers).alth.tbl).hho as isize)) as *mut libc::c_void
                    as *mut example_user_t;
            }
