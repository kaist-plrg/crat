...
unsafe extern "C" fn alt_keycmp(
    ...
    puts(b"alt_keycmp\0" as *const u8 as *const libc::c_char);
    return memcmp(a, b, n);
}
unsafe extern "C" fn alt_strlen(mut s: *const libc::c_char) -> size_t {
    puts(b"alt_strlen\0" as *const u8 as *const libc::c_char);
    return strlen(s);
}
unsafe fn main_0() -> libc::c_int {
    ...
    while i < 10 as libc::c_int {
        ...
        (*user).cookie = i * i;
        let mut _uthash_hastr_keylen: libc::c_uint = alt_strlen(
            ((*user).id).as_mut_ptr(),
        ) as libc::c_uint;
        ...
        match _hj_k {
            11 => {
                ...
                current_block_58 = 15745336164160374709;
            }
            10 => {
                current_block_58 = 15745336164160374709;
            }
            9 => {
                current_block_58 = 5297095768117442538;
            }
            8 => {
                current_block_58 = 15832527726713595135;
            }
            7 => {
                current_block_58 = 11508691844444906696;
            }
            6 => {
                current_block_58 = 17342525774372868177;
            }
            5 => {
                current_block_58 = 13036653070756278795;
            }
            4 => {
                current_block_58 = 9961485684346401672;
            }
            3 => {
                current_block_58 = 3534155755364310699;
            }
            2 => {
                current_block_58 = 13576885603110075647;
            }
            1 => {
                current_block_58 = 2521286929670583036;
            }
            _ => {
                current_block_58 = 3689906465960840878;
            }
        }
        match current_block_58 {
            15745336164160374709 => {
                _ha_hashv = _ha_hashv
                    .wrapping_add(
                        (*_hj_key.offset(9 as libc::c_int as isize) as libc::c_uint)
                            << 16 as libc::c_int,
        ...
        (*user)
            .hh
            .key = &mut *((*user).id).as_mut_ptr().offset(0 as libc::c_int as isize)
            as *mut libc::c_char as *const libc::c_void;
        (*user).hh.keylen = _uthash_hastr_keylen;
        if users.is_null() {
    ...
    while i < 10 as libc::c_int {
        ...
        sprintf(buffer.as_mut_ptr(), b"%d\0" as *const u8 as *const libc::c_char, i);
        let mut _uthash_hfstr_keylen: libc::c_uint = alt_strlen(buffer.as_mut_ptr())
            as libc::c_uint;
        ...
        if !users.is_null() {
            ...
            let mut _hj_key_0: *const libc::c_uchar = buffer.as_mut_ptr()
                as *const libc::c_uchar;
            ...
            match _hj_k_0 {
                11 => {
                    ...
                    current_block_256 = 13159533426611663449;
                }
                10 => {
                    current_block_256 = 13159533426611663449;
                }
                9 => {
                    current_block_256 = 14300543941082899683;
                }
                8 => {
                    current_block_256 = 8777519408277806717;
                }
                7 => {
                    current_block_256 = 5378243231166472823;
                }
                6 => {
                    current_block_256 = 15347768847062404082;
                }
                5 => {
                    current_block_256 = 15718575542555130989;
                }
                4 => {
                    current_block_256 = 2768525010212484757;
                }
                3 => {
                    current_block_256 = 14507743300660289476;
                }
                2 => {
                    current_block_256 = 9596750539301179110;
                }
                1 => {
                    current_block_256 = 8641749324128961562;
                }
                _ => {
                    current_block_256 = 5638484086777907119;
                }
            }
                ...
                if 1 as libc::c_int != 0 as libc::c_int {
                    ...
                    while !tmp.is_null() {
                        if (*tmp).hh.hashv == _hf_hashv
                            && (*tmp).hh.keylen == _uthash_hfstr_keylen
                        {
                            if alt_keycmp(
                                (*tmp).hh.key,
