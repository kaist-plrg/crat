...
unsafe fn main_0() -> libc::c_int {
    ...
    while i < 10 as libc::c_int {
        ...
        match _hj_k {
            ...
            9 => {
                current_block_58 = 3137761655869617204;
            }
            8 => {
                current_block_58 = 11002582195031630784;
            }
            7 => {
                current_block_58 = 3565449706180540421;
            }
            6 => {
                current_block_58 = 13006631542393395751;
            }
            5 => {
                current_block_58 = 8617283666136554728;
            }
            4 => {
                current_block_58 = 1951311294146316411;
            }
            3 => {
                current_block_58 = 10469605675374413955;
            }
            2 => {
                current_block_58 = 9434444550647791986;
            }
            1 => {
                current_block_58 = 16390215964003829843;
            }
            _ => {
