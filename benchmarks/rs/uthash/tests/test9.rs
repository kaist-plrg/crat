    ...
    while i < 1000 as libc::c_int {
        ...
        match _hj_k {
            11 => {
                ...
                current_block_58 = 7631717045806817259;
            }
            10 => {
                current_block_58 = 7631717045806817259;
            }
            9 => {
                current_block_58 = 14898900133915379764;
            }
            8 => {
                current_block_58 = 7353621651831336356;
            }
            7 => {
                current_block_58 = 1507900573487162897;
            }
            6 => {
                current_block_58 = 4422364412965362113;
            }
            5 => {
                current_block_58 = 14308627023463179144;
            }
            4 => {
                current_block_58 = 4074772071369755495;
            }
            3 => {
                current_block_58 = 8086608799474531834;
            }
            2 => {
                current_block_58 = 9989194254896477528;
            }
            1 => {
                current_block_58 = 16219904290951057092;
            }
            _ => {
        ...
        if !users.is_null() {
            ...
            match _hj_k_0 {
                11 => {
                    ...
                    current_block_253 = 5943209734910057546;
                }
                10 => {
                    current_block_253 = 5943209734910057546;
                }
                9 => {
                    current_block_253 = 6757666663575783116;
                }
                8 => {
                    current_block_253 = 14423724542182203168;
                }
                7 => {
                    current_block_253 = 9779264176850003141;
                }
                6 => {
                    current_block_253 = 6442902164396703799;
                }
                5 => {
                    current_block_253 = 13206828058566973673;
                }
                4 => {
                    current_block_253 = 8981535396670572599;
                }
                3 => {
                    current_block_253 = 12220727204062025905;
                }
                2 => {
                    current_block_253 = 68925855748695021;
                }
                1 => {
                    current_block_253 = 9193047302863557867;
                }
                _ => {
