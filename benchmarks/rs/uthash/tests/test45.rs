...
unsafe fn main_0() -> libc::c_int {
    ...
    if ((*a).icd.dtor).is_some() {
        ...
        ((*a).icd.dtor)
            .unwrap()(
            ((*a).d).offset(((*a).icd.sz).wrapping_mul((*a).i as libc::c_ulong) as isize)
                as *mut libc::c_void,
        );
    } else {
        (*a).i = ((*a).i).wrapping_sub(1);
    ...
    if ((*a).icd.dtor).is_some() {
        ...
        while _ut_i < 1 as libc::c_int as libc::c_uint {
            ((*a).icd.dtor)
                .unwrap()(
                if (0 as libc::c_int as libc::c_uint).wrapping_add(_ut_i) < (*a).i {
                    ((*a).d)
                        .offset(
                            ((*a).icd.sz)
                                .wrapping_mul(
    ...
    i = 100 as libc::c_int;
    if 3 as libc::c_int as libc::c_uint > (*a).i {
        let mut _ut_i_0: libc::c_uint = 0;
        if (*a).i > 3 as libc::c_int as libc::c_uint {
            if ((*a).icd.dtor).is_some() {
                _ut_i_0 = 3 as libc::c_int as libc::c_uint;
                while _ut_i_0 < (*a).i {
                    ((*a).icd.dtor)
                        .unwrap()(
                        ((*a).d)
            ...
            if ((*a).icd.init).is_some() {
                _ut_i_0 = (*a).i;
                while _ut_i_0 < 3 as libc::c_int as libc::c_uint {
                    ((*a).icd.init)
                        .unwrap()(
                        ((*a).d)
                            .offset(
    ...
    if (3 as libc::c_int as libc::c_uint) < (*a).i {
        memmove(
            ...
            (((*a).i).wrapping_sub(3 as libc::c_int as libc::c_uint) as libc::c_ulong)
                .wrapping_mul((*a).icd.sz),
        );
    }
    if ((*a).icd.copy).is_some() {
    ...
    p = (if (*a).i != 0 {
        ((*a).d)
            .offset(
                ((*a).icd.sz)
                    .wrapping_mul(
                        ((*a).i).wrapping_sub(1 as libc::c_int as libc::c_uint)
                            as libc::c_ulong,
                    ) as isize,
            ) as *mut libc::c_void
    } else {
    ...
    *p = 1000 as libc::c_int;
    ...
    if (*a).i > 0 as libc::c_int as libc::c_uint {
        if ((*a).icd.dtor).is_some() {
            ...
            while _ut_i_1 < (*a).i {
                ((*a).icd.dtor)
                    ...
                    ((*a).d)
                        .offset(
                            ((*a).icd.sz).wrapping_mul(_ut_i_1 as libc::c_ulong) as isize,
                        ) as *mut libc::c_void,
                );
        ...
        (*a).i = 0 as libc::c_int as libc::c_uint;
    }
    if (*a).n != 0 {
        if ((*a).icd.dtor).is_some() {
            ...
            while _ut_i_2 < (*a).i {
                ((*a).icd.dtor)
                    ...
                    if _ut_i_2 < (*a).i {
                        ((*a).d)
                            .offset(
                                ((*a).icd.sz).wrapping_mul(_ut_i_2 as libc::c_ulong)
                                    as isize,
                            ) as *mut libc::c_void
                    } else {
                        0 as *mut libc::c_void
