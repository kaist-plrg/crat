    ...
    while i < 10 as libc::c_int {
        ...
        match _hj_k {
            11 => {
                ...
                current_block_58 = 13113389668337815570;
            }
            10 => {
                current_block_58 = 13113389668337815570;
            }
            9 => {
                current_block_58 = 3186350004348426273;
            }
            8 => {
                current_block_58 = 5205974207585765338;
            }
            7 => {
                current_block_58 = 8098838428831486434;
            }
            6 => {
                current_block_58 = 3273235879762422150;
            }
            5 => {
                current_block_58 = 12092646618281579414;
            }
            4 => {
                current_block_58 = 14038760666329318491;
            }
            3 => {
                current_block_58 = 279234648302839763;
            }
            2 => {
                current_block_58 = 9802204823732183534;
            }
            1 => {
                current_block_58 = 15619826725282577858;
            }
            _ => {
        ...
        if !users.is_null() {
            ...
            match _hj_k_0 {
                11 => {
                    ...
                    current_block_254 = 13087861716624671215;
                }
                10 => {
                    current_block_254 = 13087861716624671215;
                }
                9 => {
                    current_block_254 = 15749239548947552899;
                }
                8 => {
                    current_block_254 = 18422366903412862849;
                }
                7 => {
                    current_block_254 = 11351638494878630311;
                }
                6 => {
                    current_block_254 = 10238508159951227465;
                }
                5 => {
                    current_block_254 = 5227987427314173511;
                }
                4 => {
                    current_block_254 = 14862776917617312086;
                }
                3 => {
                    current_block_254 = 3076523775781512248;
                }
                2 => {
                    current_block_254 = 4589371822259783267;
                }
                1 => {
                    current_block_254 = 4520928686846540786;
                }
                _ => {
                    current_block_254 = 763224442071743734;
                }
            }
            match current_block_254 {
                13087861716624671215 => {
                    _hf_hashv = _hf_hashv
                        .wrapping_add(
                            (*_hj_key_0.offset(9 as libc::c_int as isize)
                                as libc::c_uint) << 16 as libc::c_int,
