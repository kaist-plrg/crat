...
unsafe fn main_0() -> libc::c_int {
    ...
    while i < 10 as libc::c_int {
        ...
        match _hj_k {
            11 => {
                ...
                current_block_58 = 11014539311047517460;
            }
            10 => {
                current_block_58 = 11014539311047517460;
            }
            9 => {
                current_block_58 = 7810006664678215376;
            }
            8 => {
                current_block_58 = 8750500724598335420;
            }
            7 => {
                current_block_58 = 11894659824225936647;
            }
            6 => {
                current_block_58 = 13057207084021428;
            }
            5 => {
                current_block_58 = 6237435668353140107;
            }
            4 => {
                current_block_58 = 12653616133929655966;
            }
            3 => {
                current_block_58 = 3475328436968777373;
            }
            2 => {
                current_block_58 = 11946053889197742683;
            }
            1 => {
                current_block_58 = 14070131678493875794;
            }
            _ => {
        ...
        if !users.is_null() {
            ...
            match _hj_k_0 {
                11 => {
                    ...
                    current_block_253 = 351015859364689437;
                }
                10 => {
                    current_block_253 = 351015859364689437;
                }
                9 => {
                    current_block_253 = 1971549592808883872;
                }
                8 => {
                    current_block_253 = 4981973235423513493;
                }
                7 => {
                    current_block_253 = 8153372852136612846;
                }
                6 => {
                    current_block_253 = 10545010776557921714;
                }
                5 => {
                    current_block_253 = 11453134027485703812;
                }
                4 => {
                    current_block_253 = 12975948918414628943;
                }
                3 => {
                    current_block_253 = 10790471859394482926;
                }
                2 => {
                    current_block_253 = 4959459682386227810;
                }
                1 => {
                    current_block_253 = 3781426898980034801;
                }
                _ => {
    ...
    if !users.is_null() {
        ...
        match _hj_k_1 {
            11 => {
                ...
                current_block_418 = 7330960735048487709;
            }
            10 => {
                current_block_418 = 7330960735048487709;
            }
            9 => {
                current_block_418 = 18416177196525046445;
            }
            8 => {
                current_block_418 = 9637046246721136022;
            }
            7 => {
                current_block_418 = 16402554209308668064;
            }
            6 => {
                current_block_418 = 15074722147828535541;
            }
            5 => {
                current_block_418 = 12013080802347066318;
            }
            4 => {
                current_block_418 = 16907597709145425542;
            }
            3 => {
                current_block_418 = 4549272044206327783;
            }
            2 => {
                current_block_418 = 15653201502785575525;
            }
            1 => {
                current_block_418 = 1701664287637484839;
            }
            _ => {
                current_block_418 = 17516435607569348500;
            }
        }
        match current_block_418 {
            7330960735048487709 => {
                _hf_hashv_0 = _hf_hashv_0
                    .wrapping_add(
        ...
        if !users.is_null() {
            ...
            _hf_bkt_0 = _hf_hashv_0
                & ((*(*users).hh.tbl).num_buckets).wrapping_sub(1 as libc::c_uint);
            if 1 as libc::c_int != 0 as libc::c_int {
                if !((*((*(*users).hh.tbl).buckets).offset(_hf_bkt_0 as isize)).hh_head)
                    .is_null()
                {
                    tmp = ((*((*(*users).hh.tbl).buckets).offset(_hf_bkt_0 as isize))
                        .hh_head as *mut libc::c_char)
                        .offset(-((*(*users).hh.tbl).hho as isize)) as *mut libc::c_void
                        as *mut example_user_t;
                } else {
    ...
    if !tmp.is_null() {
        while !tmp.is_null() {
            printf(
                b"id %d, following prev...\n\0" as *const u8 as *const libc::c_char,
                (*tmp).id,
            );
            tmp = (*tmp).hh.prev as *mut example_user_t;
        }
    } else {
        printf(b"user id %d not found\n\0" as *const u8 as *const libc::c_char, i);
    }
