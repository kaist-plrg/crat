    ...
    while i < 10 as libc::c_int {
        ...
        match _hj_k {
            11 => {
                ...
                current_block_58 = 16777856626284079394;
            }
            10 => {
                current_block_58 = 16777856626284079394;
            }
            9 => {
                current_block_58 = 16855834239138604571;
            }
            8 => {
                current_block_58 = 7918841661709578870;
            }
            7 => {
                current_block_58 = 9115996375893929849;
            }
            6 => {
                current_block_58 = 17670794110436035873;
            }
            5 => {
                current_block_58 = 12592978868934916755;
            }
            4 => {
                current_block_58 = 7578513622317057874;
            }
            3 => {
                current_block_58 = 10731925788591640672;
            }
            2 => {
                current_block_58 = 4536176912500615310;
            }
            1 => {
                current_block_58 = 12218804749701071642;
            }
            _ => {
        ...
        if !users.is_null() {
            ...
            match _hj_k_0 {
                11 => {
                    ...
                    current_block_253 = 9928693419454443354;
                }
                10 => {
                    current_block_253 = 9928693419454443354;
                }
                9 => {
                    current_block_253 = 1759370654521008768;
                }
                8 => {
                    current_block_253 = 2671451586039727692;
                }
                7 => {
                    current_block_253 = 12804141195599759992;
                }
                6 => {
                    current_block_253 = 6065750021943079676;
                }
                5 => {
                    current_block_253 = 11903523019457394762;
                }
                4 => {
                    current_block_253 = 3095736338856023264;
                }
                3 => {
                    current_block_253 = 15506481794196135226;
                }
                2 => {
                    current_block_253 = 9686125455296963837;
                }
                1 => {
                    current_block_253 = 4604172229684622483;
                }
                _ => {
