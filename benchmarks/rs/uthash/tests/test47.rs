...
unsafe fn main_0() -> libc::c_int {
    ...
    let mut a: [libc::c_char; 6] = *::std::mem::transmute::<
        &[u8; 6],
        &mut [libc::c_char; 6],
    >(b" text\0");
    ...
    *((*t).d).offset(0 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
    utstring_printf(
        s,
        b"hello %s\0" as *const u8 as *const libc::c_char,
    ...
    if (::std::mem::size_of::<[libc::c_char; 6]>() as libc::c_ulong)
    ...
    *((*s).d).offset((*s).i as isize) = '\0' as i32 as libc::c_char;
    printf(b"%s\n\0" as *const u8 as *const libc::c_char, (*s).d);
    utstring_printf(t, b" second\0" as *const u8 as *const libc::c_char);
    printf(b"%s\n\0" as *const u8 as *const libc::c_char, (*t).d);
    if ((*s).n).wrapping_sub((*s).i)
    ...
    *((*t).d).offset(0 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
    ...
    utstring_printf(
        t,
        b"one %d two %u three %s\0" as *const u8 as *const libc::c_char,
        1 as libc::c_int,
        2 as libc::c_int,
