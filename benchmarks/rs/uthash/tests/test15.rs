...
unsafe fn main_0() -> libc::c_int {
    ...
    while !(*n).is_null() {
        ...
        strcpy(((*s).name).as_mut_ptr(), *n);
        let fresh0 = i;
        i = i + 1;
        (*s).id = fresh0;
        let mut _uthash_hastr_keylen: libc::c_uint = strlen(((*s).name).as_mut_ptr())
            as libc::c_uint;
        let mut _ha_hashv: libc::c_uint = 0;
        let mut _hj_i: libc::c_uint = 0;
        let mut _hj_j: libc::c_uint = 0;
        let mut _hj_k: libc::c_uint = 0;
        let mut _hj_key: *const libc::c_uchar = &mut *((*s).name)
            .as_mut_ptr()
        ...
        match _hj_k {
            ...
            2 => {
                current_block_58 = 981276038192651198;
            }
            1 => {
                current_block_58 = 18294333465137803961;
            }
            _ => {
                current_block_58 = 1423531122933789233;
            }
        }
        ...
        (*s).hh.keylen = _uthash_hastr_keylen;
        if users.is_null() {
    ...
    if !users.is_null() {
        ...
        match _hj_k_0 {
            11 => {
                ...
                current_block_254 = 4764802467124167272;
            }
            10 => {
                current_block_254 = 4764802467124167272;
            }
            9 => {
                current_block_254 = 5980836898072119616;
            }
            8 => {
                current_block_254 = 17272386124582952402;
            }
            7 => {
                current_block_254 = 13651423580372165165;
            }
            6 => {
                current_block_254 = 11854332676852958198;
            }
            5 => {
                current_block_254 = 10343820041472365708;
            }
            4 => {
                current_block_254 = 9200591069749249636;
            }
            3 => {
                current_block_254 = 18233339199029667;
            }
            2 => {
                current_block_254 = 15876325417469710291;
            }
            1 => {
                current_block_254 = 16621153270273717494;
            }
            _ => {
                current_block_254 = 18340277188286182087;
            }
        }
