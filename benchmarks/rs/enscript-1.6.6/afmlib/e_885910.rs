...
pub static mut afm_885910_encoding: [AFMEncodingTable; 257] = [
    {
    ...
    },
    {
        let mut init = encoding_table_st {
            ...
            character: b"Tslash\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        };
        init
    },
    ...
    },
    {
        let mut init = encoding_table_st {
            ...
            character: b"Ucaron\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        };
        init
    },
    ...
    },
    {
        let mut init = encoding_table_st {
            ...
            character: b"gacute\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        };
        init
    },
    ...
    },
    {
        let mut init = encoding_table_st {
            ...
            character: b"kgreenlandic\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        };
        init
    },
