...
pub static mut afm_88593_encoding: [AFMEncodingTable; 257] = [
    ...
    },
    {
        let mut init = encoding_table_st {
            ...
            character: b"Hbar\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        };
        init
    },
    {
    ...
    },
    {
        let mut init = encoding_table_st {
            ...
            character: b"Idotaccent\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        };
        init
    },
    ...
    },
    {
        let mut init = encoding_table_st {
            ...
            character: b"Cdotaccent\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        };
        init
    },
    ...
    },
    {
        let mut init = encoding_table_st {
            ...
            character: b"Gdotaccent\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        };
        init
    },
