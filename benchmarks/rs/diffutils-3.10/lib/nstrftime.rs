            ...
            match format_char {
                ...
                97 => {
                    if modifier != 0 as libc::c_int {
                        current_block = 14265820193476131346;
                    } else {
                        if change_case {
                            to_uppcase = 1 as libc::c_int != 0;
                            to_lowcase = 0 as libc::c_int != 0;
                        }
                        current_block = 3945408843668531897;
                    }
                }
                65 => {
                    if modifier != 0 as libc::c_int {
                ...
                67 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 9217838508313037615;
                    }
                }
                120 => {
                    if modifier == 'O' as i32 {
                ...
                68 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 13148720663508744519;
                    }
                }
                100 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 2339465656573576988;
                    }
                }
                101 => {
                    if modifier == 'E' as i32 {
                        ...
                        digits = 2 as libc::c_int;
                        number_value = (*tp).tm_mday;
                        current_block = 1280869915624481502;
                    }
                }
                70 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 12873303568798189683;
                    }
                }
                72 => {
                    if modifier == 'E' as i32 {
                ...
                106 => {
                    if modifier == 'E' as i32 {
                        ...
                        u_number_value = ((*tp).tm_yday as libc::c_uint)
                            .wrapping_add(1 as libc::c_uint);
                        current_block = 11570671217014660717;
                    }
                }
                77 => {
                    if modifier == 'E' as i32 {
                ...
                80 => {
                    ...
                    current_block = 3385372364107690969;
                }
                112 => {
                    current_block = 3385372364107690969;
                }
                ...
                115 => {
                    ...
                    current_block = 10661596431506160108;
                }
                88 => {
                    if modifier == 'O' as i32 {
                        current_block = 14265820193476131346;
                ...
                58 => {
                    ...
                    if *f.offset(colons as isize) as libc::c_int != 'z' as i32 {
                        ...
                        current_block = 15886530142665135189;
                    }
                }
                122 => {
                ...
                _ => {
                    match current_block {
                        9217838508313037615 => {
                            ...
                            current_block = 4706743532584823731;
                        }
                        15886530142665135189 => {
                            if (*tp).tm_isdst < 0 as libc::c_int {
                                ...
                                match colons {
                                    0 => {
                                        ...
                                        match current_block {
                                            14795592282877320006 => {
                                                ...
                                                u_number_value = (hour_diff * 100 as libc::c_int + min_diff)
                                                    as libc::c_uint;
                                                current_block = 6289597664352382882;
                                            }
                                            16105340104018725347 => {
                                        ...
                                        current_block = 8579284923599764465;
                                    }
                                    1 => {
                                        current_block = 6225579869370739012;
                                        match current_block {
                                    ...
                                    3 => {
                                        current_block = 16105340104018725347;
                                        match current_block {
                                            14795592282877320006 => {
                                                digits = 5 as libc::c_int;
                                                tz_colon_mask = 0 as libc::c_int;
