...
pub unsafe extern "C" fn clone_quoting_options(
    ...
    let mut p: *mut quoting_options = xmemdup(
        ...
        ::std::mem::size_of::<quoting_options>() as libc::c_ulong,
    ...
    '_process_input: loop {
        ...
        match quoting_style as libc::c_uint {
            6 => {
                ...
                current_block_47 = 17799772352385307655;
            }
            5 => {
                current_block_47 = 17799772352385307655;
            }
            ...
            3 => {
                backslash_escapes = 1 as libc::c_int != 0;
                current_block_47 = 16746421068423024454;
            }
            1 => {
                current_block_47 = 16746421068423024454;
            }
            4 => {
                current_block_47 = 14264503360568506830;
            }
            2 => {
                current_block_47 = 14927154267775501346;
            }
            0 => {
                elide_outer_quotes = 0 as libc::c_int != 0;
                current_block_47 = 14775119014532381840;
        ...
        } == 0
        {
            ...
            {
                if elide_outer_quotes {
                    current_block = 14637453708314067336;
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 3494945688115535314;
                            match current_block {
                                3494945688115535314 => {
                                    if elide_outer_quotes {
                                        current_block = 14637453708314067336;
                        ...
                        5 => {
                            current_block = 4404456663553854343;
                            match current_block {
                                3494945688115535314 => {
                                    if elide_outer_quotes {
                                        current_block = 14637453708314067336;
                ...
                7 => {
                    ...
                    current_block = 7723012471644338516;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 4224681499807442490;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 15228516143900926635;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 8816581272328801728;
                    }
                }
                35 | 126 => {
                    current_block = 8816581272328801728;
                ...
                32 => {
                    current_block = 16259586372816460720;
                }
                33 => {
                    current_block = 18416564117582698220;
                }
                34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 => {
                    current_block = 13165790452087967888;
                }
                62 | 91 | 94 => {
                    current_block = 11639763113151551566;
                }
                96 | 124 => {
                    current_block = 16731366866769354163;
                }
                39 => {
            ...
            match current_block {
                13165790452087967888 => {
                    current_block = 11639763113151551566;
                }
                _ => {}
            }
            match current_block {
                11639763113151551566 => {
                    current_block = 16731366866769354163;
                }
                _ => {}
            }
            match current_block {
                16731366866769354163 => {
                    if quoting_style as libc::c_uint
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                        && elide_outer_quotes as libc::c_int != 0
                    {
...
static mut slotvec0: slotvec = unsafe {
    {
        let mut init = slotvec {
            size: ::std::mem::size_of::<[libc::c_char; 256]>() as libc::c_ulong,
...
unsafe extern "C" fn quotearg_n_options(
    ...
    if nslots <= n {
        ...
        sv = xpalloc(
            ...
            ::std::mem::size_of::<slotvec>() as libc::c_ulong as idx_t,
        ) as *mut slotvec;
        slotvec = sv;
        if preallocated {
            *sv = slotvec0;
        ...
        memset(
            ...
            ((new_nslots - nslots as libc::c_long) as libc::c_ulong)
                .wrapping_mul(::std::mem::size_of::<slotvec>() as libc::c_ulong),
        );
