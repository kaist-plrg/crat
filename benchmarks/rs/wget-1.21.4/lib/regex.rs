                ...
                != 0
            {
                ...
                if wcu_0 != wc {
                    ...
                    if (mbclen == mbcdlen) as libc::c_int as libc::c_long != 0 {
                        ...
                        src_idx = byte_idx;
                        current_block_88 = 9023715435910868237;
                        break;
                    }
                } else {
                    memcpy(
...
unsafe extern "C" fn init_word_char(mut dfa: *mut re_dfa_t) {
        ...
        as libc::c_long != 0
    {
        ...
        if 64 as libc::c_int == 64 as libc::c_int {
            ...
            current_block = 8163257340074862024;
        }
        match current_block {
            8163257340074862024 => {}
            _ => {
        ...
        match c2_0 as libc::c_int {
            ...
            58 => {
                        ...
                        << 1 as libc::c_int != 0
                {
                    ...
                    current_block_28 = 12076198193809757249;
                }
            }
            _ => {
                current_block_28 = 12076198193809757249;
    ...
    match c as libc::c_int {
        ...
        45 => {
                    ...
                    ) as libc::c_int == '-' as i32)
            {
                ...
                current_block_38 = 7529722592479127321;
            }
        }
        _ => {
            current_block_38 = 7529722592479127321;
...
unsafe extern "C" fn parse_expression(
    ...
    match (*token).type_0() as libc::c_int {
        ...
        23 => {
            ...
            current_block_103 = 11178942877733387357;
        }
        11 | 18 | 19 => {
            current_block_103 = 11178942877733387357;
        }
        9 => {
            current_block_103 = 9277524420993013694;
        }
        24 => {
            current_block_103 = 10594467366690199827;
        }
        12 => {
    ...
    if (start > 0 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long != 0 {
        ...
        loop {
            ...
            if (elem.is_null() || tree.is_null()) as libc::c_int as libc::c_long != 0 {
                current_block = 11260701261144815658;
                break;
            }
            i += 1;
            i;
        ...
        as libc::c_long != 0
    {
        *err = _REG_BADPAT;
        ...
        if (*token).type_0() as libc::c_int == OP_NON_MATCH_LIST as libc::c_int {
            ...
            {
                *err = _REG_BADPAT;
                current_block = 6579867843627180394;
            } else {
                                ...
                                1 => {
                                        ...
                                        as libc::c_long != 0
                                    {
                                        ...
                                        if (new_mbchars == 0 as *mut libc::c_void as *mut wchar_t)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 3641761938862889581;
                                            break;
                                        }
...
unsafe extern "C" fn merge_state_array(
    ...
    while st_idx < num {
        if (*dst.offset(st_idx as isize)).is_null() {
            let ref mut fresh51 = *dst.offset(st_idx as isize);
            *fresh51 = *src.offset(st_idx as isize);
            ...
            let ref mut fresh52 = *dst.offset(st_idx as isize);
            *fresh52 = re_acquire_state(&mut err, dfa, &mut merged_set);
                            ...
                            ) as libc::c_int != 0)
                        {
                            if (local_sctx.sifted_states).is_null() {
                                ...
                                if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                    as libc::c_int as libc::c_long != 0
                                {
                                    current_block = 10125767841012204996;
                                    break 's_22;
                                }
                            }
                            ...
                            if !ok as libc::c_int as libc::c_long != 0 {
                                ...
                                let ref mut fresh53 = *(local_sctx.sifted_states)
                                    .offset(str_idx as isize);
                                *fresh53 = cur_state;
...
unsafe extern "C" fn sift_states_backward(
    ...
    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int as libc::c_long
        != 0
    {
        current_block = 15167688764636789313;
    } else {
        current_block = 6873731126896040597;
    }
    loop {
        match current_block {
            15167688764636789313 => {
...
unsafe extern "C" fn prune_impossible_nodes(
        ...
        as libc::c_int as libc::c_long != 0
    {
        ...
        if (*dfa).nbackref != 0 {
            ...
            {
                ret = _REG_ESPACE;
                current_block = 16920651839710410987;
            } else {
                's_62: loop {
                    memset(
...
unsafe extern "C" fn push_fail_stack(
    ...
    let ref mut fresh58 = (*((*fs).stack).offset(num as isize)).regs;
    *fresh58 = malloc(
        ...
        as libc::c_long != 0)
    {
            ...
            as libc::c_long != 0)
        {
                ...
                || (*dfa).has_mb_node() as libc::c_int != 0
            {
                ...
                {
                    err = _REG_ESPACE;
                    current_block = 10336941410500301829;
                } else {
                    mctx
                        .state_log = malloc(
                    ...
                    's_148: loop {
                        ...
                        match match_kind {
                            ...
                            7 => {
                                ...
                                current_block = 3344945525847997968;
                            }
                            6 => {
                                while (match_first < right_lim) as libc::c_int
                                    as libc::c_long != 0
                            ...
                            if nmatch > 0 as libc::c_int as libc::c_ulong {
                                ...
                                while (reg_idx as libc::c_ulong) < nmatch {
                                    let ref mut fresh59 = (*pmatch.offset(reg_idx as isize))
                                        .rm_eo;
                                    *fresh59 = -(1 as libc::c_int) as regoff_t;
                                    (*pmatch.offset(reg_idx as isize)).rm_so = *fresh59;
                                    reg_idx += 1;
                                    reg_idx;
                                }
...
unsafe extern "C" fn check_matching(
    ...
    if !((*mctx).state_log).is_null() {
        let ref mut fresh62 = *((*mctx).state_log).offset(cur_str_idx as isize);
        *fresh62 = cur_state;
        if (*dfa).nbackref != 0 {
            ...
            if !(sub_last_idx < (*sub_top).nlasts) {
                ...
                while sl_str <= bkref_str_idx {
                    ...
                    if sl_str_off > 0 as libc::c_int as libc::c_long {
                        ...
                        let fresh64 = bkref_str_off;
                        bkref_str_off = bkref_str_off + 1;
                        if *buf.offset(fresh64 as isize) as libc::c_int
                            != *buf
                                .offset(
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 6932546901262694404;
                        break;
                    }
...
unsafe extern "C" fn transit_state(
    ...
    let fresh71 = (*mctx).input.cur_idx;
    (*mctx).input.cur_idx = (*mctx).input.cur_idx + 1;
    ch = *((*mctx).input.mbs).offset(fresh71 as isize);
    loop {
            ...
            while j < dests_node[i as usize].nelem {
                ...
                if next_node != -(1 as libc::c_int) as libc::c_long {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 6628574537100854749;
                        break 's_99;
                    }
                }
                j += 1;
                                ...
                                if !(has_intersec == 0) {
                                    ...
                                    if not_subset != 0 {
                                        ...
                                        if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 2211053509144012801;
                                            break 's_20;
                                        }
                                        ndests += 1;
                                        ndests;
    ...
    if (*node).type_0() as libc::c_int == COMPLEX_BRACKET as libc::c_int {
        ...
        loop {
            ...
            if wc == *((*cset).mbchars).offset(i as isize) {
                match_len = char_len;
                current_block = 1568506298128774306;
                break;
            } else {
                i += 1;
                i;
...
unsafe extern "C" fn check_node_accept(
    ...
    match (*node).type_0() as libc::c_int {
        ...
        7 => {
            ...
            current_block_10 = 17490015655102444814;
        }
        5 => {
            current_block_10 = 17490015655102444814;
        }
...
unsafe extern "C" fn match_ctx_add_subtop(
    ...
    let ref mut fresh84 = *((*mctx).sub_tops).offset((*mctx).nsub_tops as isize);
    *fresh84 = calloc(
        1 as libc::c_int as libc::c_ulong,
    ...
    let fresh85 = (*mctx).nsub_tops;
    (*mctx).nsub_tops = (*mctx).nsub_tops + 1;
    (**((*mctx).sub_tops).offset(fresh85 as isize)).str_idx = str_idx;
    return _REG_NOERROR;
}
