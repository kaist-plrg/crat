    ...
    '_process_input: loop {
        ...
        match quoting_style as libc::c_uint {
            6 => {
                ...
                current_block_47 = 14454744115128733508;
            }
            5 => {
                current_block_47 = 14454744115128733508;
            }
            ...
            4 => {
                current_block_47 = 2316576064665906339;
            }
            2 => {
                current_block_47 = 13053408596401462044;
            }
            0 => {
                elide_outer_quotes = 0 as libc::c_int != 0;
                current_block_47 = 14775119014532381840;
        ...
        } == 0
        {
            ...
            {
                if elide_outer_quotes {
                    current_block = 3121735297514993271;
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 2718812203898698155;
                            match current_block {
                                2718812203898698155 => {
                                    if elide_outer_quotes {
                                        current_block = 3121735297514993271;
                        ...
                        5 => {
                            current_block = 7919806596259138728;
                            match current_block {
                                2718812203898698155 => {
                                    if elide_outer_quotes {
                                        current_block = 3121735297514993271;
                ...
                7 => {
                    ...
                    current_block = 12567332655730150165;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 12034444973171035459;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 8792904702300224889;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 4791084557613369489;
                    }
                }
                35 | 126 => {
                    current_block = 4791084557613369489;
                ...
                32 => {
                    current_block = 2887397348998810924;
                }
                33 => {
                    current_block = 10297796285808205086;
                }
                34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 => {
                    current_block = 3432626574554468081;
                }
                62 | 91 | 94 => {
                    current_block = 17718125445579585413;
                }
                96 | 124 => {
                    current_block = 7569392262172777061;
                }
                39 => {
