    ...
    '_process_input: loop {
        ...
        match quoting_style as libc::c_uint {
            6 => {
                ...
                current_block_47 = 11510440381272929126;
            }
            5 => {
                current_block_47 = 11510440381272929126;
            }
            ...
            3 => {
                backslash_escapes = 1 as libc::c_int != 0;
                current_block_47 = 17486193772900881328;
            }
            1 => {
                current_block_47 = 17486193772900881328;
            }
            4 => {
                current_block_47 = 10336693720916198664;
            }
            2 => {
                current_block_47 = 8713146328107349101;
            }
            0 => {
                elide_outer_quotes = 0 as libc::c_int != 0;
                current_block_47 = 14775119014532381840;
        ...
        } == 0
        {
            ...
            {
                if elide_outer_quotes {
                    current_block = 597738247802563008;
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 4246854393488470863;
                            match current_block {
                                4246854393488470863 => {
                                    if elide_outer_quotes {
                                        current_block = 597738247802563008;
                        ...
                        5 => {
                            current_block = 9691850674468209572;
                            match current_block {
                                4246854393488470863 => {
                                    if elide_outer_quotes {
                                        current_block = 597738247802563008;
                ...
                7 => {
                    ...
                    current_block = 5312557212469856756;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 13792004028548690670;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 16386578407680848466;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 18329605127095459026;
                    }
                }
                35 | 126 => {
                    current_block = 18329605127095459026;
                ...
                32 => {
                    current_block = 15074770387117256792;
                }
                33 => {
                    current_block = 10024999144700268093;
                }
                34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 => {
                    current_block = 2601460620660234964;
                }
                62 | 91 | 94 => {
                    current_block = 13805465189434996368;
                }
                96 | 124 => {
