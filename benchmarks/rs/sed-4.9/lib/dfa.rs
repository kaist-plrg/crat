...
unsafe extern "C" fn lex(mut dfa: *mut dfa) -> token {
    ...
    while i < 2 as libc::c_int {
        ...
        match c {
            92 => {
                if backslash {
                    current_block = 2170825521728291091;
                } else {
                    if (*dfa).lex.left == 0 as libc::c_int as libc::c_long {
                        dfaerror(
                            dcgettext(
            ...
            49 | 50 | 51 | 52 | 53 | 54 | 55 | 56 | 57 => {
                if !backslash {
                    ...
                    & ((((((((((((((1 as libc::c_int as libc::c_ulong)
                        ...
                        << 1 as libc::c_int) << 1 as libc::c_int != 0
                {
                    current_block = 14712412772207306552;
                } else {
            ...
            63 => {
                if (*dfa).syntax.syntax_bits
                    ...
                    != 0
                {
                    current_block = 8961258152826866507;
    ...
    *((*dfa).tokens).offset(fresh6 as isize) = t;
    ...
    match t {
        ...
        256 => {
            ...
            current_block_16 = 12510522276756935292;
        }
        274 => {
            (*dfa).fast = 0 as libc::c_int != 0;
            current_block_16 = 8184082146587542570;
        }
    ...
    while i < (*d).tindex {
            ...
            < (*((*d).follows).offset(i as isize)).nelem
        {
            ...
            match *((*d).tokens).offset(i as isize) {
                268 => {
                    current_block_12 = 4322921244590678397;
                    match current_block_12 {
                        15492563113322919920 => {
                ...
                269 => {
                    current_block_12 = 11288263663399842285;
                    match current_block_12 {
                        15492563113322919920 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                270 => {
                    current_block_12 = 18157531726959496515;
                    match current_block_12 {
                        15492563113322919920 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                271 => {
                    current_block_12 = 7133810331402286908;
                    match current_block_12 {
                        15492563113322919920 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                272 => {
                    current_block_12 = 12076198193809757249;
                    match current_block_12 {
                        15492563113322919920 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                273 => {
                    current_block_12 = 4115013968050508435;
                    match current_block_12 {
                        15492563113322919920 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                256 => {
                    current_block_12 = 15492563113322919920;
                    match current_block_12 {
                        15492563113322919920 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
    ...
    while i < tindex {
        ...
        match *((*d).tokens).offset(i as isize) {
            ...
            258 | 259 => {
                ...
                current_block_53 = 18157218261675230946;
            }
            257 => {
                current_block_53 = 18157218261675230946;
            }
        ...
        match *((*d).tokens).offset(i as isize) {
            270 | 271 | 272 | 273 => {
                if !(*d).localeinfo.multibyte {
                    ...
                    current_block_1 = 9861621054673285950;
                }
            }
            274 | 275 => {
                current_block_1 = 9861621054673285950;
            ...
            270 | 271 | 272 | 273 => {
                if (*d).localeinfo.multibyte {
                    ...
                    *((*sup).tokens)
                    ...
                    current_block_32 = 6604712238852933849;
                }
            }
            _ => {
                current_block_32 = 6604712238852933849;
    ...
    while (ri + 1 as libc::c_int as libc::c_long) < (*d).tindex {
        ...
        match t {
            ...
            263 | 264 => {
                ...
                current_block = 5589060106268965058;
            }
