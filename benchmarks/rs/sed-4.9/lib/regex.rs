                ...
                != 0
            {
                ...
                if wcu_0 != wc {
                    ...
                    if (mbclen == mbcdlen) as libc::c_int as libc::c_long != 0 {
                        ...
                        src_idx = byte_idx;
                        current_block_88 = 155614221734052228;
                        break;
                    }
                } else {
                    memcpy(
        ...
        match c2_0 as libc::c_int {
            ...
            58 => {
                        ...
                        << 1 as libc::c_int != 0
                {
                    ...
                    current_block_28 = 9165879724478994499;
                }
            }
            _ => {
                current_block_28 = 9165879724478994499;
    ...
    match c as libc::c_int {
        ...
        45 => {
                    ...
                    ) as libc::c_int == '-' as i32)
            {
                ...
                current_block_38 = 394482555998358067;
            }
        }
        _ => {
            current_block_38 = 394482555998358067;
        ...
        as libc::c_long != 0)
    {
            ...
            as libc::c_long != 0)
        {
                ...
                || (*dfa).has_mb_node() as libc::c_int != 0
            {
                ...
                {
                    err = _REG_ESPACE;
                    current_block = 15062443666196995072;
                } else {
                    mctx
                        .state_log = malloc(
                    ...
                    's_148: loop {
                        ...
                        match match_kind {
                            ...
                            7 => {
                                ...
                                current_block = 1088267677692729339;
                            }
                            6 => {
                                while (match_first < right_lim) as libc::c_int
                                    as libc::c_long != 0
...
unsafe extern "C" fn prune_impossible_nodes(
        ...
        as libc::c_int as libc::c_long != 0
    {
        ...
        if (*dfa).nbackref != 0 {
            ...
            {
                ret = _REG_ESPACE;
                current_block = 11445510957578732288;
            } else {
                's_62: loop {
                    memset(
...
unsafe extern "C" fn sift_states_backward(
    ...
    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int as libc::c_long
        != 0
    {
        current_block = 7788576996338580839;
    } else {
                            ...
                            ) as libc::c_int != 0)
                        {
                            if (local_sctx.sifted_states).is_null() {
                                ...
                                if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                    as libc::c_int as libc::c_long != 0
                                {
                                    current_block = 2505718079684388441;
                                    break 's_22;
                                }
                            }
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 6000095335088885112;
                        break;
                    }
            ...
            while j < dests_node[i as usize].nelem {
                ...
                if next_node != -(1 as libc::c_int) as libc::c_long {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 11665029275185924564;
                        break 's_99;
                    }
                }
                j += 1;
                                ...
                                if !(has_intersec == 0) {
                                    ...
                                    if not_subset != 0 {
                                        ...
                                        if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 12752516784193975630;
                                            break 's_20;
                                        }
                                        ndests += 1;
                                        ndests;
    ...
    if (*node).type_0() as libc::c_int == COMPLEX_BRACKET as libc::c_int {
        ...
        loop {
            ...
            if wc == *((*cset).mbchars).offset(i as isize) {
                match_len = char_len;
                current_block = 12054981952590301616;
                break;
            } else {
                i += 1;
                i;
...
unsafe extern "C" fn check_node_accept(
    ...
    match (*node).type_0() as libc::c_int {
        ...
        7 => {
            ...
            current_block_10 = 10656775208124116978;
        }
        5 => {
            current_block_10 = 10656775208124116978;
        }
...
unsafe extern "C" fn match_ctx_add_subtop(
    ...
    let ref mut fresh83 = *((*mctx).sub_tops).offset((*mctx).nsub_tops as isize);
    *fresh83 = calloc(
        1 as libc::c_int as libc::c_ulong,
    ...
    let fresh84 = (*mctx).nsub_tops;
    (*mctx).nsub_tops = (*mctx).nsub_tops + 1;
    (**((*mctx).sub_tops).offset(fresh84 as isize)).str_idx = str_idx;
    return _REG_NOERROR;
}
unsafe extern "C" fn match_ctx_add_entry(
    ...
    let fresh85 = (*mctx).nbkref_ents;
    (*mctx).nbkref_ents = (*mctx).nbkref_ents + 1;
    (*((*mctx).bkref_ents).offset(fresh85 as isize))
