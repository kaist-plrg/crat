...
extern "C" {
    ...
    fn osip_accept_encoding_init(
        header: *mut *mut osip_accept_encoding_t,
    ) -> libc::c_int;
    fn osip_accept_encoding_parse(
        header: *mut osip_accept_encoding_t,
...
pub type osip_accept_language_t = osip_accept_encoding_t;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub unsafe extern "C" fn osip_message_set_accept_language(
    mut sip: *mut osip_message_t,
    mut hvalue: *const libc::c_char,
) -> libc::c_int {
    let mut accept_language: *mut osip_accept_language_t = 0
        as *mut osip_accept_language_t;
    ...
    i = osip_accept_encoding_init(&mut accept_language);
    ...
    osip_list_add(
        ...
        accept_language as *mut libc::c_void,
        -(1 as libc::c_int),
    );
    return 0 as libc::c_int;
}
pub unsafe extern "C" fn osip_message_get_accept_language(
    mut sip: *const osip_message_t,
    mut pos: libc::c_int,
    mut dest: *mut *mut osip_accept_language_t,
) -> libc::c_int {
    let mut accept_language: *mut osip_accept_language_t = 0
        as *mut osip_accept_language_t;
    *dest = 0 as *mut osip_accept_language_t;
    if osip_list_size(&(*sip).accept_languages) <= pos {
        return -(1 as libc::c_int);
    }
    accept_language = osip_list_get(&(*sip).accept_languages, pos)
        as *mut osip_accept_language_t;
