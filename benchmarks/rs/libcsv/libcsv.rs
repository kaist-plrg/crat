...
pub unsafe extern "C" fn csv_free(mut p: *mut csv_parser) {
    ...
    if !((*p).entry_buf).is_null() && ((*p).free_func).is_some() {
        ((*p).free_func).unwrap()((*p).entry_buf as *mut libc::c_void);
    }
    (*p).entry_buf = 0 as *mut libc::c_uchar;
    (*p).entry_size = 0 as libc::c_int as size_t;
}
pub unsafe extern "C" fn csv_fini(
    ...
    match pstate {
        3 => {
            ...
            current_block_26 = 8681688774556256076;
        }
        1 | 2 => {
            current_block_26 = 8681688774556256076;
        }
    ...
    match current_block_26 {
        8681688774556256076 => {
            ...
            {
                cb1.unwrap()(0 as *mut libc::c_void, entry_pos, data);
            } else if cb1.is_some() {
                cb1.unwrap()((*p).entry_buf as *mut libc::c_void, entry_pos, data);
            }
            ...
            if cb2.is_some() {
                cb2.unwrap()(-(1 as libc::c_int), data);
            }
            ...
            0 | 1 => {
                ...
                } != 0
                {
                    if pstate == 1 as libc::c_int {
                        ...
                        entry_pos = quoted as size_t;
                        if cb2.is_some() {
                            cb2.unwrap()(c as libc::c_int, data);
                        }
                        pstate = 0 as libc::c_int;
                        spaces = 0 as libc::c_int as size_t;
                        quoted = spaces as libc::c_int;
