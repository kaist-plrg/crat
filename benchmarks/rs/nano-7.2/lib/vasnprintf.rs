...
extern "C" {
    ...
    fn printf_fetchargs(args: ::std::ffi::VaList, a: *mut arguments) -> libc::c_int;
    fn printf_parse(
    ...
    if printf_fetchargs(args.as_va_list(), &mut a) < 0 as libc::c_int {
        *__errno_location() = 22 as libc::c_int;
                ...
                .wrapping_div(::std::mem::size_of::<libc::c_char>() as libc::c_ulong)
        {
            ...
            buf = fresh0.leak().as_mut_ptr() as *mut libc::c_char;
            ...
            if buf_memsize == 18446744073709551615 as libc::c_ulong {
                current_block = 7460111898549513329;
            } else {
            ...
            match current_block {
                ...
                _ => {
                    *__errno_location() = 12 as libc::c_int;
                    current_block = 14808512081105677216;
                }
            }
        }
        match current_block {
            14808512081105677216 => {}
            _ => {
                result = resultbuf;
                    ...
                    if cp != (*dp).dir_start {
                        ...
                        if augmented_length > allocated {
                            ...
                            if memory_size == 18446744073709551615 as libc::c_ulong {
                                current_block = 11518995518073473280;
                                break;
                            }
                            if result == resultbuf {
                            ...
                            match type_0 as libc::c_uint {
                                9 | 10 => {
                                    ...
                                    *fresh15 = 'l' as i32 as libc::c_char;
                                    current_block_97 = 10991494775050786115;
                                }
                                7 | 8 | 14 | 16 => {
                                    current_block_97 = 10991494775050786115;
                                }
                                12 => {
                                    ...
                                    *fresh17 = 'L' as i32 as libc::c_char;
                                    current_block_97 = 11674240781755647963;
                                }
                                _ => {
                                    current_block_97 = 11674240781755647963;
                                }
                            ...
                            loop {
                                ...
                                *__errno_location() = 0 as libc::c_int;
                                ...
                                if count < 0 as libc::c_int {
                                    ...
                                    current_block = 11792150974830186584;
                                    break 's_92;
                                    ...
                                    as libc::c_ulong >= maxlen
                                {
                                    ...
                                    {
                                        current_block = 7687146208304199024;
                                        break 's_92;
                                    }
