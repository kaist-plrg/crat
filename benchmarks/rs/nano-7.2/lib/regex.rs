                ...
                != 0
            {
                ...
                if wcu_0 != wc {
                    ...
                    if (mbclen == mbcdlen) as libc::c_int as libc::c_long != 0 {
                        ...
                        src_idx = byte_idx;
                        current_block_88 = 12371978349012145177;
                        break;
                    }
                } else {
                    memcpy(
...
unsafe extern "C" fn init_word_char(mut dfa: *mut re_dfa_t) {
        ...
        as libc::c_long != 0
    {
        ...
        if 64 as libc::c_int == 64 as libc::c_int {
            ...
            current_block = 11006340517910387565;
        }
        match current_block {
            11006340517910387565 => {}
            _ => {
        ...
        match c2_0 as libc::c_int {
            ...
            58 => {
                        ...
                        << 1 as libc::c_int != 0
                {
                    ...
                    current_block_28 = 9274853688818729465;
                }
            }
            _ => {
                current_block_28 = 9274853688818729465;
    ...
    match c as libc::c_int {
        ...
        45 => {
                    ...
                    ) as libc::c_int == '-' as i32)
            {
                ...
                current_block_38 = 5498004584607368161;
            }
        }
        _ => {
            current_block_38 = 5498004584607368161;
...
unsafe extern "C" fn parse_expression(
    ...
    match (*token).type_0() as libc::c_int {
        ...
        23 => {
            ...
            current_block_103 = 3419922044708994944;
        }
        11 | 18 | 19 => {
            current_block_103 = 3419922044708994944;
        }
        9 => {
            current_block_103 = 13395312208073836257;
        }
        24 => {
            current_block_103 = 9123375336249826801;
        }
        12 => {
    ...
    if (start > 0 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long != 0 {
        ...
        loop {
            ...
            if (elem.is_null() || tree.is_null()) as libc::c_int as libc::c_long != 0 {
                current_block = 16651140662611079955;
                break;
            }
            i += 1;
            i;
        ...
        as libc::c_long != 0
    {
        *err = _REG_BADPAT;
        ...
        if (*token).type_0() as libc::c_int == OP_NON_MATCH_LIST as libc::c_int {
            ...
            {
                *err = _REG_BADPAT;
                current_block = 16356577291291594683;
            } else {
                                ...
                                1 => {
                                        ...
                                        as libc::c_long != 0
                                    {
                                        ...
                                        if (new_mbchars == 0 as *mut libc::c_void as *mut wchar_t)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 10295359031476523403;
                                            break;
                                        }
        ...
        as libc::c_long != 0)
    {
            ...
            as libc::c_long != 0)
        {
                ...
                || (*dfa).has_mb_node() as libc::c_int != 0
            {
                ...
                {
                    err = _REG_ESPACE;
                    current_block = 10668558152193749299;
                } else {
                    mctx
                        .state_log = malloc(
                    ...
                    's_148: loop {
                        ...
                        match match_kind {
                            ...
                            7 => {
                                ...
                                current_block = 11785794952098021382;
                            }
                            6 => {
                                while (match_first < right_lim) as libc::c_int
                                    as libc::c_long != 0
...
unsafe extern "C" fn prune_impossible_nodes(
        ...
        as libc::c_int as libc::c_long != 0
    {
        ...
        if (*dfa).nbackref != 0 {
            ...
            {
                ret = _REG_ESPACE;
                current_block = 3857337545834955299;
            } else {
                's_62: loop {
                    memset(
...
unsafe extern "C" fn sift_states_backward(
    ...
    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int as libc::c_long
        != 0
    {
        current_block = 430536098812597717;
    } else {
                            ...
                            ) as libc::c_int != 0)
                        {
                            if (local_sctx.sifted_states).is_null() {
                                ...
                                if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                    as libc::c_int as libc::c_long != 0
                                {
                                    current_block = 6078466879387727452;
                                    break 's_22;
                                }
                            }
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 843822917621839687;
                        break;
                    }
            ...
            while j < dests_node[i as usize].nelem {
                ...
                if next_node != -(1 as libc::c_int) as libc::c_long {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 14165046555726616440;
                        break 's_99;
                    }
                }
                j += 1;
                                ...
                                if !(has_intersec == 0) {
                                    ...
                                    if not_subset != 0 {
                                        ...
                                        if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 11154976659885597604;
                                            break 's_20;
                                        }
                                        ndests += 1;
                                        ndests;
    ...
    if (*node).type_0() as libc::c_int == COMPLEX_BRACKET as libc::c_int {
        ...
        loop {
            ...
            if wc == *((*cset).mbchars).offset(i as isize) {
                match_len = char_len;
                current_block = 2403294653929552812;
                break;
            } else {
                i += 1;
                i;
...
unsafe extern "C" fn check_node_accept(
    ...
    match (*node).type_0() as libc::c_int {
        ...
        7 => {
            ...
            current_block_10 = 11543608376920291627;
        }
        5 => {
            current_block_10 = 11543608376920291627;
        }
...
unsafe extern "C" fn match_ctx_add_sublast(
    ...
    if (new_entry != 0 as *mut libc::c_void as *mut re_sub_match_last_t) as libc::c_int
        as libc::c_long != 0
    {
        let ref mut fresh83 = *((*subtop).lasts).offset((*subtop).nlasts as isize);
        *fresh83 = new_entry;
        (*new_entry).node = node;
...
unsafe extern "C" fn match_ctx_add_entry(
    ...
    let fresh84 = (*mctx).nbkref_ents;
    (*mctx).nbkref_ents = (*mctx).nbkref_ents + 1;
    (*((*mctx).bkref_ents).offset(fresh84 as isize))
