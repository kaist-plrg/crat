...
unsafe extern "C" fn quotearg_buffer_restyled(
    ...
    '_process_input: loop {
        ...
        match quoting_style as libc::c_uint {
            ...
            3 => {
                backslash_escapes = 1 as libc::c_int != 0;
                current_block_47 = 6352476886565627491;
            }
            1 => {
                current_block_47 = 6352476886565627491;
            }
            4 => {
                current_block_47 = 6463557327865571632;
            }
            2 => {
                current_block_47 = 14119108351187933557;
            }
            0 => {
                elide_outer_quotes = 0 as libc::c_int != 0;
                current_block_47 = 14775119014532381840;
        ...
        } == 0
        {
            ...
            {
                if elide_outer_quotes {
                    current_block = 7046992113551940165;
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 6881611655122192447;
                            match current_block {
                                6881611655122192447 => {
                                    if elide_outer_quotes {
                                        current_block = 7046992113551940165;
                        ...
                        5 => {
                            current_block = 16734287195833850954;
                            match current_block {
                                6881611655122192447 => {
                                    if elide_outer_quotes {
                                        current_block = 7046992113551940165;
                ...
                7 => {
                    ...
                    current_block = 977562400035901281;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 9602895627747330090;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 18029233149860401284;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 6885674608111194404;
                    }
                }
                35 | 126 => {
                    current_block = 6885674608111194404;
                ...
                32 => {
                    current_block = 16481076385570880913;
                }
                33 => {
                    current_block = 12208436626450457004;
                }
                34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 => {
                    current_block = 8833495243305235038;
                }
                62 | 91 | 94 => {
                    current_block = 13177415446877497399;
                }
                96 | 124 => {
                    current_block = 1876731113568976909;
                }
                39 => {
