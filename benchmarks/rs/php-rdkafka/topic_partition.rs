...
extern "C" {
    ...
    fn _estrdup(s: *const libc::c_char) -> *mut libc::c_char;
    ...
    fn get_active_class_name(space: *mut *const libc::c_char) -> *const libc::c_char;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _kafka_topic_partition_intern {
    pub topic: *mut libc::c_char,
    pub partition: int32_t,
    pub offset: int64_t,
    pub err: rd_kafka_resp_err_t,
...
pub type kafka_topic_partition_intern = _kafka_topic_partition_intern;
pub type object_intern = kafka_topic_partition_intern;
#[inline(always)]
...
static mut arginfo_class_RdKafka_TopicPartition___construct: [zend_internal_arg_info; 4] = unsafe {
    [
        {
...
static mut arginfo_class_RdKafka_TopicPartition_getTopic: [zend_internal_arg_info; 1] = [
    {
        let mut init = _zend_internal_arg_info {
...
static mut arginfo_class_RdKafka_TopicPartition_setTopic: [zend_internal_arg_info; 2] = unsafe {
    [
        {
            let mut init = _zend_internal_arg_info {
...
static mut arginfo_class_RdKafka_TopicPartition_setPartition: [zend_internal_arg_info; 2] = unsafe {
    [
        {
            let mut init = _zend_internal_arg_info {
                name: 1 as libc::c_int as zend_uintptr_t as *const libc::c_char,
...
static mut arginfo_class_RdKafka_TopicPartition_setOffset: [zend_internal_arg_info; 2] = unsafe {
    [
        {
            let mut init = _zend_internal_arg_info {
                name: 1 as libc::c_int as zend_uintptr_t as *const libc::c_char,
...
static mut class_RdKafka_TopicPartition_methods: [zend_function_entry; 9] = [zend_function_entry {
...
unsafe extern "C" fn register_class_RdKafka_TopicPartition() -> *mut zend_class_entry {
    ...
    ce
        ...
        .unwrap()(
        b"RdKafka\\TopicPartition\0" as *const u8 as *const libc::c_char,
        (::std::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong),
        1 as libc::c_int,
    );
    ce.info.internal.builtin_functions = class_RdKafka_TopicPartition_methods.as_ptr();
    class_entry = zend_register_internal_class_ex(&mut ce, 0 as *mut zend_class_entry);
    return class_entry;
}
pub static mut ce_kafka_topic_partition: *mut zend_class_entry = 0
...
unsafe extern "C" fn free_object(mut object: *mut zend_object) {
    let mut intern: *mut object_intern = (object as *mut libc::c_char)
        .offset(-(32 as libc::c_ulong as isize)) as *mut object_intern;
    if !((*intern).topic).is_null() {
        _efree((*intern).topic as *mut libc::c_void);
    }
...
unsafe extern "C" fn get_object(mut z: *mut zval) -> *mut object_intern {
    let mut intern: *mut object_intern = ((*z).value.obj as *mut libc::c_char)
        .offset(-(32 as libc::c_ulong as isize)) as *mut object_intern;
    if ((*intern).topic).is_null() {
        zend_throw_exception_ex(
            0 as *mut zend_class_entry,
            0 as libc::c_int as zend_long,
            b"RdKafka\\TopicPartition::__construct() has not been called\0" as *const u8
...
pub unsafe extern "C" fn get_topic_partition_object(
    mut z: *mut zval,
) -> *mut kafka_topic_partition_intern {
    return get_object(z);
}
unsafe extern "C" fn get_debug_info(
    ...
    *is_temp = 1 as libc::c_int;
    ...
    intern = ((*object).value.obj as *mut libc::c_char)
        .offset(-(32 as libc::c_ulong as isize)) as *mut object_intern;
    if intern.is_null() || ((*intern).topic).is_null() {
    ...
    if !((*intern).topic).is_null() {
        add_assoc_string_ex(
            ...
            strlen(b"topic\0" as *const u8 as *const libc::c_char),
            (*intern).topic,
        );
    } else {
        add_assoc_null_ex(
    ...
    add_assoc_long_ex(
        ...
        strlen(b"partition\0" as *const u8 as *const libc::c_char),
        (*intern).partition as zend_long,
    );
    add_assoc_long_ex(
        &mut ary,
        b"offset\0" as *const u8 as *const libc::c_char,
        strlen(b"offset\0" as *const u8 as *const libc::c_char),
        (*intern).offset,
    );
    add_assoc_long_ex(
        &mut ary,
        ...
        (*intern).err as zend_long,
    );
    return ary.value.arr;
}
pub unsafe extern "C" fn kafka_topic_partition_init(
    mut zobj: *mut zval,
    mut topic: *mut libc::c_char,
    mut partition: int32_t,
    mut offset: int64_t,
    mut err: rd_kafka_resp_err_t,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    intern = ((*zobj).value.obj as *mut libc::c_char)
        .offset(-(32 as libc::c_ulong as isize)) as *mut object_intern;
    if intern.is_null() {
        return;
    }
    ...
    (*intern).topic = _estrdup(topic);
    (*intern).partition = partition;
    (*intern).offset = offset;
    (*intern).err = err;
}
pub unsafe extern "C" fn kafka_topic_partition_list_to_array(
    mut return_value: *mut zval,
    mut list: *mut rd_kafka_topic_partition_list_t,
) {
    let mut topar: *mut rd_kafka_topic_partition_t = 0
        as *mut rd_kafka_topic_partition_t;
    let mut ztopar: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    let mut __arr: *mut zend_array = if 0 != 0 {
        if (*list).cnt as uint32_t <= 8 as libc::c_int as libc::c_uint {
            _zend_new_array_0()
        } else {
            _zend_new_array((*list).cnt as uint32_t)
        }
    } else {
        _zend_new_array((*list).cnt as uint32_t)
    };
    ...
    i = 0 as libc::c_int;
    while i < (*list).cnt {
        topar = &mut *((*list).elems).offset(i as isize)
            as *mut rd_kafka_topic_partition_t;
        ztopar.u1.type_info = 1 as libc::c_int as uint32_t;
        object_init_ex(&mut ztopar, ce_kafka_topic_partition);
        kafka_topic_partition_init(
            &mut ztopar,
            (*topar).topic,
            (*topar).partition,
            (*topar).offset,
        ...
        add_next_index_zval(return_value, &mut ztopar);
        i += 1;
        i;
    }
}
pub unsafe extern "C" fn array_arg_to_kafka_topic_partition_list(
    mut argnum: libc::c_int,
    mut ary: *mut HashTable,
) -> *mut rd_kafka_topic_partition_list_t {
    let mut pos: HashPosition = 0;
    let mut list: *mut rd_kafka_topic_partition_list_t = 0
        as *mut rd_kafka_topic_partition_list_t;
    let mut zv: *mut zval = 0 as *mut zval;
    list = rd_kafka_topic_partition_list_new((*ary).nNumOfElements as libc::c_int);
    zend_hash_internal_pointer_reset_ex(ary, &mut pos);
    loop {
        zv = zend_hash_get_current_data_ex(ary, &mut pos);
        if zv.is_null() {
            break;
        }
        let mut topar_intern: *mut kafka_topic_partition_intern = 0
            as *mut kafka_topic_partition_intern;
        let mut topar: *mut rd_kafka_topic_partition_t = 0
            as *mut rd_kafka_topic_partition_t;
        if zval_get_type(zv) as libc::c_int != 8 as libc::c_int
            || instanceof_function((*(*zv).value.obj).ce, ce_kafka_topic_partition) == 0
        {
            let mut space: *const libc::c_char = 0 as *const libc::c_char;
            let mut class_name: *const libc::c_char = get_active_class_name(&mut space);
            rd_kafka_topic_partition_list_destroy(list);
            zend_error(
                (1 as libc::c_int) << 0 as libc::c_long,
                b"Argument %d passed to %s%s%s() must be an array of RdKafka\\TopicPartition, at least one element is a(n) %s\0"
            ...
            return 0 as *mut rd_kafka_topic_partition_list_t;
        }
        topar_intern = get_topic_partition_object(zv);
        if topar_intern.is_null() {
            rd_kafka_topic_partition_list_destroy(list);
            return 0 as *mut rd_kafka_topic_partition_list_t;
        }
        topar = rd_kafka_topic_partition_list_add(
            list,
            (*topar_intern).topic,
            (*topar_intern).partition,
        );
        (*topar).offset = (*topar_intern).offset;
        zend_hash_move_forward_ex(ary, &mut pos);
    }
    return list;
}
pub unsafe extern "C" fn zim_RdKafka_TopicPartition___construct(
    ...
    let mut offset: zend_long = 0 as libc::c_int as zend_long;
    ...
    if zend_parse_parameters(
        ...
        b"sl|l\0" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn zim_RdKafka_TopicPartition_getTopic(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    ...
    if !((*intern).topic).is_null() {
        let mut _s: *const libc::c_char = (*intern).topic;
        let mut __z: *mut zval = return_value;
        ...
        (*return_value).u1.type_info = 1 as libc::c_int as uint32_t;
        return;
    };
}
pub unsafe extern "C" fn zim_RdKafka_TopicPartition_setTopic(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut topic: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    (*intern).topic = _estrdup(topic);
    let mut __z: *mut zval = return_value;
    let mut __zv: *mut zval = if zval_get_type(&mut (*execute_data).This) as libc::c_int
        == 8 as libc::c_int
    {
        &mut (*execute_data).This
    } else {
...
pub unsafe extern "C" fn zim_RdKafka_TopicPartition_getPartition(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    ...
    let mut __z: *mut zval = return_value;
    (*__z).value.lval = (*intern).partition as zend_long;
    (*__z).u1.type_info = 4 as libc::c_int as uint32_t;
}
pub unsafe extern "C" fn zim_RdKafka_TopicPartition_setPartition(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut partition: zend_long = 0;
    ...
    (*intern).partition = partition as int32_t;
    let mut __z: *mut zval = return_value;
    let mut __zv: *mut zval = if zval_get_type(&mut (*execute_data).This) as libc::c_int
        == 8 as libc::c_int
    {
...
pub unsafe extern "C" fn zim_RdKafka_TopicPartition_getOffset(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    ...
    let mut __z: *mut zval = return_value;
    (*__z).value.lval = (*intern).offset;
    (*__z).u1.type_info = 4 as libc::c_int as uint32_t;
}
pub unsafe extern "C" fn zim_RdKafka_TopicPartition_setOffset(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
...
pub unsafe extern "C" fn zim_RdKafka_TopicPartition_getErr(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    ...
    let mut __z: *mut zval = return_value;
    (*__z).value.lval = (*intern).err as zend_long;
    (*__z).u1.type_info = 4 as libc::c_int as uint32_t;
}
pub unsafe extern "C" fn kafka_metadata_topic_partition_minit(
    mut type_0: libc::c_int,
    mut module_number: libc::c_int,
) {
    ce_kafka_topic_partition = register_class_RdKafka_TopicPartition();
    (*ce_kafka_topic_partition)
        .c2rust_unnamed_0
        .create_object = Some(
    ...
    handlers.offset = 32 as libc::c_ulong as libc::c_int;
}
unsafe extern "C" fn run_static_initializers() {
    class_RdKafka_TopicPartition_methods = [
        {
            let mut init = _zend_function_entry {
                fname: b"__construct\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_TopicPartition___construct
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_TopicPartition___construct.as_ptr(),
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getTopic\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_TopicPartition_getTopic
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_TopicPartition_getTopic.as_ptr(),
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"setTopic\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_TopicPartition_setTopic
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_TopicPartition_setTopic.as_ptr(),
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getPartition\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_TopicPartition_getPartition
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_TopicPartition_getTopic.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"setPartition\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_TopicPartition_setPartition
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_TopicPartition_setPartition.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 2]>()
                    as libc::c_ulong)
                    .wrapping_div(
                        ::std::mem::size_of::<_zend_internal_arg_info>() as libc::c_ulong,
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getOffset\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_TopicPartition_getOffset
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_TopicPartition_getTopic.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"setOffset\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_TopicPartition_setOffset
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_TopicPartition_setOffset.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 2]>()
                    as libc::c_ulong)
                    .wrapping_div(
                        ::std::mem::size_of::<_zend_internal_arg_info>() as libc::c_ulong,
        ...
        },
        {
            let mut init = _zend_function_entry {
                ...
                handler: Some(
                    zim_RdKafka_TopicPartition_getErr
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_TopicPartition_getTopic.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
