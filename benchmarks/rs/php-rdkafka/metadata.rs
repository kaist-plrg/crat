...
extern "C" {
    ...
    fn rd_kafka_metadata_destroy(metadata: *const rd_kafka_metadata);
    fn zim_RdKafka___construct(
        execute_data: *mut zend_execute_data,
        return_value: *mut zval,
    );
    static mut kafka_default_object_handlers: zend_object_handlers;
    fn kafka_metadata_collection_minit(type_0: libc::c_int, module_number: libc::c_int);
    ...
    fn kafka_metadata_topic_minit(type_0: libc::c_int, module_number: libc::c_int);
    fn kafka_metadata_topic_ctor(
        return_value: *mut zval,
        zmetadata: *mut zval,
        metadata_topic: *const libc::c_void,
    );
    fn kafka_metadata_broker_minit(type_0: libc::c_int, module_number: libc::c_int);
    fn kafka_metadata_broker_ctor(
        return_value: *mut zval,
        zmetadata: *mut zval,
        metadata_broker: *const libc::c_void,
    );
    fn kafka_metadata_partition_minit(type_0: libc::c_int, module_number: libc::c_int);
...
pub struct _object_intern {
    pub metadata: *const rd_kafka_metadata_t,
    pub std: zend_object,
}
#[inline(always)]
...
static mut arginfo_class_RdKafka_Metadata___construct: [zend_internal_arg_info; 1] = [
    {
...
static mut arginfo_class_RdKafka_Metadata_getOrigBrokerId: [zend_internal_arg_info; 1] = [
    {
        let mut init = _zend_internal_arg_info {
            name: 0 as *const libc::c_char,
            type_0: 0 as libc::c_int as zend_type,
...
static mut class_RdKafka_Metadata_methods: [zend_function_entry; 6] = [zend_function_entry {
...
unsafe extern "C" fn register_class_RdKafka_Metadata() -> *mut zend_class_entry {
    ...
    ce_0
        ...
        .unwrap()(
        b"RdKafka\\Metadata\0" as *const u8 as *const libc::c_char,
        (::std::mem::size_of::<[libc::c_char; 17]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong),
        1 as libc::c_int,
    );
    ce_0.info.internal.builtin_functions = class_RdKafka_Metadata_methods.as_ptr();
...
unsafe extern "C" fn brokers_collection(
    mut return_value: *mut zval,
    mut parent: *mut zval,
    mut intern: *mut object_intern,
) {
    kafka_metadata_collection_init(
        return_value,
        parent,
        (*(*intern).metadata).brokers as *const libc::c_void,
        (*(*intern).metadata).broker_cnt as size_t,
        ::std::mem::size_of::<rd_kafka_metadata_broker>() as libc::c_ulong,
        Some(
            kafka_metadata_broker_ctor
                as unsafe extern "C" fn(*mut zval, *mut zval, *const libc::c_void) -> (),
        ),
    );
}
unsafe extern "C" fn topics_collection(
    mut return_value: *mut zval,
    mut parent: *mut zval,
    mut intern: *mut object_intern,
) {
    kafka_metadata_collection_init(
        return_value,
        parent,
        (*(*intern).metadata).topics as *const libc::c_void,
        (*(*intern).metadata).topic_cnt as size_t,
        ::std::mem::size_of::<rd_kafka_metadata_topic>() as libc::c_ulong,
        Some(
            kafka_metadata_topic_ctor
                as unsafe extern "C" fn(*mut zval, *mut zval, *const libc::c_void) -> (),
        ),
    );
}
unsafe extern "C" fn kafka_metadata_free(mut object: *mut zend_object) {
    let mut intern: *mut object_intern = (object as *mut libc::c_char)
        .offset(-(8 as libc::c_ulong as isize)) as *mut object_intern;
    if !((*intern).metadata).is_null() {
        rd_kafka_metadata_destroy((*intern).metadata);
    }
    zend_object_std_dtor(&mut (*intern).std);
}
unsafe extern "C" fn kafka_metadata_new(
...
unsafe extern "C" fn get_object(mut zmetadata: *mut zval) -> *mut object_intern {
    let mut ometadata: *mut object_intern = ((*zmetadata).value.obj as *mut libc::c_char)
        .offset(-(8 as libc::c_ulong as isize)) as *mut object_intern;
    if ((*ometadata).metadata).is_null() {
        zend_throw_exception_ex(
            0 as *mut zend_class_entry,
            0 as libc::c_int as zend_long,
            b"RdKafka\\Metadata::__construct() has not been called\0" as *const u8
...
unsafe extern "C" fn get_debug_info(
    ...
    *is_temp = 1 as libc::c_int;
    ...
    intern = ((*object).value.obj as *mut libc::c_char)
        .offset(-(8 as libc::c_ulong as isize)) as *mut object_intern;
    if intern.is_null() || ((*intern).metadata).is_null() {
        return ary.value.arr;
    }
    brokers.u1.type_info = 1 as libc::c_int as uint32_t;
    brokers_collection(&mut brokers, object, intern);
    add_assoc_zval_ex(
        &mut ary,
        b"brokers\0" as *const u8 as *const libc::c_char,
        strlen(b"brokers\0" as *const u8 as *const libc::c_char),
        &mut brokers,
    );
    topics.u1.type_info = 1 as libc::c_int as uint32_t;
    topics_collection(&mut topics, object, intern);
    add_assoc_zval_ex(
        &mut ary,
        b"topics\0" as *const u8 as *const libc::c_char,
        strlen(b"topics\0" as *const u8 as *const libc::c_char),
        &mut topics,
    );
    add_assoc_long_ex(
        &mut ary,
        b"orig_broker_id\0" as *const u8 as *const libc::c_char,
        strlen(b"orig_broker_id\0" as *const u8 as *const libc::c_char),
        (*(*intern).metadata).orig_broker_id as zend_long,
    );
    add_assoc_string_ex(
        &mut ary,
        b"orig_broker_name\0" as *const u8 as *const libc::c_char,
        strlen(b"orig_broker_name\0" as *const u8 as *const libc::c_char),
        (*(*intern).metadata).orig_broker_name,
    );
    return ary.value.arr;
}
pub unsafe extern "C" fn zim_RdKafka_Metadata_getOrigBrokerId(
    ...
    (*__z).value.lval = (*(*intern).metadata).orig_broker_id as zend_long;
    (*__z).u1.type_info = 4 as libc::c_int as uint32_t;
}
pub unsafe extern "C" fn zim_RdKafka_Metadata_getOrigBrokerName(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    ...
    let mut _s: *const libc::c_char = (*(*intern).metadata).orig_broker_name;
    let mut __z: *mut zval = return_value;
...
pub unsafe extern "C" fn zim_RdKafka_Metadata_getBrokers(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
...
pub unsafe extern "C" fn zim_RdKafka_Metadata_getTopics(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
...
pub unsafe extern "C" fn kafka_metadata_minit(
    ...
    handlers
        .free_obj = Some(
        kafka_metadata_free as unsafe extern "C" fn(*mut zend_object) -> (),
    );
    handlers.offset = 8 as libc::c_ulong as libc::c_int;
    kafka_metadata_topic_minit(type_0, module_number);
    kafka_metadata_broker_minit(type_0, module_number);
    kafka_metadata_partition_minit(type_0, module_number);
    kafka_metadata_collection_minit(type_0, module_number);
}
pub unsafe extern "C" fn kafka_metadata_init(
    mut return_value: *mut zval,
    mut metadata: *const rd_kafka_metadata_t,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
...
unsafe extern "C" fn run_static_initializers() {
    class_RdKafka_Metadata_methods = [
        {
            let mut init = _zend_function_entry {
                ...
                arg_info: arginfo_class_RdKafka_Metadata___construct.as_ptr(),
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getOrigBrokerId\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_Metadata_getOrigBrokerId
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_getOrigBrokerId.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
                    as libc::c_ulong)
                    .wrapping_div(
                        ::std::mem::size_of::<_zend_internal_arg_info>() as libc::c_ulong,
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getOrigBrokerName\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_Metadata_getOrigBrokerName
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_getOrigBrokerId.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getBrokers\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_Metadata_getBrokers
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_getOrigBrokerId.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getTopics\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_Metadata_getTopics
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_getOrigBrokerId.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
