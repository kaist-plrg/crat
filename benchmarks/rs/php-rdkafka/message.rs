...
extern "C" {
    ...
    fn zend_update_property_string(
        scope: *mut zend_class_entry,
        object: *mut zval,
        name: *const libc::c_char,
        name_length: size_t,
    ...
    fn rd_kafka_header_get_all(
        hdrs: *const rd_kafka_headers_t,
        idx: size_t,
        namep: *mut *const libc::c_char,
        valuep: *mut *const libc::c_void,
        sizep: *mut size_t,
    ) -> rd_kafka_resp_err_t;
    fn rd_kafka_message_timestamp(
        rkmessage: *const rd_kafka_message_t,
        tstype: *mut rd_kafka_timestamp_type_t,
    ) -> int64_t;
    fn rd_kafka_message_headers(
        rkmessage: *const rd_kafka_message_t,
        hdrsp: *mut *mut rd_kafka_headers_t,
    ) -> rd_kafka_resp_err_t;
    fn rd_kafka_header_cnt(hdrs: *const rd_kafka_headers_t) -> size_t;
...
pub type rd_kafka_timestamp_type_t = libc::c_uint;
pub const RD_KAFKA_TIMESTAMP_LOG_APPEND_TIME: rd_kafka_timestamp_type_t = 2;
pub const RD_KAFKA_TIMESTAMP_CREATE_TIME: rd_kafka_timestamp_type_t = 1;
pub const RD_KAFKA_TIMESTAMP_NOT_AVAILABLE: rd_kafka_timestamp_type_t = 0;
...
static mut arginfo_class_RdKafka_Message_errstr: [zend_internal_arg_info; 1] = [
    {
...
static mut class_RdKafka_Message_methods: [zend_function_entry; 2] = [zend_function_entry {
...
unsafe extern "C" fn register_class_RdKafka_Message() -> *mut zend_class_entry {
    ...
    ce
        ...
        .unwrap()(
        b"RdKafka\\Message\0" as *const u8 as *const libc::c_char,
        (::std::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong),
        1 as libc::c_int,
    );
    ce.info.internal.builtin_functions = class_RdKafka_Message_methods.as_ptr();
    class_entry = zend_register_internal_class_ex(&mut ce, 0 as *mut zend_class_entry);
    let mut property_err_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_err_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_err_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        class_entry,
        property_err_name,
        &mut property_err_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_err_name);
    let mut property_topic_name_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_topic_name_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_topic_name_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        class_entry,
        property_topic_name_name,
        &mut property_topic_name_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_topic_name_name);
    let mut property_timestamp_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_timestamp_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_timestamp_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        ...
        &mut property_timestamp_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_timestamp_name);
    let mut property_partition_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_partition_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_partition_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        ...
        &mut property_partition_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_partition_name);
    let mut property_payload_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_payload_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_payload_name: *mut zend_string = zend_string_init(
        b"payload\0" as *const u8 as *const libc::c_char,
    ...
    zend_declare_property_ex(
        ...
        &mut property_payload_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_payload_name);
    let mut property_len_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_len_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_len_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        class_entry,
        property_len_name,
        &mut property_len_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_len_name);
    let mut property_key_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_key_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_key_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        class_entry,
        property_key_name,
        &mut property_key_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_key_name);
    let mut property_offset_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_offset_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_offset_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        ...
        &mut property_offset_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_offset_name);
    let mut property_headers_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_headers_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_headers_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        class_entry,
        property_headers_name,
        &mut property_headers_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
    zend_string_release(property_headers_name);
    let mut property_opaque_default_value: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    property_opaque_default_value.u1.type_info = 1 as libc::c_int as uint32_t;
    let mut property_opaque_name: *mut zend_string = zend_string_init(
    ...
    zend_declare_property_ex(
        class_entry,
        property_opaque_name,
        &mut property_opaque_default_value,
        (1 as libc::c_int) << 0 as libc::c_int,
        0 as *mut zend_string,
    );
...
pub static mut ce_kafka_message: *mut zend_class_entry = 0 as *const zend_class_entry
    as *mut zend_class_entry;
pub unsafe extern "C" fn kafka_message_new(
    mut return_value: *mut zval,
    mut message: *const rd_kafka_message_t,
    mut msg_opaque: *mut zend_string,
) {
    object_init_ex(return_value, ce_kafka_message);
    let mut tstype: rd_kafka_timestamp_type_t = RD_KAFKA_TIMESTAMP_NOT_AVAILABLE;
    let mut timestamp: int64_t = 0;
    timestamp = rd_kafka_message_timestamp(message, &mut tstype);
    let mut headers_array: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    let mut message_headers: *mut rd_kafka_headers_t = 0 as *mut rd_kafka_headers_t;
    let mut header_response: rd_kafka_resp_err_t = RD_KAFKA_RESP_ERR_NO_ERROR;
    let mut header_name: *const libc::c_char = 0 as *const libc::c_char;
    let mut header_value: *const libc::c_void = 0 as *const libc::c_void;
    let mut header_size: size_t = 0 as libc::c_int as size_t;
    let mut i: size_t = 0;
    zend_update_property_long(
        ...
        (::std::mem::size_of::<[libc::c_char; 4]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong),
        (*message).err as zend_long,
    );
    if !((*message).rkt).is_null() {
    ...
    zend_update_property_long(
        ...
        (::std::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong),
        (*message).partition as zend_long,
    );
    if !((*message).payload).is_null() {
        ...
        zend_update_property_stringl(
            ...
            (::std::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            (*message).payload as *const libc::c_char,
            (*message).len,
        );
        zend_update_property_long(
            0 as *mut zend_class_entry,
    ...
    if !((*message).key).is_null() {
        zend_update_property_stringl(
            ...
            (::std::mem::size_of::<[libc::c_char; 4]>() as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            (*message).key as *const libc::c_char,
            (*message).key_len,
        );
    }
    zend_update_property_long(
    ...
    let mut __z: *mut zval = &mut headers_array;
    (*__z).value.arr = __arr;
    (*__z)
        .u1
    ...
    if (*message).err as libc::c_int == RD_KAFKA_RESP_ERR_NO_ERROR as libc::c_int {
        rd_kafka_message_headers(message, &mut message_headers);
        if !message_headers.is_null() {
            i = 0 as libc::c_int as size_t;
            while i < rd_kafka_header_cnt(message_headers) {
                header_response = rd_kafka_header_get_all(
                    message_headers,
                    i,
                    &mut header_name,
                    &mut header_value,
                ...
                if header_response as libc::c_int
                    != RD_KAFKA_RESP_ERR_NO_ERROR as libc::c_int
                {
                    break;
                }
                add_assoc_stringl_ex(
                    ...
                    header_name,
                    strlen(header_name),
                    header_value as *const libc::c_char,
                    header_size,
                );
                i = i.wrapping_add(1);
                i;
    ...
    zval_ptr_dtor(&mut headers_array);
...
pub unsafe extern "C" fn kafka_message_list_to_array(
    mut return_value: *mut zval,
    mut messages: *mut *mut rd_kafka_message_t,
    mut size: libc::c_long,
) {
    let mut msg: *mut rd_kafka_message_t = 0 as *mut rd_kafka_message_t;
    let mut zmsg: zval = zval {
        value: _zend_value { lval: 0 },
        u1: C2RustUnnamed_1 {
            v: C2RustUnnamed_2 {
                type_0: 0,
    ...
    let mut __arr: *mut zend_array = if 0 != 0 {
        if size as uint32_t <= 8 as libc::c_int as libc::c_uint {
            _zend_new_array_0()
        } else {
            _zend_new_array(size as uint32_t)
        }
    } else {
        _zend_new_array(size as uint32_t)
    };
    ...
    while (i as libc::c_long) < size {
        msg = *messages.offset(i as isize);
        zmsg.u1.type_info = 1 as libc::c_int as uint32_t;
        kafka_message_new(&mut zmsg, msg, 0 as *mut zend_string);
        add_next_index_zval(return_value, &mut zmsg);
        i += 1;
        i;
    }
}
pub unsafe extern "C" fn zim_RdKafka_Message_errstr(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut zerr: *mut zval = 0 as *mut zval;
    let mut zpayload: *mut zval = 0 as *mut zval;
    ...
    if zerr.is_null() || zval_get_type(zerr) as libc::c_int != 4 as libc::c_int {
        return;
    }
    errstr = rd_kafka_err2str((*zerr).value.lval as rd_kafka_resp_err_t);
    if !errstr.is_null() {
    ...
    zpayload = rdkafka_read_property(
        0 as *mut zend_class_entry,
        if zval_get_type(&mut (*execute_data).This) as libc::c_int == 8 as libc::c_int {
            &mut (*execute_data).This
        } else {
    ...
    if !zpayload.is_null() && zval_get_type(zpayload) as libc::c_int == 6 as libc::c_int
    {
        let mut __z_0: *mut zval = return_value;
        let mut __zv: *mut zval = zpayload;
        if !(zval_get_type(__zv) as libc::c_int == 10 as libc::c_int) as libc::c_int
            as libc::c_long != 0
        {
            if 1 as libc::c_int != 0 && 0 as libc::c_int == 0 {
                let mut _z1: *mut zval = __z_0;
...
pub unsafe extern "C" fn kafka_message_minit(
    ...
    class_RdKafka_Message_methods = [
        {
            let mut init = _zend_function_entry {
                fname: b"errstr\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_Message_errstr
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Message_errstr.as_ptr(),
