...
pub struct _object_intern {
    pub zmetadata: zval,
    pub metadata_broker: *const rd_kafka_metadata_broker_t,
    pub std: zend_object,
}
#[inline(always)]
...
static mut arginfo_class_RdKafka_Metadata_Broker___construct: [zend_internal_arg_info; 1] = [
    {
...
static mut arginfo_class_RdKafka_Metadata_Broker_getId: [zend_internal_arg_info; 1] = [
    {
        let mut init = _zend_internal_arg_info {
            name: 0 as *const libc::c_char,
            type_0: 0 as libc::c_int as zend_type,
...
static mut class_RdKafka_Metadata_Broker_methods: [zend_function_entry; 5] = [zend_function_entry {
...
unsafe extern "C" fn register_class_RdKafka_Metadata_Broker() -> *mut zend_class_entry {
    ...
    ce_0
        ...
        .unwrap()(
        b"RdKafka\\Metadata\\Broker\0" as *const u8 as *const libc::c_char,
    ...
    ce_0
        .info
        .internal
        .builtin_functions = class_RdKafka_Metadata_Broker_methods.as_ptr();
...
unsafe extern "C" fn free_object(mut object: *mut zend_object) {
    ...
    if !((*intern).metadata_broker).is_null() {
...
unsafe extern "C" fn get_object(mut zmt: *mut zval) -> *mut object_intern {
    let mut omt: *mut object_intern = ((*zmt).value.obj as *mut libc::c_char)
        .offset(-(24 as libc::c_ulong as isize)) as *mut object_intern;
    if ((*omt).metadata_broker).is_null() {
        zend_throw_exception_ex(
            0 as *mut zend_class_entry,
            0 as libc::c_int as zend_long,
            b"RdKafka\\Metadata\\Broker::__construct() has not been called\0"
...
unsafe extern "C" fn get_debug_info(
    ...
    *is_temp = 1 as libc::c_int;
    ...
    intern = ((*object).value.obj as *mut libc::c_char)
        .offset(-(24 as libc::c_ulong as isize)) as *mut object_intern;
    if intern.is_null() || ((*intern).metadata_broker).is_null() {
    ...
    add_assoc_long_ex(
        ...
        (*(*intern).metadata_broker).id as zend_long,
    );
    add_assoc_string_ex(
        &mut ary,
        b"host\0" as *const u8 as *const libc::c_char,
        strlen(b"host\0" as *const u8 as *const libc::c_char),
        (*(*intern).metadata_broker).host,
    );
    add_assoc_long_ex(
        &mut ary,
        b"port\0" as *const u8 as *const libc::c_char,
        strlen(b"port\0" as *const u8 as *const libc::c_char),
        (*(*intern).metadata_broker).port as zend_long,
    );
    return ary.value.arr;
}
pub unsafe extern "C" fn zim_RdKafka_Metadata_Broker_getId(
    ...
    (*__z).value.lval = (*(*intern).metadata_broker).id as zend_long;
    (*__z).u1.type_info = 4 as libc::c_int as uint32_t;
}
pub unsafe extern "C" fn zim_RdKafka_Metadata_Broker_getHost(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    ...
    let mut _s: *const libc::c_char = (*(*intern).metadata_broker).host;
    let mut __z: *mut zval = return_value;
...
pub unsafe extern "C" fn zim_RdKafka_Metadata_Broker_getPort(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    ...
    let mut __z: *mut zval = return_value;
    (*__z).value.lval = (*(*intern).metadata_broker).port as zend_long;
    (*__z).u1.type_info = 4 as libc::c_int as uint32_t;
}
pub unsafe extern "C" fn kafka_metadata_broker_minit(
...
pub unsafe extern "C" fn kafka_metadata_broker_ctor(
    mut return_value: *mut zval,
    mut zmetadata: *mut zval,
    mut data: *const libc::c_void,
) {
    let mut metadata_broker: *mut rd_kafka_metadata_broker_t = data
        as *mut rd_kafka_metadata_broker_t;
    let mut intern: *mut object_intern = 0 as *mut object_intern;
...
unsafe extern "C" fn run_static_initializers() {
    class_RdKafka_Metadata_Broker_methods = [
        {
            let mut init = _zend_function_entry {
                ...
                arg_info: arginfo_class_RdKafka_Metadata_Broker___construct.as_ptr(),
        ...
        },
        {
            let mut init = _zend_function_entry {
                ...
                handler: Some(
                    zim_RdKafka_Metadata_Broker_getId
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_Broker_getId.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
                    as libc::c_ulong)
                    .wrapping_div(
                        ::std::mem::size_of::<_zend_internal_arg_info>() as libc::c_ulong,
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getHost\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_Metadata_Broker_getHost
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_Broker_getId.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getPort\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_Metadata_Broker_getPort
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_Broker_getId.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
