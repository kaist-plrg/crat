...
extern "C" {
    ...
    fn kafka_metadata_partition_ctor(
        return_value: *mut zval,
        zmetadata: *mut zval,
        metadata_partition: *const libc::c_void,
    );
...
pub struct _object_intern {
    pub zmetadata: zval,
    pub metadata_topic: *const rd_kafka_metadata_topic_t,
    pub std: zend_object,
}
#[inline(always)]
...
static mut arginfo_class_RdKafka_Metadata_Topic___construct: [zend_internal_arg_info; 1] = [
    {
...
static mut arginfo_class_RdKafka_Metadata_Topic_getTopic: [zend_internal_arg_info; 1] = [
    {
        let mut init = _zend_internal_arg_info {
            name: 0 as *const libc::c_char,
            type_0: 0 as libc::c_int as zend_type,
...
static mut class_RdKafka_Metadata_Topic_methods: [zend_function_entry; 5] = [zend_function_entry {
...
unsafe extern "C" fn register_class_RdKafka_Metadata_Topic() -> *mut zend_class_entry {
    ...
    ce_0
        ...
        .unwrap()(
        b"RdKafka\\Metadata\\Topic\0" as *const u8 as *const libc::c_char,
        (::std::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong),
        1 as libc::c_int,
    );
    ce_0.info.internal.builtin_functions = class_RdKafka_Metadata_Topic_methods.as_ptr();
...
unsafe extern "C" fn partitions_collection(
    ...
    kafka_metadata_collection_init(
        return_value,
        parent,
        (*(*intern).metadata_topic).partitions as *const libc::c_void,
        (*(*intern).metadata_topic).partition_cnt as size_t,
        ::std::mem::size_of::<rd_kafka_metadata_partition>() as libc::c_ulong,
        Some(
            kafka_metadata_partition_ctor
...
unsafe extern "C" fn free_object(mut object: *mut zend_object) {
    ...
    if !((*intern).metadata_topic).is_null() {
...
unsafe extern "C" fn get_object(mut zmt: *mut zval) -> *mut object_intern {
    let mut omt: *mut object_intern = ((*zmt).value.obj as *mut libc::c_char)
        .offset(-(24 as libc::c_ulong as isize)) as *mut object_intern;
    if ((*omt).metadata_topic).is_null() {
        zend_throw_exception_ex(
            0 as *mut zend_class_entry,
            0 as libc::c_int as zend_long,
            b"RdKafka\\Metadata\\Topic::__construct() has not been called\0" as *const u8
...
unsafe extern "C" fn get_debug_info(
    ...
    *is_temp = 1 as libc::c_int;
    ...
    intern = ((*object).value.obj as *mut libc::c_char)
        .offset(-(24 as libc::c_ulong as isize)) as *mut object_intern;
    if intern.is_null() || ((*intern).metadata_topic).is_null() {
    ...
    add_assoc_string_ex(
        ...
        (*(*intern).metadata_topic).topic,
    );
    partitions.u1.type_info = 1 as libc::c_int as uint32_t;
    partitions_collection(&mut partitions, object, intern);
    add_assoc_zval_ex(
        &mut ary,
        b"partitions\0" as *const u8 as *const libc::c_char,
        strlen(b"partitions\0" as *const u8 as *const libc::c_char),
        &mut partitions,
    );
    add_assoc_long_ex(
        &mut ary,
        ...
        (*(*intern).metadata_topic).err as zend_long,
    );
    return ary.value.arr;
}
pub unsafe extern "C" fn zim_RdKafka_Metadata_Topic_getTopic(
    ...
    let mut _s: *const libc::c_char = (*(*intern).metadata_topic).topic;
...
pub unsafe extern "C" fn zim_RdKafka_Metadata_Topic_getErr(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
    ...
    let mut __z: *mut zval = return_value;
    (*__z).value.lval = (*(*intern).metadata_topic).err as zend_long;
    (*__z).u1.type_info = 4 as libc::c_int as uint32_t;
}
pub unsafe extern "C" fn zim_RdKafka_Metadata_Topic_getPartitions(
    mut execute_data: *mut zend_execute_data,
    mut return_value: *mut zval,
) {
    let mut intern: *mut object_intern = 0 as *mut object_intern;
...
pub unsafe extern "C" fn kafka_metadata_topic_minit(
...
pub unsafe extern "C" fn kafka_metadata_topic_ctor(
    mut return_value: *mut zval,
    mut zmetadata: *mut zval,
    mut data: *const libc::c_void,
) {
    let mut metadata_topic: *mut rd_kafka_metadata_topic_t = data
        as *mut rd_kafka_metadata_topic_t;
    let mut intern: *mut object_intern = 0 as *mut object_intern;
...
unsafe extern "C" fn run_static_initializers() {
    class_RdKafka_Metadata_Topic_methods = [
        {
            let mut init = _zend_function_entry {
                ...
                arg_info: arginfo_class_RdKafka_Metadata_Topic___construct.as_ptr(),
        ...
        },
        {
            let mut init = _zend_function_entry {
                ...
                handler: Some(
                    zim_RdKafka_Metadata_Topic_getTopic
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_Topic_getTopic.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
                    as libc::c_ulong)
                    .wrapping_div(
                        ::std::mem::size_of::<_zend_internal_arg_info>() as libc::c_ulong,
        ...
        },
        {
            let mut init = _zend_function_entry {
                ...
                handler: Some(
                    zim_RdKafka_Metadata_Topic_getErr
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_Topic_getTopic.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
        ...
        {
            let mut init = _zend_function_entry {
                fname: b"getPartitions\0" as *const u8 as *const libc::c_char,
                handler: Some(
                    zim_RdKafka_Metadata_Topic_getPartitions
                        as unsafe extern "C" fn(*mut zend_execute_data, *mut zval) -> (),
                ),
                arg_info: arginfo_class_RdKafka_Metadata_Topic_getTopic.as_ptr(),
                num_args: (::std::mem::size_of::<[zend_internal_arg_info; 1]>()
