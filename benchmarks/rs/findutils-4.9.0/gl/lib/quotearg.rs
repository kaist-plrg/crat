    ...
    '_process_input: loop {
        ...
        match quoting_style as libc::c_uint {
            6 => {
                ...
                current_block_47 = 9080453953395393584;
            }
            5 => {
                current_block_47 = 9080453953395393584;
            }
            ...
            3 => {
                backslash_escapes = 1 as libc::c_int != 0;
                current_block_47 = 12646571442105645948;
            }
            1 => {
                current_block_47 = 12646571442105645948;
            }
            4 => {
                current_block_47 = 17797373342310498984;
            }
            2 => {
        ...
        } == 0
        {
            ...
            {
                if elide_outer_quotes {
                    current_block = 11233652323963016008;
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 7510126661828808164;
                            match current_block {
                                7510126661828808164 => {
                                    if elide_outer_quotes {
                                        current_block = 11233652323963016008;
                        ...
                        5 => {
                            current_block = 2879063718477978487;
                            match current_block {
                                7510126661828808164 => {
                                    if elide_outer_quotes {
                                        current_block = 11233652323963016008;
                ...
                7 => {
                    ...
                    current_block = 9977971425456396732;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 12671670376631433970;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 10376421133956149346;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 16014052840155008140;
                    }
                }
                35 | 126 => {
                    current_block = 16014052840155008140;
                ...
                32 => {
                    current_block = 12236582163728144121;
                }
                33 => {
                    current_block = 10358861861386579380;
                }
                34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 => {
                    current_block = 14904599392459668326;
                }
                62 | 91 | 94 => {
                    current_block = 1024606310598961621;
                }
                96 | 124 => {
            ...
            match current_block {
                10358861861386579380 => {
                    current_block = 14904599392459668326;
                }
                _ => {}
            }
            match current_block {
                14904599392459668326 => {
                    current_block = 1024606310598961621;
                }
                _ => {}
            }
