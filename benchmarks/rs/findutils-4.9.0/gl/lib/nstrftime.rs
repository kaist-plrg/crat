    ...
    while *f as libc::c_int != '\0' as i32 {
        ...
        if *f as libc::c_int != '%' as i32 {
                ...
                <= 9 as libc::c_int as libc::c_uint
            {
                ...
                loop {
                    if (if ::std::mem::size_of::<libc::c_int>() as libc::c_ulong
            ...
            match format_char {
                37 => {
                    if f.offset(-(1 as libc::c_int as isize)) != percent {
                        current_block = 12057777778687874600;
                    } else {
                ...
                97 => {
                    if modifier != 0 as libc::c_int {
                        current_block = 17342178753796048488;
                    } else {
                        if change_case {
                            to_uppcase = 1 as libc::c_int != 0;
                            to_lowcase = 0 as libc::c_int != 0;
                        }
                        current_block = 13631792190498755770;
                    }
                }
                65 => {
                    if modifier != 0 as libc::c_int {
                ...
                67 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 11120583983995094340;
                    }
                }
                120 => {
                    if modifier == 'O' as i32 {
                ...
                68 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 7903145896047294534;
                    }
                }
                100 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 9009306013276239202;
                    }
                }
                101 => {
                    if modifier == 'E' as i32 {
                        ...
                        digits = 2 as libc::c_int;
                        number_value = (*tp).tm_mday;
                        current_block = 7367216628788411751;
                    }
                }
                70 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 2620324242058733012;
                    }
                }
                72 => {
                    if modifier == 'E' as i32 {
                ...
                106 => {
                    if modifier == 'E' as i32 {
                        ...
                        u_number_value = ((*tp).tm_yday as libc::c_uint)
                            .wrapping_add(1 as libc::c_uint);
                        current_block = 17598850276088554561;
                    }
                }
                77 => {
                    if modifier == 'E' as i32 {
                ...
                80 => {
                    ...
                    current_block = 2930060197450468266;
                }
                112 => {
                    current_block = 2930060197450468266;
                }
                ...
                115 => {
                    ...
                    current_block = 4170154385241456296;
                }
                88 => {
                    if modifier == 'O' as i32 {
                        current_block = 17342178753796048488;
                ...
                58 => {
                    ...
                    if *f.offset(colons as isize) as libc::c_int != 'z' as i32 {
                        ...
                        current_block = 10116164008318837169;
                    }
                }
                122 => {
                ...
                _ => {
                    match current_block {
                        11120583983995094340 => {
                            ...
                            current_block = 9101924503188412562;
                        }
                        10116164008318837169 => {
                            if (*tp).tm_isdst < 0 as libc::c_int {
                                ...
                                match colons {
                                    0 => {
                                        ...
                                        match current_block {
                                            14795592282877320006 => {
                                                ...
                                                u_number_value = (hour_diff * 100 as libc::c_int + min_diff)
                                                    as libc::c_uint;
                                                current_block = 704395504574082038;
                                            }
                                            16447570354664244416 => {
                                        ...
                                        current_block = 15009779722110488868;
                                    }
                                    1 => {
                                        current_block = 6225579869370739012;
                                        match current_block {
                                    ...
                                    3 => {
                                        current_block = 16447570354664244416;
                                        match current_block {
                                            14795592282877320006 => {
                                                digits = 5 as libc::c_int;
                                                tz_colon_mask = 0 as libc::c_int;
