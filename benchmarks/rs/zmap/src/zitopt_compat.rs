...
pub const ARG_LONGLONG: cmdline_parser_arg_type = 3;
...
pub unsafe extern "C" fn cmdline_parser_print_version() {
    printf(
        b"%s %s\n\0" as *const u8 as *const libc::c_char,
        if strlen(b"ziterate\0" as *const u8 as *const libc::c_char) != 0 {
            b"ziterate\0" as *const u8 as *const libc::c_char
        } else {
            b"ziterate\0" as *const u8 as *const libc::c_char
        },
...
unsafe extern "C" fn init_args_info(mut args_info: *mut gengetopt_args_info) {
    ...
    (*args_info)
        .ignore_blocklist_errors_help = gengetopt_args_info_help[5 as libc::c_int
        as usize];
    (*args_info).seed_help = gengetopt_args_info_help[6 as libc::c_int as usize];
    (*args_info).max_targets_help = gengetopt_args_info_help[7 as libc::c_int as usize];
    (*args_info)
        .disable_syslog_help = gengetopt_args_info_help[8 as libc::c_int as usize];
    (*args_info).shards_help = gengetopt_args_info_help[10 as libc::c_int as usize];
    (*args_info).shard_help = gengetopt_args_info_help[11 as libc::c_int as usize];
    (*args_info).help_help = gengetopt_args_info_help[13 as libc::c_int as usize];
    (*args_info).version_help = gengetopt_args_info_help[14 as libc::c_int as usize];
}
...
unsafe extern "C" fn cmdline_parser_internal(
    ...
    loop {
        ...
        c = getopt_long(
            argc,
            argv,
            b"b:w:l:v:e:n:hV\0" as *const u8 as *const libc::c_char,
        ...
        match c {
            98 => {
                ...
                {
                    current_block = 17323745642727553576;
                    break;
                }
            }
            119 => {
...
pub static mut gengetopt_args_info_purpose: *const libc::c_char = b"A tool for iterating over the IPv4 space\0"
    as *const u8 as *const libc::c_char;
pub static mut gengetopt_args_info_usage: *const libc::c_char = b"Usage: ziterate [OPTION]... [SUBNETS]...\0"
    as *const u8 as *const libc::c_char;
pub static mut gengetopt_args_info_description: *const libc::c_char = b"\0" as *const u8
    as *const libc::c_char;
pub static mut gengetopt_args_info_help: [*const libc::c_char; 17] = [
    ...
    b"  -e, --seed=n                  Seed used to select address permutation\0"
        as *const u8 as *const libc::c_char,
    b"  -n, --max-targets=n           Cap number of IPs to generate (as a number or a\n                                  percentage of the address space)\0"
        as *const u8 as *const libc::c_char,
    b"      --disable-syslog          Disables logging messages to syslog\0" as *const u8
        as *const libc::c_char,
    b"\nSharding:\0" as *const u8 as *const libc::c_char,
    b"      --shards=N                total number of shards  (default=`1')\0"
        as *const u8 as *const libc::c_char,
    b"      --shard=n                 shard this scan is targeting (0 indexed)\n                                  (default=`0')\0"
        as *const u8 as *const libc::c_char,
