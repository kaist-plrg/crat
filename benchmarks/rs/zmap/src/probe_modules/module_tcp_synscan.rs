...
unsafe extern "C" fn synscan_init_perthread(
    ...
    make_tcp_header(tcp_header, dst_port, 0x2 as libc::c_int as uint16_t);
...
unsafe extern "C" fn synscan_make_packet(
    ...
    let mut sport: port_h_t = get_src_port(
        num_ports as libc::c_int,
        probe_num,
        validation,
    );
    (*tcp_header).c2rust_unnamed.c2rust_unnamed.th_sport = __bswap_16(sport);
...
pub unsafe extern "C" fn synscan_print_packet(
    ...
    let mut iph: *mut ip = &mut *ethh.offset(1 as libc::c_int as isize)
        as *mut ether_header as *mut ip;
    let mut tcph: *mut tcphdr = &mut *iph.offset(1 as libc::c_int as isize) as *mut ip
        as *mut tcphdr;
    fprintf(
        fp,
        b"tcp { source: %u | dest: %u | seq: %u | checksum: %#04X }\n\0" as *const u8
            as *const libc::c_char,
        __bswap_16((*tcph).c2rust_unnamed.c2rust_unnamed.th_sport) as libc::c_int,
        __bswap_16((*tcph).c2rust_unnamed.c2rust_unnamed.th_dport) as libc::c_int,
        __bswap_32((*tcph).c2rust_unnamed.c2rust_unnamed.th_seq),
        __bswap_16((*tcph).c2rust_unnamed.c2rust_unnamed.th_sum) as libc::c_int,
    );
...
unsafe extern "C" fn synscan_validate_packet(
    ...
    if (*ip_hdr).ip_p as libc::c_int == IPPROTO_TCP as libc::c_int {
        ...
        let mut sport: port_h_t = __bswap_16(
            (*tcp).c2rust_unnamed.c2rust_unnamed.th_sport,
        );
        let mut dport: port_h_t = __bswap_16(
            ...
            & 0x4 as libc::c_int != 0
        {
            if __bswap_32((*tcp).c2rust_unnamed.c2rust_unnamed.th_ack)
                ...
                && __bswap_32((*tcp).c2rust_unnamed.c2rust_unnamed.th_ack)
                    != (__bswap_32(*validation.offset(0 as libc::c_int as isize)))
        ...
        let mut sport_0: port_h_t = __bswap_16(
            (*tcp_0).c2rust_unnamed.c2rust_unnamed.th_sport,
        );
        let mut dport_0: port_h_t = __bswap_16(
            (*tcp_0).c2rust_unnamed.c2rust_unnamed.th_dport,
        );
        if dport_0 as libc::c_int != target_port as libc::c_int {
            return 0 as libc::c_int;
        }
        validate_gen(
...
unsafe extern "C" fn synscan_process_packet(
    ...
    if !ip_hdr.is_null() {} else {
        __assert_fail(
            ...
            b"probe_modules/module_tcp_synscan.c\0" as *const u8 as *const libc::c_char,
            175 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<
                &[u8; 97],
                &[libc::c_char; 97],
            >(
                b"void synscan_process_packet(const u_char *, uint32_t, fieldset_t *, uint32_t *, struct timespec)\0",
            ))
                .as_ptr(),
        );
    }
    'c_6303: {
        if !ip_hdr.is_null() {} else {
            __assert_fail(
                b"ip_hdr\0" as *const u8 as *const libc::c_char,
                b"probe_modules/module_tcp_synscan.c\0" as *const u8
                    as *const libc::c_char,
                175 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<
                    &[u8; 97],
