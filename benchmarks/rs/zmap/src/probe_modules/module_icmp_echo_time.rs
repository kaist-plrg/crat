...
unsafe extern "C" fn icmp_echo_init_perthread(
    ...
    let mut len: uint16_t = __bswap_16(
        (::std::mem::size_of::<ip>() as libc::c_ulong)
            ...
            .wrapping_sub(8 as libc::c_int as libc::c_ulong) as __uint16_t,
    );
...
unsafe extern "C" fn icmp_echo_make_packet(
    ...
    let mut icmp_header: *mut icmp = &mut *ip_header.offset(1 as libc::c_int as isize)
        as *mut ip as *mut icmp;
    let mut payload: *mut icmp_payload_for_rtt = (icmp_header as *mut libc::c_char)
        .offset(8 as libc::c_int as isize) as *mut icmp_payload_for_rtt;
...
unsafe extern "C" fn icmp_validate_packet(
    ...
    if (4 as libc::c_int as uint32_t)
        .wrapping_mul((*ip_hdr).ip_hl())
        .wrapping_add(5 as libc::c_int as libc::c_uint) > len
    {
        return 0 as libc::c_int;
    }
    let mut icmp_h: *mut icmp = (ip_hdr as *mut libc::c_char)
        .offset((4 as libc::c_int * (*ip_hdr).ip_hl() as libc::c_int) as isize)
        as *mut icmp;
    let mut icmp_idnum: uint16_t = (*icmp_h).icmp_hun.ih_idseq.icd_id;
    let mut icmp_seqnum: uint16_t = (*icmp_h).icmp_hun.ih_idseq.icd_seq;
    if (*icmp_h).icmp_type as libc::c_int == 11 as libc::c_int
        || (*icmp_h).icmp_type as libc::c_int == 3 as libc::c_int
    {
        if ((4 as libc::c_int * (*ip_hdr).ip_hl() as libc::c_int + 8 as libc::c_int)
            as libc::c_ulong)
        ...
        let mut ip_inner: *mut ip = (icmp_h as *mut libc::c_char)
            .offset(8 as libc::c_int as isize) as *mut ip;
        if (4 as libc::c_int as uint32_t)
            .wrapping_mul((*ip_hdr).ip_hl())
            .wrapping_add(8 as libc::c_int as libc::c_uint)
            .wrapping_add(
                (4 as libc::c_int * (*ip_inner).ip_hl() as libc::c_int) as libc::c_uint,
            )
            .wrapping_add(8 as libc::c_int as libc::c_uint) > len
        {
            return 0 as libc::c_int;
        }
        let mut icmp_inner: *mut icmp = (ip_inner as *mut libc::c_char)
            .offset((4 as libc::c_int * (*ip_hdr).ip_hl() as libc::c_int) as isize)
            as *mut icmp;
...
unsafe extern "C" fn icmp_echo_process_packet(
    ...
    let mut payload: *mut icmp_payload_for_rtt = (icmp_hdr as *mut libc::c_char)
        .offset(8 as libc::c_int as isize) as *mut icmp_payload_for_rtt;
    fs_add_uint64(
        fs,
