...
unsafe extern "C" fn __strftime_internal(
    ...
    while *f as libc::c_int != '\0' as i32 {
        ...
        let mut sign_char: libc::c_char = 0;
        ...
        if *f as libc::c_int != '%' as i32 {
            ...
            let mut _w: size_t = (if width < 0 as libc::c_int {
                0 as libc::c_int
            } else {
                width
            }) as size_t;
            ...
            if !p.is_null() {
                if digits == 0 as libc::c_int && _n < _w {
                    let mut _delta: size_t = (width as libc::c_ulong).wrapping_sub(_n);
                    if pad == '0' as i32 {
            ...
            match format_char {
                37 => {
                    if modifier != 0 as libc::c_int {
                        current_block = 9324994853405344624;
                    } else {
                        let mut _n_0: size_t = 1 as libc::c_int as size_t;
                        let mut _w_0: size_t = (if width < 0 as libc::c_int {
                            0 as libc::c_int
                        } else {
                            width
                        }) as size_t;
                        ...
                        if !p.is_null() {
                            if digits == 0 as libc::c_int && _n_0 < _w_0 {
                                let mut _delta_0: size_t = (width as libc::c_ulong)
                                    .wrapping_sub(_n_0);
                                if pad == '0' as i32 {
                ...
                97 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 5472623869413499089;
                    }
                }
                65 => {
                    if modifier != 0 as libc::c_int {
                ...
                67 => {
                    if modifier == 'E' as i32 {
                        ...
                        let mut century: libc::c_int = (*tp).tm_year / 100 as libc::c_int
                            + 1900 as libc::c_int / 100 as libc::c_int;
                        century
                            -= (((*tp).tm_year % 100 as libc::c_int) < 0 as libc::c_int
                                && (0 as libc::c_int) < century) as libc::c_int;
                        digits = 2 as libc::c_int;
                        negative_number = (*tp).tm_year < -(1900 as libc::c_int);
                        u_number_value = century as libc::c_uint;
                        current_block = 11558581800383873459;
                    }
                }
                120 => {
                    if modifier == 'O' as i32 {
                ...
                68 => {
                    if modifier != 0 as libc::c_int {
                        ...
                        current_block = 15557672952378041288;
                    }
                }
                100 => {
                    if modifier == 'E' as i32 {
                        ...
                        current_block = 11313660210605209331;
                    }
                }
                101 => {
                    if modifier == 'E' as i32 {
                        ...
                        digits = 2 as libc::c_int;
                        number_value = (*tp).tm_mday;
                        current_block = 10318915748027261447;
                    }
                }
                70 => {
                    if modifier != 0 as libc::c_int {
                ...
                78 => {
                    if modifier == 'E' as i32 {
                        ...
                        if width == -(1 as libc::c_int) {
                            width = 9 as libc::c_int;
                        } else {
                            let mut j: libc::c_int = 0;
                            j = width;
                            while j < 9 as libc::c_int {
                                number_value /= 10 as libc::c_int;
                                j += 1;
                                j;
                            }
                        }
                ...
                110 => {
                    ...
                    let mut _w_8: size_t = (if width < 0 as libc::c_int {
                        0 as libc::c_int
                    } else {
                        width
                    }) as size_t;
                    ...
                    if !p.is_null() {
                        if digits == 0 as libc::c_int && _n_8 < _w_8 {
                            let mut _delta_8: size_t = (width as libc::c_ulong)
                                .wrapping_sub(_n_8);
                            if pad == '0' as i32 {
                ...
                80 => {
                    ...
                    current_block = 5426526603503222773;
                }
                112 => {
                    current_block = 5426526603503222773;
                }
                ...
                115 => {
                    ...
                    bufp = buf
                        .as_mut_ptr()
                        .offset(
                            (::std::mem::size_of::<[libc::c_char; 23]>()
                                as libc::c_ulong)
                                .wrapping_div(
                    ...
                    current_block = 16277637496040828215;
                }
                88 => {
                    if modifier == 'O' as i32 {
                        current_block = 9324994853405344624;
                ...
                116 => {
                    let mut _n_9: size_t = 1 as libc::c_int as size_t;
                    let mut _w_9: size_t = (if width < 0 as libc::c_int {
                        0 as libc::c_int
                    } else {
                        width
                    }) as size_t;
                    ...
                    if !p.is_null() {
                        if digits == 0 as libc::c_int && _n_9 < _w_9 {
                            let mut _delta_9: size_t = (width as libc::c_ulong)
                                .wrapping_sub(_n_9);
                            if pad == '0' as i32 {
                    ...
                    if modifier == 'E' as i32 {
                        ...
                        match *f as libc::c_int {
                            103 => {
                                ...
                                digits = 2 as libc::c_int;
                                number_value = if 0 as libc::c_int <= yy {
                                    yy
                                } else if (*tp).tm_year
                ...
                90 => {
                    ...
                    let mut _n_10: size_t = strlen(zone);
                    let mut _w_10: size_t = (if width < 0 as libc::c_int {
                        0 as libc::c_int
                    } else {
                        width
                    }) as size_t;
                    let mut _incr_10: size_t = if _n_10 < _w_10 { _w_10 } else { _n_10 };
                    if _incr_10 >= maxsize.wrapping_sub(i) {
                        return 0 as libc::c_int as size_t;
                    }
                    if !p.is_null() {
                        if digits == 0 as libc::c_int && _n_10 < _w_10 {
                            let mut _delta_10: size_t = (width as libc::c_ulong)
                                .wrapping_sub(_n_10);
                            if pad == '0' as i32 {
                        ...
                        if to_lowcase {
                            memcpy_lowcase(p, zone, _n_10);
                        } else if to_uppcase {
                            memcpy_uppcase(p, zone, _n_10);
                        } else {
                            memcpy(
                    ...
                    i = (i as libc::c_ulong).wrapping_add(_incr_10) as size_t as size_t;
                    current_block = 13513818773234778473;
                }
                58 => {
                    ...
                    if *f.offset(colons as isize) as libc::c_int != 'z' as i32 {
                        ...
                        current_block = 12314923692570678399;
                    }
                }
                122 => {
                    ...
                    match current_block {
                        12314923692570678399 => {
                            if (*tp).tm_isdst < 0 as libc::c_int {
                                ...
                                match colons {
                                    0 => {
                                        current_block = 3814992378180292084;
                                        match current_block {
                                            3814992378180292084 => {
                                        ...
                                        current_block = 13093966305570064487;
                                    }
                                    1 => {
                                        current_block = 3878748411117650840;
                                        match current_block {
                                    ...
                                    3 => {
                                        current_block = 15525655650990252292;
                                        match current_block {
                                            3814992378180292084 => {
                                                digits = 5 as libc::c_int;
                                                tz_colon_mask = 0 as libc::c_int;
                        ...
                        10318915748027261447 => {
                            if pad != '0' as i32 && pad != '-' as i32 {
                                pad = '_' as i32;
                            }
                            current_block = 11313660210605209331;
                        }
                        15557672952378041288 => {
                            ...
                            let mut _w_1: size_t = (if width < 0 as libc::c_int {
                                0 as libc::c_int
                            } else {
                                width
                            }) as size_t;
                            ...
                            if !p.is_null() {
                                if digits == 0 as libc::c_int && _n_1 < _w_1 {
                                    let mut _delta_1: size_t = (width as libc::c_ulong)
                                        .wrapping_sub(_n_1);
                                    if pad == '0' as i32 {
                        ...
                        _ => {
                            match current_block {
                                ...
                                9324994853405344624 => {
                                    ...
                                    let mut _n_11: size_t = flen as size_t;
                                    let mut _w_11: size_t = (if width < 0 as libc::c_int {
                                        0 as libc::c_int
                                    } else {
                                        width
                                    }) as size_t;
                                    let mut _incr_11: size_t = if _n_11 < _w_11 {
                                        _w_11
                                    } else {
                                        _n_11
                                    };
                                    if _incr_11 >= maxsize.wrapping_sub(i) {
                                        return 0 as libc::c_int as size_t;
                                    }
                                    if !p.is_null() {
                                        if digits == 0 as libc::c_int && _n_11 < _w_11 {
                                            let mut _delta_11: size_t = (width as libc::c_ulong)
                                                .wrapping_sub(_n_11);
                                            if pad == '0' as i32 {
                                                memset(p as *mut libc::c_void, '0' as i32, _delta_11);
                                                p = p.offset(_delta_11 as isize);
                                            } else {
                                                memset(p as *mut libc::c_void, ' ' as i32, _delta_11);
                                                p = p.offset(_delta_11 as isize);
                                            }
                                        }
                                        if to_lowcase {
                                        ...
                                        p = p.offset(_n_11 as isize);
                                    }
                                    i = (i as libc::c_ulong).wrapping_add(_incr_11) as size_t
                                        as size_t;
                                    current_block = 13513818773234778473;
                                }
                                _ => {}
                                ...
                                _ => {
                                    ...
                                    match current_block {
                                        5472623869413499089 => {
                                            ...
                                            *u = '\0' as i32 as libc::c_char;
                                            ...
                                            if len_0 != 0 as libc::c_int as libc::c_ulong {
                                                ...
                                                let mut _w_2: size_t = (if width < 0 as libc::c_int {
                                                    0 as libc::c_int
                                                } else {
                                                    width
                                                }) as size_t;
                                                ...
                                                if !p.is_null() {
                                                    if digits == 0 as libc::c_int && _n_2 < _w_2 {
                                                        let mut _delta_2: size_t = (width as libc::c_ulong)
                                                            .wrapping_sub(_n_2);
                                                        if pad == '0' as i32 {
                                        ...
                                        _ => {
                                            ...
                                            sign_char = (if negative_number as libc::c_int != 0 {
                                                '-' as i32
                                            ...
                                            if pad == '-' as i32 {
                                                if sign_char != 0 {
                                                    ...
                                                    let mut _w_3: size_t = (if width < 0 as libc::c_int {
                                                        0 as libc::c_int
                                                    } else {
                                                        width
                                                    }) as size_t;
                                                    ...
                                                    if !p.is_null() {
                                                        if digits == 0 as libc::c_int && _n_3 < _w_3 {
                                                            let mut _delta_3: size_t = (width as libc::c_ulong)
                                                                .wrapping_sub(_n_3);
                                                            if pad == '0' as i32 {
                                                ...
                                                let mut padding: libc::c_int = (digits as libc::c_long
                                                    - buf
                                                        .as_mut_ptr()
                                                        .offset(
                                                            (::std::mem::size_of::<[libc::c_char; 23]>()
                                                        ...
                                                        .offset_from(bufp) as libc::c_long
                                                    - (sign_char != 0) as libc::c_int as libc::c_long)
                                                    as libc::c_int;
                                                if padding > 0 as libc::c_int {
                                                    if pad == '_' as i32 {
                                                        if padding as size_t >= maxsize.wrapping_sub(i) {
                                                            return 0 as libc::c_int as size_t;
                                                        }
                                                        if !p.is_null() {
                                                            memset(
                                                        ...
                                                        if sign_char != 0 {
                                                            let mut _n_4: size_t = 1 as libc::c_int as size_t;
                                                            let mut _w_4: size_t = (if width < 0 as libc::c_int {
                                                                0 as libc::c_int
                                                            } else {
                                                                width
                                                            }) as size_t;
                                                            ...
                                                            if !p.is_null() {
                                                                if digits == 0 as libc::c_int && _n_4 < _w_4 {
                                                                    let mut _delta_4: size_t = (width as libc::c_ulong)
                                                                        .wrapping_sub(_n_4);
                                                                    if pad == '0' as i32 {
                                                        ...
                                                        if digits as size_t >= maxsize.wrapping_sub(i) {
                                                            return 0 as libc::c_int as size_t;
                                                        }
                                                        if sign_char != 0 {
                                                            let mut _n_5: size_t = 1 as libc::c_int as size_t;
                                                            let mut _w_5: size_t = (if width < 0 as libc::c_int {
                                                                0 as libc::c_int
                                                            } else {
                                                                width
                                                            }) as size_t;
                                                            let mut _incr_5: size_t = if _n_5 < _w_5 {
                                                                _w_5
                                                            } else {
                                                                _n_5
                                                            };
                                                            ...
                                                            if !p.is_null() {
                                                                if digits == 0 as libc::c_int && _n_5 < _w_5 {
                                                                    let mut _delta_5: size_t = (width as libc::c_ulong)
                                                                        .wrapping_sub(_n_5);
                                                                    if pad == '0' as i32 {
                                                    ...
                                                    let mut _n_6: size_t = 1 as libc::c_int as size_t;
                                                    let mut _w_6: size_t = (if width < 0 as libc::c_int {
                                                        0 as libc::c_int
                                                    } else {
                                                        width
                                                    }) as size_t;
                                                    let mut _incr_6: size_t = if _n_6 < _w_6 {
                                                        _w_6
                                                    } else {
                                                        _n_6
                                                    };
                                                    ...
                                                    if !p.is_null() {
                                                        if digits == 0 as libc::c_int && _n_6 < _w_6 {
                                                            let mut _delta_6: size_t = (width as libc::c_ulong)
                                                                .wrapping_sub(_n_6);
                                                            if pad == '0' as i32 {
                                            ...
                                            let mut _n_7: size_t = buf
                                                ...
                                                .offset_from(bufp) as libc::c_long as size_t;
                                            let mut _w_7: size_t = (if width < 0 as libc::c_int {
                                                0 as libc::c_int
                                            } else {
                                                width
                                            }) as size_t;
                                            let mut _incr_7: size_t = if _n_7 < _w_7 {
                                                _w_7
                                            } else {
                                                _n_7
                                            };
                                            ...
                                            if !p.is_null() {
                                                if digits == 0 as libc::c_int && _n_7 < _w_7 {
                                                    let mut _delta_7: size_t = (width as libc::c_ulong)
                                                        .wrapping_sub(_n_7);
                                                    if pad == '0' as i32 {
                                                ...
                                                if to_lowcase {
                                                    memcpy_lowcase(p, bufp, _n_7);
                                                } else if to_uppcase {
                                                    memcpy_uppcase(p, bufp, _n_7);
                                                } else {
                                                    memcpy(
                                                        p as *mut libc::c_void,
                                            ...
                                            i = (i as libc::c_ulong).wrapping_add(_incr_7) as size_t
                                                as size_t;
                                        }
                                    }
                                }
