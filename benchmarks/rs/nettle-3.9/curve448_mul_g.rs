...
pub unsafe extern "C" fn nettle_curve448_mul_g(
    mut r: *mut uint8_t,
    mut n: *const uint8_t,
) {
    let mut ecc: *const ecc_curve = &_nettle_curve448;
    let mut t: [uint8_t; 56] = [0; 56];
    ...
    t[0 as libc::c_int
        as usize] = (t[0 as libc::c_int as usize] as libc::c_int & !(3 as libc::c_int))
        as uint8_t;
    t[(56 as libc::c_int - 1 as libc::c_int)
        as usize] = (t[(56 as libc::c_int - 1 as libc::c_int) as usize] as libc::c_int
        & 0x7f as libc::c_int | 0x80 as libc::c_int) as uint8_t;
    itch = (5 as libc::c_int * (*ecc).p.size as libc::c_int
