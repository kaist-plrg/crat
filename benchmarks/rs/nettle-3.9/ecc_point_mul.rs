...
pub unsafe extern "C" fn nettle_ecc_point_mul(
    ...
    let mut itch: mp_size_t = (3 as libc::c_int as libc::c_ulong)
        .wrapping_mul(size)
        .wrapping_add((*ecc).mul_itch as libc::c_ulong) as mp_size_t;
    let mut scratch: *mut mp_limb_t = _nettle_gmp_alloc_limbs(itch);
    if (*n).ecc == ecc {} else {
        __assert_fail(
            b"n->ecc == ecc\0" as *const u8 as *const libc::c_char,
            b"ecc-point-mul.c\0" as *const u8 as *const libc::c_char,
            52 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<
                &[u8; 99],
                &[libc::c_char; 99],
            >(
                b"void nettle_ecc_point_mul(struct ecc_point *, const struct ecc_scalar *, const struct ecc_point *)\0",
            ))
                .as_ptr(),
        );
    }
    ...
    if (*p).ecc == ecc {} else {
        __assert_fail(
            b"p->ecc == ecc\0" as *const u8 as *const libc::c_char,
            b"ecc-point-mul.c\0" as *const u8 as *const libc::c_char,
    ...
    if (*ecc).h_to_a_itch as libc::c_int <= (*ecc).mul_itch as libc::c_int {} else {
        __assert_fail(
            b"ecc->h_to_a_itch <= ecc->mul_itch\0" as *const u8 as *const libc::c_char,
            b"ecc-point-mul.c\0" as *const u8 as *const libc::c_char,
    ...
    'c_3582: {
        if (*ecc).h_to_a_itch as libc::c_int <= (*ecc).mul_itch as libc::c_int {} else {
            __assert_fail(
                b"ecc->h_to_a_itch <= ecc->mul_itch\0" as *const u8
