...
extern "C" {
    ...
    fn _nettle_eddsa_public_key_itch(ecc: *const ecc_curve) -> mp_size_t;
    fn _nettle_eddsa_public_key(
        ecc: *const ecc_curve,
        k_0: *const mp_limb_t,
        pub_0: *mut uint8_t,
...
pub unsafe extern "C" fn nettle_ed448_shake256_public_key(
    ...
    let mut digest: [uint8_t; 114] = [0; 114];
    let mut itch: mp_size_t = (*ecc).q.size as libc::c_long
        + _nettle_eddsa_public_key_itch(ecc);
