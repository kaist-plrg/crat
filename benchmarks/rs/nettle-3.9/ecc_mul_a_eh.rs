...
unsafe extern "C" fn table_init(
    ...
    let ref mut fresh0 = *table_0
        .offset(
            (0 as libc::c_int * 3 as libc::c_int * (*ecc).p.size as libc::c_int) as isize,
        )
        .offset((2 as libc::c_int * (*ecc).p.size as libc::c_int) as isize);
    *fresh0 = 1 as libc::c_int as mp_limb_t;
    *table_0
        .offset(
            (0 as libc::c_int * 3 as libc::c_int * (*ecc).p.size as libc::c_int) as isize,
        )
        .offset((*ecc).p.size as isize) = *fresh0;
    _nettle_ecc_a_to_j(
        ecc,
        table_0
            .offset(
...
pub unsafe extern "C" fn _nettle_ecc_mul_a_eh(
    mut ecc: *const ecc_curve,
    mut r: *mut mp_limb_t,
    ...
    if bits < ((1 as libc::c_uint) << 4 as libc::c_int) as libc::c_ulong {} else {
        __assert_fail(
            ...
            b"ecc-mul-a-eh.c\0" as *const u8 as *const libc::c_char,
            141 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<
                &[u8; 116],
                &[libc::c_char; 116],
            >(
                b"void _nettle_ecc_mul_a_eh(const struct ecc_curve *, mp_limb_t *, const mp_limb_t *, const mp_limb_t *, mp_limb_t *)\0",
            ))
                .as_ptr(),
        );
    }
    ...
    loop {
        ...
        while j < 4 as libc::c_int as libc::c_uint {
            ((*ecc).dup).unwrap()(ecc, r, r, scratch_out);
            j = j.wrapping_add(1);
            j;
        }
        bits
        ...
        ((*ecc).add_hhh).unwrap()(ecc, r, r, scratch, scratch_out);
    };
}
