...
pub unsafe extern "C" fn nettle_curve25519_mul(
    mut q: *mut uint8_t,
    mut n: *const uint8_t,
    mut p: *const uint8_t,
) {
    let mut m: *const ecc_modulo = &_nettle_curve25519.p;
    ...
    let ref mut fresh0 = *x
        .offset((255 as libc::c_int / (64 as libc::c_int - 0 as libc::c_int)) as isize);
    *fresh0
        &= !((1 as libc::c_int as mp_limb_t)
            << 255 as libc::c_int % (64 as libc::c_int - 0 as libc::c_int));
    _nettle_ecc_mul_m(
        m,
        121665 as libc::c_int as mp_limb_t,
