...
pub unsafe extern "C" fn _nettle_ecc_add_jja(
    ...
    _nettle_ecc_mod_mul_1(&(*ecc).p, scratch, scratch, 4 as libc::c_int as mp_limb_t);
    _nettle_ecc_mod_mul(
        &(*ecc).p,
        scratch.offset((*ecc).p.size as libc::c_int as isize),
        scratch,
    ...
    _nettle_ecc_mod_submul_1(&(*ecc).p, r, scratch, 2 as libc::c_int as mp_limb_t);
    _nettle_ecc_mod_mul(
        &(*ecc).p,
        scratch.offset((*ecc).p.size as libc::c_int as isize),
        p.offset((*ecc).p.size as libc::c_int as isize),
