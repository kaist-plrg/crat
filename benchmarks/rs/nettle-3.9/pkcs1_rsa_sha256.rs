...
static mut sha256_prefix: [uint8_t; 19] = [
...
pub unsafe extern "C" fn nettle_pkcs1_rsa_sha256_encode(
    ...
    p = _nettle_pkcs1_signature_prefix(
        ...
        em,
        ::std::mem::size_of::<[uint8_t; 19]>() as libc::c_ulong as libc::c_uint,
        sha256_prefix.as_ptr(),
        32 as libc::c_int as libc::c_uint,
    );
    if !p.is_null() {
        nettle_sha256_digest(hash, 32 as libc::c_int as size_t, p);
...
pub unsafe extern "C" fn nettle_pkcs1_rsa_sha256_encode_digest(
    mut m: *mut __mpz_struct,
    mut key_size: size_t,
