...
static mut sha512_prefix: [uint8_t; 19] = [
...
pub unsafe extern "C" fn nettle_pkcs1_rsa_sha512_encode(
    ...
    p = _nettle_pkcs1_signature_prefix(
        ...
        sha512_prefix.as_ptr(),
        64 as libc::c_int as libc::c_uint,
    );
    if !p.is_null() {
        nettle_sha512_digest(hash, 64 as libc::c_int as size_t, p);
...
pub unsafe extern "C" fn nettle_pkcs1_rsa_sha512_encode_digest(
    mut m: *mut __mpz_struct,
    mut key_size: size_t,
