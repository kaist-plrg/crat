...
extern "C" {
    ...
    fn nettle_ecc_gostdsa_verify_itch(ecc: *const ecc_curve) -> mp_size_t;
...
pub unsafe extern "C" fn nettle_gostdsa_verify(
    ...
    let mut itch: mp_size_t = (2 as libc::c_int as libc::c_ulong)
        .wrapping_mul(size)
        .wrapping_add(nettle_ecc_gostdsa_verify_itch((*pub_0).ecc) as libc::c_ulong)
        as mp_size_t;
