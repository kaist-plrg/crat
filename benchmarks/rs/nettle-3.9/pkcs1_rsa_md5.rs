...
static mut md5_prefix: [uint8_t; 18] = [
...
pub unsafe extern "C" fn nettle_pkcs1_rsa_md5_encode(
    ...
    p = _nettle_pkcs1_signature_prefix(
        ...
        em,
        ::std::mem::size_of::<[uint8_t; 18]>() as libc::c_ulong as libc::c_uint,
        md5_prefix.as_ptr(),
        16 as libc::c_int as libc::c_uint,
    );
    if !p.is_null() {
        nettle_md5_digest(hash, 16 as libc::c_int as size_t, p);
...
pub unsafe extern "C" fn nettle_pkcs1_rsa_md5_encode_digest(
    mut m: *mut __mpz_struct,
    mut key_size: size_t,
