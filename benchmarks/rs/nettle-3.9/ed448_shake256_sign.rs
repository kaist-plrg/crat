...
pub unsafe extern "C" fn nettle_ed448_shake256_sign(
    ...
    let mut eddsa: *const ecc_eddsa = &_nettle_ed448_shake256;
    ...
    _nettle_eddsa_sign(
        ...
        &mut ctx as *mut sha3_256_ctx as *mut libc::c_void,
        pub_0,
        digest.as_mut_ptr().offset(57 as libc::c_int as isize),
        scratch,
        length,
        msg,
        signature,
