...
pub unsafe extern "C" fn nettle_dsa_params_from_der_iterator(
    mut params: *mut dsa_params,
    mut max_bits: libc::c_uint,
    mut q_bits: libc::c_uint,
    mut i: *mut asn1_der_iterator,
) -> libc::c_int {
    if (*i).type_0 as libc::c_uint == ASN1_INTEGER as libc::c_int as libc::c_uint
        && nettle_asn1_der_get_bignum(i, ((*params).p).as_mut_ptr(), max_bits) != 0
    ...
    {
        let mut p_bits: libc::c_uint = __gmpz_sizeinbase(
        ...
        return (nettle_asn1_der_iterator_next(i) as libc::c_uint
            ...
            && (if (*((*params).q).as_mut_ptr())._mp_size < 0 as libc::c_int {
                ...
                ((*((*params).q).as_mut_ptr())._mp_size > 0 as libc::c_int)
                    as libc::c_int
            }) > 0 as libc::c_int
            && (q_bits == 0 as libc::c_int as libc::c_uint
                || __gmpz_sizeinbase(
            ...
            && (nettle_asn1_der_iterator_next(i) as libc::c_uint
                ...
                && (*i).type_0 as libc::c_uint
                    == ASN1_INTEGER as libc::c_int as libc::c_uint
                && nettle_asn1_der_get_bignum(i, ((*params).g).as_mut_ptr(), p_bits) != 0
...
pub unsafe extern "C" fn nettle_dsa_public_key_from_der_iterator(
    mut params: *const dsa_params,
    mut pub_0: *mut __mpz_struct,
    mut i: *mut asn1_der_iterator,
) -> libc::c_int {
    return ((*i).type_0 as libc::c_uint == ASN1_INTEGER as libc::c_int as libc::c_uint
        && nettle_asn1_der_get_bignum(
            i,
            pub_0,
            __gmpz_sizeinbase(((*params).p).as_ptr(), 2 as libc::c_int) as libc::c_uint,
        ) != 0
        ...
        && __gmpz_cmp(pub_0 as mpz_srcptr, ((*params).p).as_ptr()) < 0 as libc::c_int)
        as libc::c_int;
}
pub unsafe extern "C" fn nettle_dsa_openssl_private_key_from_der_iterator(
    mut params: *mut dsa_params,
    mut pub_0: *mut __mpz_struct,
    ...
    if (*i).type_0 as libc::c_uint == ASN1_SEQUENCE as libc::c_int as libc::c_uint
        ...
        && (nettle_asn1_der_iterator_next(i) as libc::c_uint
            == ASN1_ITERATOR_PRIMITIVE as libc::c_int as libc::c_uint
            && (*i).type_0 as libc::c_uint == ASN1_INTEGER as libc::c_int as libc::c_uint
            && nettle_asn1_der_get_bignum(i, ((*params).p).as_mut_ptr(), p_max_bits) != 0
            && (if (*((*params).p).as_mut_ptr())._mp_size < 0 as libc::c_int {
                -(1 as libc::c_int)
            } else {
                ((*((*params).p).as_mut_ptr())._mp_size > 0 as libc::c_int)
                    as libc::c_int
            }) > 0 as libc::c_int)
    {
        let mut p_bits: libc::c_uint = __gmpz_sizeinbase(
        ...
        return (nettle_asn1_der_iterator_next(i) as libc::c_uint
            ...
            && (nettle_asn1_der_iterator_next(i) as libc::c_uint
                ...
                && (*i).type_0 as libc::c_uint
                    == ASN1_INTEGER as libc::c_int as libc::c_uint
                && nettle_asn1_der_get_bignum(i, pub_0, p_bits) != 0
                && (if (*pub_0)._mp_size < 0 as libc::c_int {
                    -(1 as libc::c_int)
                } else {
                    ((*pub_0)._mp_size > 0 as libc::c_int) as libc::c_int
                }) > 0 as libc::c_int)
            && __gmpz_cmp(pub_0 as mpz_srcptr, ((*params).p).as_mut_ptr() as mpz_srcptr)
                < 0 as libc::c_int
            && (nettle_asn1_der_iterator_next(i) as libc::c_uint
                == ASN1_ITERATOR_PRIMITIVE as libc::c_int as libc::c_uint
                && (*i).type_0 as libc::c_uint
...
pub unsafe extern "C" fn nettle_openssl_provate_key_from_der(
    mut params: *mut dsa_params,
    mut pub_0: *mut __mpz_struct,
    mut priv_0: *mut __mpz_struct,
    mut p_max_bits: libc::c_uint,
