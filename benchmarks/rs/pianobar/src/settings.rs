...
pub const BAR_KS_COUNT: C2RustUnnamed_4 = 30;
pub const BAR_KS_SETTINGS: C2RustUnnamed_4 = 29;
pub const BAR_KS_VOLRESET: C2RustUnnamed_4 = 28;
pub const BAR_KS_PAUSE: C2RustUnnamed_4 = 27;
pub const BAR_KS_PLAY: C2RustUnnamed_4 = 26;
pub const BAR_KS_CREATESTATIONFROMSONG: C2RustUnnamed_4 = 25;
pub const BAR_KS_PLAYPAUSE2: C2RustUnnamed_4 = 24;
pub const BAR_KS_MANAGESTATION: C2RustUnnamed_4 = 23;
pub const BAR_KS_VOLUP: C2RustUnnamed_4 = 22;
pub const BAR_KS_VOLDOWN: C2RustUnnamed_4 = 21;
pub const BAR_KS_BOOKMARK: C2RustUnnamed_4 = 20;
pub const BAR_KS_DEBUG: C2RustUnnamed_4 = 19;
pub const BAR_KS_SELECTQUICKMIX: C2RustUnnamed_4 = 18;
pub const BAR_KS_UPCOMING: C2RustUnnamed_4 = 17;
pub const BAR_KS_TIRED: C2RustUnnamed_4 = 16;
pub const BAR_KS_SELECTSTATION: C2RustUnnamed_4 = 15;
pub const BAR_KS_RENAMESTATION: C2RustUnnamed_4 = 14;
pub const BAR_KS_QUIT: C2RustUnnamed_4 = 13;
pub const BAR_KS_PLAYPAUSE: C2RustUnnamed_4 = 12;
pub const BAR_KS_SKIP: C2RustUnnamed_4 = 11;
pub const BAR_KS_ADDSHARED: C2RustUnnamed_4 = 10;
pub const BAR_KS_INFO: C2RustUnnamed_4 = 9;
pub const BAR_KS_HISTORY: C2RustUnnamed_4 = 8;
pub const BAR_KS_GENRESTATION: C2RustUnnamed_4 = 7;
pub const BAR_KS_EXPLAIN: C2RustUnnamed_4 = 6;
pub const BAR_KS_DELETESTATION: C2RustUnnamed_4 = 5;
pub const BAR_KS_CREATESTATION: C2RustUnnamed_4 = 4;
pub const BAR_KS_ADDMUSIC: C2RustUnnamed_4 = 3;
pub const BAR_KS_BAN: C2RustUnnamed_4 = 2;
pub const BAR_KS_LOVE: C2RustUnnamed_4 = 1;
pub const BAR_KS_HELP: C2RustUnnamed_4 = 0;
...
unsafe extern "C" fn BarSettingsGetHome() -> *mut libc::c_char {
    ...
    if !home.is_null() && strlen(home) > 0 as libc::c_int as libc::c_ulong {
        return strdup(home);
    }
    let pw: *mut passwd = getpwuid(getuid());
    if !pw.is_null() && !((*pw).pw_dir).is_null()
        && strlen((*pw).pw_dir) > 0 as libc::c_int as libc::c_ulong
    {
...
unsafe extern "C" fn BarGetXdgConfigDir(
    ...
    if !xdgConfigDir.is_null()
        && strlen(xdgConfigDir) > 0 as libc::c_int as libc::c_ulong
    {
        let len: size_t = (strlen(xdgConfigDir))
            .wrapping_add(1 as libc::c_int as libc::c_ulong)
            .wrapping_add(strlen(filename))
            .wrapping_add(1 as libc::c_int as libc::c_ulong);
        let concat: *mut libc::c_char = malloc(
...
pub unsafe extern "C" fn BarSettingsExpandTilde(
    ...
    {
        let expanded: *mut libc::c_char = malloc(
            (strlen(home))
                .wrapping_add(1 as libc::c_int as libc::c_ulong)
        ...
        sprintf(
            ...
            b"%s/%s\0" as *const u8 as *const libc::c_char,
            home,
            &*path.offset(2 as libc::c_int as isize) as *const libc::c_char,
        );
        return expanded;
    }
    return strdup(path);
...
pub unsafe extern "C" fn BarSettingsDestroy(mut settings: *mut BarSettings_t) {
    ...
    while i < MSG_COUNT as libc::c_int as libc::c_ulong {
...
pub unsafe extern "C" fn BarSettingsRead(mut settings: *mut BarSettings_t) {
    let configfiles: [*mut libc::c_char; 2] = [
        b"pianobar/state\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        b"pianobar/config\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ];
    let userhome: *mut libc::c_char = BarSettingsGetHome();
    let defaultxdg: *mut libc::c_char = malloc(
        (strlen(userhome))
            .wrapping_add(strlen(b"/.config\0" as *const u8 as *const libc::c_char))
            .wrapping_add(1 as libc::c_int as libc::c_ulong),
    ) as *mut libc::c_char;
    ...
    (*settings).history = 5 as libc::c_int as libc::c_uint;
    (*settings).volume = 0 as libc::c_int;
    (*settings).timeout = 30 as libc::c_int as libc::c_uint;
    (*settings).gainMul = 1.0f64 as libc::c_float;
    (*settings).maxRetry = 5 as libc::c_int as libc::c_uint;
    (*settings).bufferSecs = 5 as libc::c_int as libc::c_uint;
    ...
    (*settings).audioPipe = 0 as *mut libc::c_char;
    (*settings).sampleRate = 0 as libc::c_int;
    (*settings)
        .msgFormat[MSG_NONE as libc::c_int as usize]
        .prefix = 0 as *mut libc::c_char;
    (*settings)
        .msgFormat[MSG_NONE as libc::c_int as usize]
        .postfix = 0 as *mut libc::c_char;
    (*settings)
        .msgFormat[MSG_INFO as libc::c_int as usize]
        .prefix = strdup(b"(i) \0" as *const u8 as *const libc::c_char);
    (*settings)
        .msgFormat[MSG_INFO as libc::c_int as usize]
        .postfix = 0 as *mut libc::c_char;
    (*settings)
        .msgFormat[MSG_PLAYING as libc::c_int as usize]
        .prefix = strdup(b"|>  \0" as *const u8 as *const libc::c_char);
    (*settings)
        .msgFormat[MSG_PLAYING as libc::c_int as usize]
        .postfix = 0 as *mut libc::c_char;
    (*settings)
        .msgFormat[MSG_TIME as libc::c_int as usize]
        .prefix = strdup(b"#   \0" as *const u8 as *const libc::c_char);
    (*settings)
        .msgFormat[MSG_TIME as libc::c_int as usize]
        .postfix = 0 as *mut libc::c_char;
    (*settings)
        .msgFormat[MSG_ERR as libc::c_int as usize]
        .prefix = strdup(b"/!\\ \0" as *const u8 as *const libc::c_char);
    (*settings)
        .msgFormat[MSG_ERR as libc::c_int as usize]
        .postfix = 0 as *mut libc::c_char;
    (*settings)
        .msgFormat[MSG_QUESTION as libc::c_int as usize]
        .prefix = strdup(b"[?] \0" as *const u8 as *const libc::c_char);
    (*settings)
        .msgFormat[MSG_QUESTION as libc::c_int as usize]
        .postfix = 0 as *mut libc::c_char;
    (*settings)
        .msgFormat[MSG_LIST as libc::c_int as usize]
        .prefix = strdup(b"\t\0" as *const u8 as *const libc::c_char);
    (*settings)
        .msgFormat[MSG_LIST as libc::c_int as usize]
        .postfix = 0 as *mut libc::c_char;
            ...
            .wrapping_div(::std::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
    {
        ...
        let mut lineNum: size_t = 0 as libc::c_int as size_t;
        let path: *mut libc::c_char = BarGetXdgConfigDir(configfiles[j as usize]);
        configfd = fopen(path, b"r\0" as *const u8 as *const libc::c_char);
        if configfd.is_null() {
            ...
            loop {
                    ...
                    && feof(configfd) == 0
                {
                    ...
                    let mut key: *mut libc::c_char = line.as_mut_ptr();
                    while *(*__ctype_b_loc())
                        .offset(
                    ...
                    let mut val: *mut libc::c_char = strchr(
                        line.as_mut_ptr(),
                        '=' as i32,
                    );
                    if val.is_null() {
                        ...
                        *val = '\0' as i32 as libc::c_char;
                        val = val.offset(1);
                        val;
                        let mut keyend: *mut libc::c_char = &mut *key
                            .offset(
                                ((strlen
                                    as unsafe extern "C" fn(
                                        *const libc::c_char,
                        ...
                        while keyend >= key
                            && *(*__ctype_b_loc())
                                ...
                                != 0
                        {
                            *keyend = '\0' as i32 as libc::c_char;
                        ...
                        let mut valend: *mut libc::c_char = &mut *val
                            .offset(
                                ((strlen
                                    as unsafe extern "C" fn(
                                        *const libc::c_char,
                        ...
                        while valend >= val
                            && (*valend as libc::c_int == '\r' as i32
                                || *valend as libc::c_int == '\n' as i32)
                        {
                            *valend = '\0' as i32 as libc::c_char;
                        ...
                        ) == 0 as libc::c_int
                        {
                            ...
                            while i_0 < BAR_KS_COUNT as libc::c_int as libc::c_ulong {
                                if strcmp(dispatchActions[i_0 as usize].configKey, key)
                                    == 0 as libc::c_int
                                {
                                    if strcmp(
                                        val,
                                    ...
                                    {
                                        (*settings)
                                            .keys[i_0 as usize] = '\0' as i32 as libc::c_char;
                                    } else {
                                        (*settings)
                                            .keys[i_0
                        ...
                        {
                            if strcmp(val, b"low\0" as *const u8 as *const libc::c_char)
                                == 0 as libc::c_int
                            {
                        ...
                        {
                            (*settings).history = atoi(val) as libc::c_uint;
                        } else if strcmp(
                            b"max_retry\0" as *const u8 as *const libc::c_char,
                            key,
                        ) == 0 as libc::c_int
                        {
                            (*settings).maxRetry = atoi(val) as libc::c_uint;
                        } else if strcmp(
                            b"timeout\0" as *const u8 as *const libc::c_char,
                            key,
                        ) == 0 as libc::c_int
                        {
                            (*settings).timeout = atoi(val) as libc::c_uint;
                        } else if strcmp(
                            b"buffer_seconds\0" as *const u8 as *const libc::c_char,
                            key,
                        ) == 0 as libc::c_int
                        {
                            (*settings).bufferSecs = atoi(val) as libc::c_uint;
                        } else if strcmp(
                        ...
                        ) == 0 as libc::c_int
                        {
                            ...
                            static mut mapping: [*const libc::c_char; 6] = [
                                ...
                                b"quickmix_01_name_az\0" as *const u8
                                    as *const libc::c_char,
                                b"quickmix_01_name_za\0" as *const u8
                                    as *const libc::c_char,
                                b"quickmix_10_name_az\0" as *const u8
                                    as *const libc::c_char,
                                b"quickmix_10_name_za\0" as *const u8 as *const libc::c_char,
                            ];
                            i_1 = 0 as libc::c_int as size_t;
                            while i_1 < BAR_SORT_COUNT as libc::c_int as libc::c_ulong {
                                if strcmp(mapping[i_1 as usize], val) == 0 as libc::c_int {
                                    (*settings).sortOrder = i_1 as BarStationSorting_t;
                                    break;
                                } else {
                        ...
                        {
                            (*settings).gainMul = atof(val) as libc::c_float;
                        } else if strcmp(
                        ...
                        ) == 0 as libc::c_int
                        {
                            free((*settings).audioPipe as *mut libc::c_void);
                            (*settings)
                                .audioPipe = BarSettingsExpandTilde(val, userhome);
                        } else if strcmp(
                            b"autoselect\0" as *const u8 as *const libc::c_char,
                            key,
                        ) == 0 as libc::c_int
                        {
                            (*settings).autoselect = atoi(val) != 0;
                        } else if strcmp(
                        ...
                        } else if strncmp(formatMsgPrefix, key, strlen(formatMsgPrefix))
                            == 0 as libc::c_int
                        {
                            static mut mapping_0: [*const libc::c_char; 7] = [
                            ...
                            let mut typeStart: *const libc::c_char = key
                                .offset(strlen(formatMsgPrefix) as isize);
                            ...
                            {
                                if strcmp(typeStart, mapping_0[i_2 as usize])
                                    == 0 as libc::c_int
                                {
                                    let mut formatPos: *const libc::c_char = strstr(
                                        val,
                                        b"%s\0" as *const u8 as *const libc::c_char,
                                    );
                                    if !formatPos.is_null() {
                                        let mut format: *mut BarMsgFormatStr_t = &mut *((*settings)
                                            .msgFormat)
                                            .as_mut_ptr()
                                            .offset(i_2 as isize) as *mut BarMsgFormatStr_t;
                                        free((*format).prefix as *mut libc::c_void);
                                        free((*format).postfix as *mut libc::c_void);
                                        let prefixLen: size_t = formatPos.offset_from(val)
                                            as libc::c_long as size_t;
                                        (*format)
                                            .prefix = calloc(
                                            prefixLen.wrapping_add(1 as libc::c_int as libc::c_ulong),
                                        ...
                                        let postfixLen: size_t = (strlen(val))
                                            .wrapping_sub(
                                                formatPos.offset_from(val) as libc::c_long as libc::c_ulong,
                                            )
                                            .wrapping_sub(2 as libc::c_int as libc::c_ulong);
                                        (*format)
                                            .postfix = calloc(
                                            postfixLen.wrapping_add(1 as libc::c_int as libc::c_ulong),
                                            ::std::mem::size_of::<libc::c_char>() as libc::c_ulong,
                                        ) as *mut libc::c_char;
                                        memcpy(
    ...
    if ((*settings).proxy).is_null() {
        let mut tmpProxy: *mut libc::c_char = getenv(
            b"http_proxy\0" as *const u8 as *const libc::c_char,
        );
        if !tmpProxy.is_null() && strlen(tmpProxy) > 0 as libc::c_int as libc::c_ulong {
...
pub unsafe extern "C" fn BarSettingsWrite(
    ...
    let path: *mut libc::c_char = BarGetXdgConfigDir(
        b"pianobar/state\0" as *const u8 as *const libc::c_char,
    );
    fd = fopen(path, b"w\0" as *const u8 as *const libc::c_char);
    if fd.is_null() {
        free(path as *mut libc::c_void);
        return;
    }
