...
unsafe extern "C" fn BrotliUnalignedRead64(mut p: *const libc::c_void) -> uint64_t {
    ...
    memcpy(
        &mut t as *mut uint64_t as *mut libc::c_void,
        p,
...
unsafe extern "C" fn BrotliUnalignedRead32(mut p: *const libc::c_void) -> uint32_t {
    ...
    memcpy(
        &mut t as *mut uint32_t as *mut libc::c_void,
        p,
...
unsafe extern "C" fn BrotliFillBitWindow(
    ...
    if 1 as libc::c_int == 0 && 0 != 0 && n_bits <= 8 as libc::c_int as libc::c_uint {
...
unsafe extern "C" fn BrotliPullByte(br: *mut BrotliBitReader) -> libc::c_int {
    ...
    (*br)
        .bit_pos_ = ((*br).bit_pos_ as libc::c_uint)
        .wrapping_sub(8 as libc::c_int as libc::c_uint) as uint32_t as uint32_t;
...
unsafe extern "C" fn BrotliDropBits(br: *mut BrotliBitReader, mut n_bits: uint32_t) {
    (*br)
        .bit_pos_ = ((*br).bit_pos_ as libc::c_uint).wrapping_add(n_bits) as uint32_t
        as uint32_t;
}
#[inline(always)]
unsafe extern "C" fn BrotliBitReaderUnload(mut br: *mut BrotliBitReader) {
    ...
    (*br)
        .avail_in = ((*br).avail_in as libc::c_ulong)
        .wrapping_add(unused_bytes as libc::c_ulong) as size_t as size_t;
    ...
    (*br)
        .bit_pos_ = ((*br).bit_pos_ as libc::c_uint).wrapping_add(unused_bits)
        as uint32_t as uint32_t;
}
#[inline(always)]
...
unsafe extern "C" fn BrotliCopyBytes(
    ...
    (*br)
        .avail_in = ((*br).avail_in as libc::c_ulong).wrapping_sub(num) as size_t
        as size_t;
...
pub unsafe extern "C" fn BrotliDecoderCreateInstance(
    ...
    if BrotliDecoderStateInit(state, alloc_func, free_func, opaque) == 0 {
        if alloc_func.is_none() && free_func.is_none() {
            ...
            free_func.unwrap()(opaque, state as *mut libc::c_void);
        }
        return 0 as *mut BrotliDecoderState;
    }
    return state;
...
unsafe extern "C" fn DecodeVarLenUint8(
    ...
    match (*s).substate_decode_uint8 as libc::c_uint {
        0 => {
            ...
            current_block_24 = 4902291571558015149;
        }
        1 => {
            current_block_24 = 4902291571558015149;
        }
        2 => {
            current_block_24 = 3716115564420390185;
        }
        _ => {
            ...
            match (*s).substate_metablock_header as libc::c_uint {
                0 => {
                    ...
                    if (*s).is_last_metablock() == 0 {
                        ...
                        current_block_76 = 16366467526826778603;
                    }
                }
                1 => {
                    current_block_76 = 16366467526826778603;
                ...
                3 => {
                    current_block_76 = 5437945319872143895;
                }
                4 => {
                    current_block_76 = 15211688870647195772;
                }
                5 => {
                    if BrotliSafeReadBits(br, 1 as libc::c_int as uint32_t, &mut bits)
                        == 0
                    ...
                    current_block_76 = 12172632442870686280;
                }
                6 => {
                    current_block_76 = 12172632442870686280;
                }
                7 => {
                    current_block_76 = 9302285461129694157;
                }
                _ => {
                    return BROTLI_DECODER_ERROR_UNREACHABLE as libc::c_int
                        as BrotliDecoderErrorCode;
...
unsafe extern "C" fn ReadSymbolCodeLengths(
    ...
    while symbol < alphabet_size && space > 0 as libc::c_int as libc::c_uint {
        ...
        if code_len < 16 as libc::c_int as libc::c_uint {
            ...
            let mut extra_bits: uint32_t = (if code_len
...
unsafe extern "C" fn ReadHuffmanCode(
    ...
    loop {
        match (*h).substate_huffman as libc::c_uint {
            0 => {
                ...
                if (*h).sub_loop_counter != 1 as libc::c_int as libc::c_uint {
                    ...
                    current_block_67 = 4504337442091779300;
                }
            }
            1 => {
                current_block_67 = 4504337442091779300;
            ...
            2 => {
                current_block_67 = 9765469144730143385;
            }
            3 => {
                current_block_67 = 2156894112054174168;
            }
            4 => {
                ...
                current_block_67 = 2260374316100882458;
            }
            5 => {
                current_block_67 = 2260374316100882458;
            }
        ...
        if (*h).symbol == 3 as libc::c_int as libc::c_uint {
            ...
            (*h)
                .symbol = ((*h).symbol as libc::c_uint).wrapping_add(bits) as uint32_t
                as uint32_t;
        }
    ...
    match (*h).substate_context_map as libc::c_int {
        0 => {
            ...
            *context_map_arg = ((*s).alloc_func)
                .unwrap()((*s).memory_manager_opaque, context_map_size as size_t)
                as *mut uint8_t;
            ...
            current_block_72 = 14108169435543779573;
        }
        1 => {
            current_block_72 = 14108169435543779573;
        }
        2 => {
            current_block_72 = 6061421480933744580;
        }
        3 => {
            current_block_72 = 9239104938994354823;
        }
        4 => {
            current_block_72 = 8944665841444743726;
        }
        _ => {
            return BROTLI_DECODER_ERROR_UNREACHABLE as libc::c_int
                as BrotliDecoderErrorCode;
...
unsafe extern "C" fn WriteRingBuffer(
    ...
    *available_out = (*available_out as libc::c_ulong).wrapping_sub(num_written)
        as size_t as size_t;
    (*s)
        .partial_pos_out = ((*s).partial_pos_out as libc::c_ulong)
        .wrapping_add(num_written) as size_t as size_t;
...
unsafe extern "C" fn BrotliEnsureRingBuffer(
    ...
    *((*s).ringbuffer)
    ...
    if !old_ringbuffer.is_null() {
        ...
        ((*s).free_func)
            .unwrap()((*s).memory_manager_opaque, old_ringbuffer as *mut libc::c_void);
    ...
    loop {
        if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int {
            ...
            match (*s).state as libc::c_uint {
                ...
                3 => {
                    current_block_175 = 16961224587090219858;
                }
                4 => {
                    current_block_175 = 519160363748337264;
                }
                17 => {
                    current_block_175 = 8712270783959480920;
                }
                18 => {
                ...
                5 => {
                        ...
                        == 0
                    {
                        ...
                        if ((*s).context_modes).is_null() {
                            ...
                            current_block_175 = 15280576717888187136;
                        }
                    }
                }
                6 => {
                ...
                22 => {
                    current_block_175 = 1232922633126777150;
                }
                23 => {
                ...
                25 => {
                    current_block_175 = 12310883806328202904;
                }
                7 => {
                    current_block_175 = 13253931237392700050;
                }
                8 => {
                    current_block_175 = 7680476978976971598;
                }
                9 | 10 => {
                    current_block_175 = 15464803012785988042;
                }
                13 => {
                    current_block_175 = 9047376510614419450;
                }
                15 | 16 => {
                    current_block_175 = 9047376510614419450;
                }
                14 => {
                    if (*s).meta_block_remaining_len < 0 as libc::c_int {
                        ...
                        if (*s).is_last_metablock() == 0 {
                            ...
                            current_block_175 = 1121036194666580941;
                        }
                    }
                }
                26 => {
