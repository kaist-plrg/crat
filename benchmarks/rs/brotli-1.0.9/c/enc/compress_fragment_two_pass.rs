...
unsafe extern "C" fn ShannonEntropy(
    ...
    if size & 1 as libc::c_int as libc::c_ulong != 0 {
        current_block = 7117201326743070172;
    } else {
...
unsafe extern "C" fn HashBytesAtOffset(
    ...
    let h: uint64_t = (v >> (8 as libc::c_int as libc::c_ulong).wrapping_mul(offset)
        << (8 as libc::c_int as libc::c_ulong)
            .wrapping_sub(length)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong))
        .wrapping_mul(kHashMul32 as libc::c_ulong);
...
unsafe extern "C" fn EmitInsertLen(
    ...
    if insertlen < 6 as libc::c_int as libc::c_uint {
        **commands = insertlen;
        ...
        let tail: uint32_t = insertlen.wrapping_sub(2 as libc::c_int as libc::c_uint);
        ...
        **commands = inscode | extra << 8 as libc::c_int;
        ...
        let tail_0: uint32_t = insertlen.wrapping_sub(66 as libc::c_int as libc::c_uint);
        let nbits_0: uint32_t = Log2FloorNonZero(tail_0 as size_t);
        let code: uint32_t = nbits_0.wrapping_add(10 as libc::c_int as libc::c_uint);
        ...
        **commands = code | extra_0 << 8 as libc::c_int;
        ...
        let extra_1: uint32_t = insertlen
            .wrapping_sub(2114 as libc::c_int as libc::c_uint);
        **commands = 21 as libc::c_int as libc::c_uint | extra_1 << 8 as libc::c_int;
    } else if insertlen < 22594 as libc::c_int as libc::c_uint {
        let extra_2: uint32_t = insertlen
            .wrapping_sub(6210 as libc::c_int as libc::c_uint);
        **commands = 22 as libc::c_int as libc::c_uint | extra_2 << 8 as libc::c_int;
    } else {
        let extra_3: uint32_t = insertlen
            .wrapping_sub(22594 as libc::c_int as libc::c_uint);
...
unsafe extern "C" fn EmitCopyLen(mut copylen: size_t, mut commands: *mut *mut uint32_t) {
    if copylen < 10 as libc::c_int as libc::c_ulong {
        **commands = copylen.wrapping_add(38 as libc::c_int as libc::c_ulong)
        ...
        let tail: size_t = copylen.wrapping_sub(6 as libc::c_int as libc::c_ulong);
        ...
        **commands = (code | extra << 8 as libc::c_int) as uint32_t;
        ...
        let tail_0: size_t = copylen.wrapping_sub(70 as libc::c_int as libc::c_ulong);
        let nbits_0: size_t = Log2FloorNonZero(tail_0) as size_t;
        let code_0: size_t = nbits_0.wrapping_add(52 as libc::c_int as libc::c_ulong);
        ...
        **commands = (code_0 | extra_0 << 8 as libc::c_int) as uint32_t;
        ...
        let extra_1: size_t = copylen.wrapping_sub(2118 as libc::c_int as libc::c_ulong);
...
unsafe extern "C" fn EmitCopyLenLastDistance(
    ...
    if copylen < 12 as libc::c_int as libc::c_ulong {
        ...
        *commands;
        ...
        let tail: size_t = copylen.wrapping_sub(8 as libc::c_int as libc::c_ulong);
        let nbits: size_t = (Log2FloorNonZero(tail))
            .wrapping_sub(1 as libc::c_int as libc::c_uint) as size_t;
        let prefix: size_t = tail >> nbits;
        let code: size_t = (nbits << 1 as libc::c_int)
        ...
        *commands;
        ...
        let tail_0: size_t = copylen.wrapping_sub(8 as libc::c_int as libc::c_ulong);
        ...
        *commands;
        ...
        let tail_1: size_t = copylen.wrapping_sub(72 as libc::c_int as libc::c_ulong);
        let nbits_0: size_t = Log2FloorNonZero(tail_1) as size_t;
        let code_1: size_t = nbits_0.wrapping_add(52 as libc::c_int as libc::c_ulong);
        ...
        *commands;
        ...
        let extra_2: size_t = copylen.wrapping_sub(2120 as libc::c_int as libc::c_ulong);
...
unsafe extern "C" fn EmitDistance(
    ...
    let mut d: uint32_t = distance.wrapping_add(3 as libc::c_int as libc::c_uint);
    let mut nbits: uint32_t = (Log2FloorNonZero(d as size_t))
        .wrapping_sub(1 as libc::c_int as libc::c_uint);
    let prefix: uint32_t = d >> nbits & 1 as libc::c_int as libc::c_uint;
    let offset: uint32_t = (2 as libc::c_int as libc::c_uint).wrapping_add(prefix)
        << nbits;
...
unsafe extern "C" fn CreateCommands(
    ...
    let shift: size_t = (64 as libc::c_uint as libc::c_ulong).wrapping_sub(table_bits);
