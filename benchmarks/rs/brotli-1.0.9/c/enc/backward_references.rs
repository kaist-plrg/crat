...
unsafe extern "C" fn FindLongestMatchH42(
    ...
    let mut delta: size_t = cur_ix
        .wrapping_sub(*addr.offset(key as isize) as libc::c_ulong);
...
unsafe extern "C" fn StoreH42(
    ...
    let bank: size_t = key & (512 as libc::c_int - 1 as libc::c_int) as libc::c_ulong;
    let fresh1 = (*self_0).free_slot_idx[bank as usize];
    (*self_0)
        .free_slot_idx[bank
        as usize] = ((*self_0).free_slot_idx[bank as usize]).wrapping_add(1);
    let idx: size_t = (fresh1 as libc::c_int
...
unsafe extern "C" fn PrefixEncodeCopyDistance(
        ...
        < (16 as libc::c_int as libc::c_ulong).wrapping_add(num_direct_codes)
    {
        ...
        *extra_bits = 0 as libc::c_int as uint32_t;
        ...
        let mut prefix: size_t = dist >> bucket & 1 as libc::c_int as libc::c_ulong;
        let mut offset: size_t = (2 as libc::c_int as libc::c_ulong).wrapping_add(prefix)
            << bucket;
...
unsafe extern "C" fn FindLongestMatchH5(
    ...
    let down: size_t = if *num.offset(key as isize) as libc::c_ulong
        > (*self_0).block_size_
    {
