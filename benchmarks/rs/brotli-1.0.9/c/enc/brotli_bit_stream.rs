...
unsafe extern "C" fn SortHuffmanTreeItems(
    ...
    if n < 13 as libc::c_int as libc::c_ulong {
        ...
        while i < n {
            ...
            let mut k: size_t = i;
            let mut j: size_t = i.wrapping_sub(1 as libc::c_int as libc::c_ulong);
            while comparator.unwrap()(&mut tmp, &mut *items.offset(j as isize)) != 0 {
...
pub unsafe extern "C" fn BrotliBuildAndStoreHuffmanTreeFast(
    ...
    let mut tree: *mut HuffmanTree = if max_tree_size > 0 as libc::c_int as libc::c_ulong
    {
        BrotliAllocate(
            m,
            max_tree_size
...
unsafe extern "C" fn MoveToFrontTransform(
    ...
    let mut mtf_size: size_t = max_value.wrapping_add(1 as libc::c_int as libc::c_uint)
        as size_t;
    i = 0 as libc::c_int as size_t;
    while i < v_size {
...
unsafe extern "C" fn BuildAndStoreEntropyCodesLiteral(
    ...
    (*self_0)
        .depths_ = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
    ...
    (*self_0)
        .bits_ = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
