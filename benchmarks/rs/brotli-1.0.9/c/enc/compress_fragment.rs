...
unsafe extern "C" fn EmitInsertLen(
    ...
    if insertlen < 6 as libc::c_int as libc::c_ulong {
        let code: size_t = insertlen.wrapping_add(40 as libc::c_int as libc::c_ulong);
        BrotliWriteBits(
        ...
        *fresh0;
        ...
        let tail: size_t = insertlen.wrapping_sub(2 as libc::c_int as libc::c_ulong);
        ...
        *fresh1;
        ...
        let tail_0: size_t = insertlen.wrapping_sub(66 as libc::c_int as libc::c_ulong);
        let nbits_0: uint32_t = Log2FloorNonZero(tail_0);
        let code_0: size_t = nbits_0.wrapping_add(50 as libc::c_int as libc::c_uint)
            as size_t;
        BrotliWriteBits(
...
unsafe extern "C" fn EmitCopyLen(
    ...
    if copylen < 10 as libc::c_int as libc::c_ulong {
        ...
        *fresh7;
        ...
        let nbits_0: uint32_t = Log2FloorNonZero(tail_0);
        let code_0: size_t = nbits_0.wrapping_add(28 as libc::c_int as libc::c_uint)
            as size_t;
        BrotliWriteBits(
            *depth.offset(code_0 as isize) as size_t,
            *bits.offset(code_0 as isize) as uint64_t,
...
unsafe extern "C" fn EmitCopyLenLastDistance(
    ...
    if copylen < 12 as libc::c_int as libc::c_ulong {
        ...
        *fresh13;
        ...
        let code_1: size_t = nbits_0.wrapping_add(28 as libc::c_int as libc::c_uint)
            as size_t;
        BrotliWriteBits(
...
unsafe extern "C" fn EmitDistance(
    ...
    let offset: size_t = (2 as libc::c_int as libc::c_ulong).wrapping_add(prefix)
        << nbits;
...
unsafe extern "C" fn UpdateBits(
    ...
    while n_bits > 0 as libc::c_int as libc::c_ulong {
        ...
        let mut n_unchanged_bits: size_t = pos & 7 as libc::c_int as libc::c_ulong;
        ...
        let mut unchanged_bits: uint32_t = *array.offset(byte_pos as isize)
            as libc::c_uint & mask;
        ...
        if (block_size >= kInputMarginBytes) as libc::c_int as libc::c_long != 0 {
            ...
            's_111: loop {
                ...
                ) != 0
                {
                    ...
                    input = base;
                    next_emit = input;
                    current_block = 1802297857078318244;
                    break;
                } else {
                    EmitLongInsertLen(
                        insert,
                ...
                *table
                ...
                while IsMatch(ip, candidate) != 0 {
                    ...
                    let mut matched_0: size_t = (5 as libc::c_int as libc::c_ulong)
                        .wrapping_add(
                            FindMatchLengthWithLimit(
                                candidate.offset(5 as libc::c_int as isize),
                                ip.offset(5 as libc::c_int as isize),
