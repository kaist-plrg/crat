                ...
                != 0
            {
                ...
                if wcu_0 != wc {
                    ...
                    if (mbclen == mbcdlen) as libc::c_int as libc::c_long != 0 {
                        ...
                        src_idx = byte_idx;
                        current_block_88 = 7671027112189899641;
                        break;
                    }
                } else {
                    memcpy(
...
unsafe extern "C" fn init_word_char(mut dfa: *mut re_dfa_t) {
        ...
        as libc::c_long != 0
    {
        ...
        if 64 as libc::c_int == 64 as libc::c_int {
            ...
            current_block = 18254842853461311135;
        }
        match current_block {
            18254842853461311135 => {}
            _ => {
        ...
        match c2_0 as libc::c_int {
            ...
            58 => {
                        ...
                        << 1 as libc::c_int != 0
                {
                    ...
                    current_block_28 = 7854466874719874534;
                }
            }
            _ => {
                current_block_28 = 7854466874719874534;
    ...
    match c as libc::c_int {
        ...
        45 => {
                    ...
                    as libc::c_int == '-' as i32)
            {
                ...
                current_block_38 = 3600678818727394212;
            }
        }
        _ => {
            current_block_38 = 3600678818727394212;
...
unsafe extern "C" fn parse_expression(
    ...
    match (*token).type_0() as libc::c_int {
        ...
        23 => {
            ...
            current_block_103 = 18118495340503429063;
        }
        11 | 18 | 19 => {
            current_block_103 = 18118495340503429063;
        }
        9 => {
            current_block_103 = 4728492399713828712;
        }
        24 => {
            current_block_103 = 15525297778185363835;
        }
        12 => {
    ...
    if (start > 0 as libc::c_int) as libc::c_int as libc::c_long != 0 {
        ...
        loop {
            ...
            if (elem.is_null() || tree.is_null()) as libc::c_int as libc::c_long != 0 {
                current_block = 10711169543047482531;
                break;
            }
            i += 1;
            i;
        ...
        as libc::c_long != 0
    {
        *err = _REG_BADPAT;
        ...
        if (*token).type_0() as libc::c_int == OP_NON_MATCH_LIST as libc::c_int {
            ...
            {
                *err = _REG_BADPAT;
                current_block = 13852936146616074403;
            } else {
                                ...
                                1 => {
                                        ...
                                        as libc::c_long != 0
                                    {
                                        ...
                                        if (new_mbchars == 0 as *mut libc::c_void as *mut wchar_t)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 7143083496918493380;
                                            break;
                                        }
        ...
        as libc::c_long != 0)
    {
            ...
            as libc::c_long != 0)
        {
                ...
                || (*dfa).has_mb_node() as libc::c_int != 0
            {
                ...
                {
                    err = _REG_ESPACE;
                    current_block = 216665851873233995;
                } else {
                    mctx
                        .state_log = malloc(
                    ...
                    's_148: loop {
                        ...
                        match match_kind {
                            ...
                            7 => {
                                ...
                                current_block = 11613000955830897022;
                            }
                            6 => {
                                while (match_first < right_lim) as libc::c_int
                                    as libc::c_long != 0
...
unsafe extern "C" fn prune_impossible_nodes(
        ...
        as libc::c_int as libc::c_long != 0
    {
        ...
        if (*dfa).nbackref != 0 {
            ...
            {
                ret = _REG_ESPACE;
                current_block = 5073083355668114601;
            } else {
                's_62: loop {
                    memset(
...
unsafe extern "C" fn sift_states_backward(
    ...
    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int as libc::c_long
        != 0
    {
        current_block = 3427961895061845002;
    } else {
                            ...
                            ) as libc::c_int != 0)
                        {
                            if (local_sctx.sifted_states).is_null() {
                                ...
                                if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                    as libc::c_int as libc::c_long != 0
                                {
                                    current_block = 5267073806801104500;
                                    break 's_22;
                                }
                            }
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 11572685254514192398;
                        break;
                    }
                        ...
                        if !(cls_node == -(1 as libc::c_int)) {
                            if ((*sub_top).path).is_null() {
                                (*sub_top)
                                    ...
                                    (sl_str - (*sub_top).str_idx + 1 as libc::c_int)
                                        as libc::c_ulong,
                                ...
                                if !(has_intersec == 0) {
                                    ...
                                    if not_subset != 0 {
                                        ...
                                        if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 7667116971484224063;
                                            break 's_20;
                                        }
                                        ndests += 1;
                                        ndests;
            ...
            while j < dests_node[i as usize].nelem {
                ...
                if next_node != -(1 as libc::c_int) {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 16964616599598688260;
                        break 's_99;
                    }
                }
                j += 1;
            ...
            if !(re_node_set_contains(cur_nodes, (*ent).node) == 0) {
                ...
                if to_idx == cur_str {
                    ...
                    match current_block {
                        17179679302217393232 => {}
                        _ => {
                            let ref mut fresh81 = *((*mctx).state_log)
                                .offset(to_idx as isize);
                            *fresh81 = re_acquire_state(&mut err, dfa, &mut union_set);
                            free(union_set.elems as *mut libc::c_void);
                            if ((*((*mctx).state_log).offset(to_idx as isize)).is_null()
                                && err as libc::c_int != _REG_NOERROR as libc::c_int)
                                as libc::c_int as libc::c_long != 0
    ...
    if (*node).type_0() as libc::c_int == COMPLEX_BRACKET as libc::c_int {
        ...
        loop {
            ...
            if wc == *((*cset).mbchars).offset(i as isize) {
                match_len = char_len;
                current_block = 1428941908175990766;
                break;
            } else {
                i += 1;
                i;
...
unsafe extern "C" fn check_node_accept(
    ...
    match (*node).type_0() as libc::c_int {
        ...
        7 => {
            ...
            current_block_10 = 11020291554983179096;
        }
        5 => {
            current_block_10 = 11020291554983179096;
        }
