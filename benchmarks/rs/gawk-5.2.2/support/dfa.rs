...
extern "C" {
    ...
    fn wctob(__c: wint_t) -> libc::c_int;
...
#[inline]
unsafe extern "C" fn wctob_unused(mut __wc: wint_t) -> libc::c_int {
...
unsafe extern "C" fn xnmalloc(mut n: size_t, mut s: size_t) -> *mut libc::c_void {
    if ((if ::std::mem::size_of::<ptrdiff_t>() as libc::c_ulong
...
pub unsafe extern "C" fn xrealloc(
    ...
    let mut new_p: *mut libc::c_void = realloc(p, size);
    if new_p.is_null() {
        xalloc_die();
    }
    return new_p;
...
pub unsafe extern "C" fn xpalloc(
    ...
    *(&mut n as *mut idx_t) = fresh0;
    ...
    let mut adjusted_nbytes: idx_t = (if (if ::std::mem::size_of::<idx_t>()
        as libc::c_ulong == ::std::mem::size_of::<libc::c_schar>() as libc::c_ulong
    {
                        ...
                        < 0 as libc::c_int as libc::c_long
                    {
                            ...
                            < 0 as libc::c_int as libc::c_long
                        {
                            !(((((if 1 as libc::c_int != 0 {
                                ...
                                << (::std::mem::size_of::<idx_t>() as libc::c_ulong)
...
pub unsafe extern "C" fn ximemdup0(
    ...
    let mut result: *mut libc::c_char = malloc(
        (s + 1 as libc::c_int as libc::c_long) as libc::c_ulong,
    ) as *mut libc::c_char;
...
unsafe extern "C" fn zeroset(mut s: *mut charclass) {
    memset(
        ...
        0 as libc::c_int,
        ::std::mem::size_of::<charclass>() as libc::c_ulong,
    );
}
...
unsafe extern "C" fn charclass_index(mut d: *mut dfa, mut s: *const charclass) -> idx_t {
    ...
    (*d)
        ...
        ::std::mem::size_of::<charclass>() as libc::c_ulong as idx_t,
    ) as *mut charclass;
    (*d).cindex += 1;
    (*d).cindex;
                            ...
                            while i < n {
                                if !setbit_wc(folded[i as usize] as wint_t, &mut ccl) {
                                    (*dfa)
                                        ...
                                        ::std::mem::size_of::<wchar_t>() as libc::c_ulong as idx_t,
                                    ) as *mut wchar_t;
...
unsafe extern "C" fn lex(mut dfa: *mut dfa) -> token {
    ...
    loop {
        ...
        match c {
            92 => {
                if backslash {
                    current_block = 14883914201955301771;
                } else {
                    if (*dfa).lex.left == 0 as libc::c_int as libc::c_long {
                        dfaerror(
                            dcgettext(
            ...
            49 | 50 | 51 | 52 | 53 | 54 | 55 | 56 | 57 => {
                if !backslash {
                    ...
                    & ((((((((((((((1 as libc::c_int as libc::c_ulong)
                        ...
                        << 1 as libc::c_int) << 1 as libc::c_int != 0
                {
                    current_block = 15229165603831016243;
                } else {
            ...
            63 => {
                if (*dfa).syntax.syntax_bits
                    ...
                    != 0
                {
                    current_block = 16455861690924244022;
...
unsafe extern "C" fn addtok_mb(
    ...
    if (*dfa).talloc == (*dfa).tindex {
        (*dfa)
            ...
            -(1 as libc::c_int) as ptrdiff_t,
            ::std::mem::size_of::<token>() as libc::c_ulong as idx_t,
        ) as *mut token;
        if (*dfa).localeinfo.multibyte {
            (*dfa)
    ...
    *((*dfa).tokens).offset(fresh10 as isize) = t;
    ...
    match t {
        ...
        256 => {
            ...
            current_block_16 = 13880789179548621954;
        }
        274 => {
            (*dfa).fast = 0 as libc::c_int != 0;
            current_block_16 = 4544899792495013912;
        }
...
unsafe extern "C" fn add_utf8_anychar(mut dfa: *mut dfa) {
        ...
        == 0 as libc::c_int as libc::c_long
    {
        ...
        while (i as libc::c_ulong)
            < (::std::mem::size_of::<[charclass; 9]>() as libc::c_ulong)
                .wrapping_div(::std::mem::size_of::<charclass>() as libc::c_ulong)
        {
            (*dfa)
...
unsafe extern "C" fn copy(mut src: *const position_set, mut dst: *mut position_set) {
    if (*dst).alloc < (*src).nelem {
        free((*dst).elems as *mut libc::c_void);
        (*dst)
            .elems = xpalloc(
            ...
            (*src).nelem - (*dst).alloc,
            -(1 as libc::c_int) as ptrdiff_t,
            ::std::mem::size_of::<position>() as libc::c_ulong as idx_t,
        ) as *mut position;
    }
    (*dst).nelem = (*src).nelem;
    if (*src).nelem != 0 as libc::c_int as libc::c_long {
        memcpy(
            ...
            ((*src).nelem as libc::c_ulong)
                .wrapping_mul(::std::mem::size_of::<position>() as libc::c_ulong),
        );
    }
}
unsafe extern "C" fn alloc_position_set(mut s: *mut position_set, mut size: idx_t) {
    (*s)
        .elems = xnmalloc(
        size as size_t,
        ::std::mem::size_of::<position>() as libc::c_ulong,
    ) as *mut position;
    (*s).alloc = size;
...
unsafe extern "C" fn merge_constrained(
    ...
    if (*m).alloc - (*s1).nelem < (*s2).nelem {
        free((*m).elems as *mut libc::c_void);
        (*m).alloc = (*s1).nelem;
        (*m)
            .elems = xpalloc(
            0 as *mut libc::c_void,
...
unsafe extern "C" fn state_index(
    ...
    (*d)
        ...
        &mut (*d).salloc,
        -(1 as libc::c_int) as ptrdiff_t,
        ::std::mem::size_of::<dfa_state>() as libc::c_ulong as idx_t,
    ) as *mut dfa_state;
...
unsafe extern "C" fn epsclosure(mut d: *const dfa, mut backward: *mut position_set) {
    ...
    while i < (*d).tindex {
            ...
            < (*((*d).follows).offset(i as isize)).nelem
        {
            ...
            match *((*d).tokens).offset(i as isize) {
                268 => {
                    current_block_12 = 13864821308468751900;
                    match current_block_12 {
                        11080366019037810193 => {
                ...
                269 => {
                    current_block_12 = 819037118680370750;
                    match current_block_12 {
                        11080366019037810193 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                270 => {
                    current_block_12 = 12858059004824668994;
                    match current_block_12 {
                        11080366019037810193 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                271 => {
                    current_block_12 = 5233293622026407812;
                    match current_block_12 {
                        11080366019037810193 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                272 => {
                    current_block_12 = 8836757511579242428;
                    match current_block_12 {
                        11080366019037810193 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                273 => {
                    current_block_12 = 18266794816609870263;
                    match current_block_12 {
                        11080366019037810193 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
                ...
                256 => {
                    current_block_12 = 11080366019037810193;
                    match current_block_12 {
                        11080366019037810193 => {
                            constraint = NO_CONSTRAINT as libc::c_int as libc::c_uint;
                        }
    ...
    free(tmp.elems as *mut libc::c_void);
}
...
unsafe extern "C" fn reorder_tokens(mut d: *mut dfa) {
    ...
    *map.offset(0 as libc::c_int as isize) = fresh20;
    ...
    let mut follows: *mut position_set = xnmalloc(
        (*d).nleaves as size_t,
        ::std::mem::size_of::<position_set>() as libc::c_ulong,
    ) as *mut position_set;
    ...
    while i_0 < (*d).tindex {
        if *map.offset(i_0 as isize) < 0 as libc::c_int as libc::c_long {
            free((*((*d).follows).offset(i_0 as isize)).elems as *mut libc::c_void);
    ...
    free(follows as *mut libc::c_void);
    free(constraints as *mut libc::c_void);
    free(multibyte_prop as *mut libc::c_void);
...
unsafe extern "C" fn dfaoptimize(mut d: *mut dfa) {
    ...
    *fresh28 = (*fresh28 as libc::c_int | OPT_QUEUED as libc::c_int) as libc::c_char;
    ...
    reorder_tokens(d);
    free((*merged).elems as *mut libc::c_void);
...
unsafe extern "C" fn dfaanalyze(mut d: *mut dfa, mut searchflag: bool) {
    ...
    let mut backward: *mut position_set = (if (*d).epsilon as libc::c_int != 0 {
        xcalloc(tindex as size_t, ::std::mem::size_of::<position_set>() as libc::c_ulong)
    } else {
        0 as *mut libc::c_void
    }) as *mut position_set;
    let mut i: idx_t = 0 as libc::c_int as idx_t;
    while i < tindex {
        ...
        match *((*d).tokens).offset(i as isize) {
            ...
            258 | 259 => {
                ...
                current_block_53 = 13888381626014317794;
            }
            257 => {
                current_block_53 = 13888381626014317794;
            }
    ...
    if !backward.is_null() {
        ...
        let mut i_0: idx_t = 0 as libc::c_int as idx_t;
        while i_0 < tindex {
            free((*backward.offset(i_0 as isize)).elems as *mut libc::c_void);
            i_0 += 1;
            i_0;
        }
        free(backward as *mut libc::c_void);
    }
    dfaoptimize(d);
    ...
    free(posalloc as *mut libc::c_void);
    free(stkalloc as *mut libc::c_void);
    free(merged.elems as *mut libc::c_void);
    free(tmp.elems as *mut libc::c_void);
}
unsafe extern "C" fn realloc_trans_if_necessary(mut d: *mut dfa) {
    ...
    if oldalloc < (*d).sindex {
        ...
        realtrans = xpalloc(
            ...
            (*d).sindex - oldalloc,
            -(1 as libc::c_int) as ptrdiff_t,
            ::std::mem::size_of::<*mut state_num>() as libc::c_ulong as idx_t,
        ...
        *fresh36 = *fresh35;
        ...
        (*d)
            ...
            newalloc as size_t,
            ::std::mem::size_of::<*mut state_num>() as libc::c_ulong,
        ) as *mut *mut state_num;
        (*d)
            .success = xnrealloc(
        ...
        (*d)
            ...
            newalloc as size_t,
            ::std::mem::size_of::<state_num>() as libc::c_ulong,
        ) as *mut state_num;
...
unsafe extern "C" fn build_state(
    ...
    if trans.is_null() {
        if MAX_TRCOUNT as libc::c_int <= (*d).trcount {
            ...
            while i < (*d).tralloc {
                free(*((*d).trans).offset(i as isize) as *mut libc::c_void);
                free(*((*d).fails).offset(i as isize) as *mut libc::c_void);
        ...
        trans = xmalloc(
            (NOTCHAR as libc::c_int as libc::c_ulong)
                .wrapping_mul(::std::mem::size_of::<state_num>() as libc::c_ulong),
        ) as *mut state_num;
        *ptrans = trans;
        let mut i_0: libc::c_int = 0 as libc::c_int;
    ...
    *((*d).success).offset(s as isize) = 0 as libc::c_int as libc::c_char;
    ...
    free(group.elems as *mut libc::c_void);
    ...
    *pp = (*pp).offset((mbclen - mbci) as isize);
    ...
    if (*((*d).states).offset(s1 as isize)).mb_trindex < 0 as libc::c_int as libc::c_long
    {
        if MAX_TRCOUNT as libc::c_int as libc::c_long <= (*d).mb_trcount {
            ...
            while s3 < (*d).tralloc {
                free(*((*d).mb_trans).offset(s3 as isize) as *mut libc::c_void);
...
unsafe extern "C" fn dfaexec_main(
    ...
    if MAX_TRCOUNT as libc::c_int as libc::c_long <= (*d).sindex {
        ...
        while s < (*d).sindex {
            free((*((*d).states).offset(s as isize)).elems.elems as *mut libc::c_void);
            free((*((*d).states).offset(s as isize)).mbps.elems as *mut libc::c_void);
            s += 1;
            s;
        }
        ...
        if !((*d).trans).is_null() {
            ...
            while s_0 < (*d).tralloc {
                free(*((*d).trans).offset(s_0 as isize) as *mut libc::c_void);
                free(*((*d).fails).offset(s_0 as isize) as *mut libc::c_void);
        ...
        if (*d).localeinfo.multibyte as libc::c_int != 0 && !((*d).mb_trans).is_null() {
            ...
            while s_1 < (*d).tralloc {
                free(*((*d).mb_trans).offset(s_1 as isize) as *mut libc::c_void);
...
pub unsafe extern "C" fn dfaexec(
    ...
    return ((*d).dfaexec).unwrap()(d, begin, end, allow_nl, count, backref);
}
...
unsafe extern "C" fn free_mbdata(mut d: *mut dfa) {
    free((*d).multibyte_prop as *mut libc::c_void);
    free((*d).lex.brack.chars as *mut libc::c_void);
    free((*d).mb_follows.elems as *mut libc::c_void);
    if !((*d).mb_trans).is_null() {
        let mut s: state_num = 0;
        s = -(1 as libc::c_int) as state_num;
        while s < (*d).tralloc {
            free(*((*d).mb_trans).offset(s as isize) as *mut libc::c_void);
            s += 1;
            s;
        }
        free(((*d).mb_trans).offset(-(2 as libc::c_int as isize)) as *mut libc::c_void);
    }
}
        ...
        match *((*d).tokens).offset(i as isize) {
            270 | 271 | 272 | 273 => {
                if !(*d).localeinfo.multibyte {
                    ...
                    current_block_1 = 11894611796288955927;
                }
            }
            274 | 275 => {
                current_block_1 = 11894611796288955927;
...
unsafe extern "C" fn maybe_disable_superset_dfa(mut d: *mut dfa) {
    ...
    if !have_backref && !((*d).superset).is_null() {
        dfafree((*d).superset);
        free((*d).superset as *mut libc::c_void);
    ...
    if (*d).cindex != 0 {
        memcpy(
            ...
            ((*d).cindex as libc::c_ulong)
                .wrapping_mul(::std::mem::size_of::<charclass>() as libc::c_ulong),
        );
    }
    (*sup)
        .tokens = xnmalloc(
        (*d).tindex as size_t,
        (2 as libc::c_int as libc::c_ulong)
            .wrapping_mul(::std::mem::size_of::<token>() as libc::c_ulong),
    ) as *mut token;
            ...
            270 | 271 | 272 | 273 => {
                if (*d).localeinfo.multibyte {
                    ...
                    *((*sup).tokens)
                    ...
                    current_block_32 = 14797834874599232187;
                }
            }
            _ => {
                current_block_32 = 14797834874599232187;
...
pub unsafe extern "C" fn dfafree(mut d: *mut dfa) {
    free((*d).charclasses as *mut libc::c_void);
    free((*d).tokens as *mut libc::c_void);
    if (*d).localeinfo.multibyte {
        free_mbdata(d);
    }
    free((*d).constraints as *mut libc::c_void);
    free((*d).separates as *mut libc::c_void);
    let mut i: idx_t = 0 as libc::c_int as idx_t;
    while i < (*d).sindex {
        free((*((*d).states).offset(i as isize)).elems.elems as *mut libc::c_void);
        free((*((*d).states).offset(i as isize)).mbps.elems as *mut libc::c_void);
        i += 1;
        i;
    }
    free((*d).states as *mut libc::c_void);
    if !((*d).follows).is_null() {
        ...
        free((*d).follows as *mut libc::c_void);
    }
    if !((*d).trans).is_null() {
        let mut i_1: idx_t = 0 as libc::c_int as idx_t;
        while i_1 < (*d).tralloc {
            free(*((*d).trans).offset(i_1 as isize) as *mut libc::c_void);
            free(*((*d).fails).offset(i_1 as isize) as *mut libc::c_void);
            i_1 += 1;
            i_1;
        }
        free(((*d).trans).offset(-(2 as libc::c_int as isize)) as *mut libc::c_void);
        free((*d).fails as *mut libc::c_void);
        free((*d).newlines as *mut libc::c_void);
        free((*d).success as *mut libc::c_void);
    }
    if !((*d).superset).is_null() {
        dfafree((*d).superset);
        free((*d).superset as *mut libc::c_void);
...
unsafe extern "C" fn freelist(mut cpp: *mut *mut libc::c_char) {
    while !(*cpp).is_null() {
        let fresh62 = cpp;
        cpp = cpp.offset(1);
        free(*fresh62 as *mut libc::c_void);
    }
}
unsafe extern "C" fn enlistnew(
    ...
    while !(*cpp.offset(j as isize)).is_null() {
        if (strstr(new, *cpp.offset(j as isize))).is_null() {
            ...
            free(*cpp.offset(j as isize) as *mut libc::c_void);
            i -= 1;
            if i == j {
                break;
            }
...
unsafe extern "C" fn allocmust(mut mp: *mut must, mut size: idx_t) -> *mut must {
    let mut new_mp: *mut must = xmalloc(::std::mem::size_of::<must>() as libc::c_ulong)
        as *mut must;
    (*new_mp)
        .in_0 = xzalloc(::std::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
        as *mut *mut libc::c_char;
...
unsafe extern "C" fn freemust(mut mp: *mut must) {
    freelist((*mp).in_0);
    free((*mp).in_0 as *mut libc::c_void);
    free((*mp).left as *mut libc::c_void);
    free((*mp).right as *mut libc::c_void);
    free((*mp).is as *mut libc::c_void);
...
pub unsafe extern "C" fn dfamust(mut d: *const dfa) -> *mut dfamust {
            ...
            262 => {
                ...
                if str_eq((*lmp).is, (*rmp).is) {
                    (*lmp)
                        ...
                        & (*rmp).begline as libc::c_int) != 0;
                    (*lmp)
                        .endline = ((*lmp).endline as libc::c_int
                        & (*rmp).endline as libc::c_int) != 0;
                } else {
                    *((*lmp).is)
                ...
                *((*lmp).right).offset(j as isize) = '\0' as i32 as libc::c_char;
                ...
                freelist((*lmp).in_0);
                free((*lmp).in_0 as *mut libc::c_void);
                (*lmp).in_0 = new;
                freemust(rmp);
            }
            259 => {
                            ...
                            if tstbit(j_0 as libc::c_uint, ccl) as libc::c_int != 0
                                && !(case_fold_unibyte as libc::c_int != 0
                                    && ({
                                        ...
                                        == ({
                                            let mut __res: libc::c_int = 0;
                                            if ::std::mem::size_of::<token>() as libc::c_ulong
                                                > 1 as libc::c_int as libc::c_ulong
                                            {
                                                if 0 != 0 {
    ...
    if *result != 0 {
        dm = xmalloc(
            (3 as libc::c_ulong)
                .wrapping_add(::std::mem::align_of::<dfamust>() as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                .wrapping_add(
                    (strlen(result)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                )
                & !(::std::mem::align_of::<dfamust>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
        ) as *mut dfamust;
        (*dm).exact = exact;
        (*dm).begline = begline;
...
pub unsafe extern "C" fn dfamustfree(mut dm: *mut dfamust) {
    free(dm as *mut libc::c_void);
}
pub unsafe extern "C" fn dfaalloc() -> *mut dfa {
    return xmalloc(::std::mem::size_of::<dfa>() as libc::c_ulong) as *mut dfa;
}
