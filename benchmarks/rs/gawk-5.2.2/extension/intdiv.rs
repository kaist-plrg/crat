...
unsafe extern "C" fn do_intdiv(
    ...
    if ((*api).api_get_argument)
        .unwrap()(ext_id, 0 as libc::c_int as size_t, AWK_NUMBER, &mut nv) as u64 == 0
    {
        ((*api).api_warning)
            .unwrap()(
            ext_id,
    ...
    if ((*api).api_get_argument)
        .unwrap()(ext_id, 1 as libc::c_int as size_t, AWK_NUMBER, &mut dv) as u64 == 0
    {
        ((*api).api_warning)
            .unwrap()(
            ext_id,
    ...
    if ((*api).api_get_argument)
        .unwrap()(ext_id, 2 as libc::c_int as size_t, AWK_ARRAY, &mut array_param) as u64
        == 0
    {
        ((*api).api_warning)
            .unwrap()(
