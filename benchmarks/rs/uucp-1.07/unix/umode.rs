...
pub unsafe extern "C" fn ixsysdep_user_file_mode(
    ...
    iret = stat(zfile as *mut libc::c_char, &mut s);
    ...
    if s.st_mode & 0o777 as libc::c_int as libc::c_uint
        == 0 as libc::c_int as libc::c_uint
    {
        return 0o400 as libc::c_int as libc::c_uint;
    }
    return s.st_mode & 0o777 as libc::c_int as libc::c_uint;
}
