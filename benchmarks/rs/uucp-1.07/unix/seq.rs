...
pub unsafe extern "C" fn ixsysdep_get_sequence(
    ...
    iseq = 0 as libc::c_int as libc::c_long;
    if stat(zname, &mut s) == 0 as libc::c_int {
            ...
            != 0 as libc::c_int as libc::c_uint
        {
            ulog(
                LOG_ERROR,
                b"Bad file protection for conversation sequence file\0" as *const u8
        ...
        if getline(&mut zline, &mut cline, e) <= 0 as libc::c_int as libc::c_long {
            ...
            iseq = strtol(zline, &mut zend, 10 as libc::c_int);
            if zend == zline {
                fok = 0 as libc::c_int;
            }
        }
        ...
        if fok == 0 {
            ulog(
                LOG_ERROR,
                b"Bad format for conversation sequence file\0" as *const u8
                    as *const libc::c_char,
            );
            fclose(e);
            return -(1 as libc::c_int) as libc::c_long;
        ...
        e = esysdep_fopen(zname, 0 as libc::c_int, 0 as libc::c_int, 1 as libc::c_int);
        ubuffree(zname);
        if e.is_null() {
            return -(1 as libc::c_int) as libc::c_long;
        }
    ...
    iseq += 1;
    iseq;
    fprintf(e, b"%ld\0" as *const u8 as *const libc::c_char, iseq);
