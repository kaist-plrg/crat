...
pub static mut uuname_rcsid: [libc::c_char; 51] = unsafe {
    *::std::mem::transmute::<
        &[u8; 51],
        &[libc::c_char; 51],
    >(b"$Id: uuname.c,v 1.24 2002/03/05 19:10:42 ian Rel $\0")
};
static mut asNlongopts: [option; 7] = [
    {
        let mut init = option {
...
unsafe fn main_0(
    ...
    let mut falias: boolean = 0 as libc::c_int;
    let mut flocal: boolean = 0 as libc::c_int;
    ...
    loop {
        iopt = getopt_long(
            argc,
            argv,
            b"alI:vx:\0" as *const u8 as *const libc::c_char,
            asNlongopts.as_ptr(),
    ...
    usysdep_initialize(puuconf, 0o4 as libc::c_int | 0o2 as libc::c_int);
    if flocal != 0 {
...
unsafe extern "C" fn unusage() {
    fprintf(
        stderr,
        b"Usage: %s [-a] [-l] [-I file]\n\0" as *const u8 as *const libc::c_char,
        zProgram,
    );
    fprintf(
        stderr,
...
unsafe extern "C" fn unhelp() {
    ...
    printf(b" -a,--aliases: display aliases\n\0" as *const u8 as *const libc::c_char);
    printf(b" -l,--local: print local name\n\0" as *const u8 as *const libc::c_char);
    printf(
