...
pub static mut _uuconf_deblev_rcsid: [libc::c_char; 50] = unsafe {
    *::std::mem::transmute::<
        &[u8; 50],
        &[libc::c_char; 50],
    >(b"$Id: deblev.c,v 1.6 2002/03/05 19:10:42 ian Rel $\0")
};
pub unsafe extern "C" fn uuconf_debuglevel(
    mut pglobal: pointer,
    mut pzdebug: *mut *const libc::c_char,
) -> libc::c_int {
