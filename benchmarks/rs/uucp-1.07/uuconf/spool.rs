...
pub static mut _uuconf_spool_rcsid: [libc::c_char; 49] = unsafe {
    *::std::mem::transmute::<
        &[u8; 49],
        &[libc::c_char; 49],
    >(b"$Id: spool.c,v 1.7 2002/03/05 19:10:42 ian Rel $\0")
};
pub unsafe extern "C" fn uuconf_spooldir(
    mut pglobal: pointer,
    mut pzspool: *mut *const libc::c_char,
) -> libc::c_int {
