...
pub static mut _uuconf_lckdir_rcsid: [libc::c_char; 50] = unsafe {
    *::std::mem::transmute::<
        &[u8; 50],
        &[libc::c_char; 50],
    >(b"$Id: lckdir.c,v 1.6 2002/03/05 19:10:42 ian Rel $\0")
};
pub unsafe extern "C" fn uuconf_lockdir(
    mut pglobal: pointer,
    mut pzlock: *mut *const libc::c_char,
) -> libc::c_int {
