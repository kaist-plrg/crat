use ::libc;
extern "C" {
    fn uuconf_taylor_system_unknown(
...
pub static mut _uuconf_unk_rcsid: [libc::c_char; 47] = unsafe {
    *::std::mem::transmute::<
        &[u8; 47],
        &[libc::c_char; 47],
    >(b"$Id: unk.c,v 1.6 2002/03/05 19:10:43 ian Rel $\0")
};
pub unsafe extern "C" fn uuconf_system_unknown(
    mut pglobal: pointer,
