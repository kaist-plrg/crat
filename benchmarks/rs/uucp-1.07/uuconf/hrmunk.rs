...
pub static mut _uuconf_hrmunk_rcsid: [libc::c_char; 50] = unsafe {
    *::std::mem::transmute::<
        &[u8; 50],
        &[libc::c_char; 50],
    >(b"$Id: hrmunk.c,v 1.5 2002/03/05 19:10:42 ian Rel $\0")
};
pub unsafe extern "C" fn uuconf_hdb_remote_unknown(
    mut pglobal: pointer,
    mut pzname: *mut *mut libc::c_char,
) -> libc::c_int {
    let mut qglobal: *mut sglobal = pglobal as *mut sglobal;
    let mut csize: size_t = 0;
    csize = (::std::mem::size_of::<[libc::c_char; 14]>() as libc::c_ulong)
        .wrapping_add(::std::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong)
        .wrapping_sub(1 as libc::c_int as libc::c_ulong);
    *pzname = malloc(csize) as *mut libc::c_char;
    if (*pzname).is_null() {
        (*qglobal).ierrno = *__errno_location();
        return 4 as libc::c_int | 0x100 as libc::c_int;
    }
    memcpy(
        *pzname as *mut libc::c_void,
        b"/usr/lib/uucp\0" as *const u8 as *const libc::c_char as *const libc::c_void,
    ...
    memcpy(
        ...
        b"/remote.unknown\0" as *const u8 as *const libc::c_char as *const libc::c_void,
