...
pub static mut _uuconf_bool_rcsid: [libc::c_char; 48] = unsafe {
    *::std::mem::transmute::<
        &[u8; 48],
        &[libc::c_char; 48],
    >(b"$Id: bool.c,v 1.8 2002/03/05 19:10:42 ian Rel $\0")
};
pub unsafe extern "C" fn _uuconf_iboolean(
    mut qglobal: *mut sglobal,
    mut zval: *const libc::c_char,
    mut pi: *mut boolean,
) -> libc::c_int {
    match *zval as libc::c_int {
        121 | 89 | 116 | 84 => {
            *pi = 1 as libc::c_int;
        }
        110 | 78 | 102 | 70 => {
