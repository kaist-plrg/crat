...
pub static mut _uuconf_local_rcsid: [libc::c_char; 49] = unsafe {
    *::std::mem::transmute::<
        &[u8; 49],
        &[libc::c_char; 49],
    >(b"$Id: local.c,v 1.7 2002/03/05 19:10:42 ian Rel $\0")
};
pub unsafe extern "C" fn uuconf_system_local(
    mut pglobal: pointer,
    ...
    (*qsys).uuconf_zname = (*(*qglobal).qprocess).zlocalname as *mut libc::c_char;
