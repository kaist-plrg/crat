...
pub static mut _uuconf_int_rcsid: [libc::c_char; 47] = unsafe {
    *::std::mem::transmute::<
        &[u8; 47],
        &[libc::c_char; 47],
    >(b"$Id: int.c,v 1.9 2002/03/05 19:10:42 ian Rel $\0")
};
pub unsafe extern "C" fn _uuconf_iint(
    ...
    i = strtol(zval as *mut libc::c_char, &mut zend, 10 as libc::c_int);
