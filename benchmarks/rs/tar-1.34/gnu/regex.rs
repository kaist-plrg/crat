                ...
                != 0
            {
                ...
                if wcu_0 != wc {
                    ...
                    if (mbclen == mbcdlen) as libc::c_int as libc::c_long != 0 {
                        ...
                        src_idx = byte_idx;
                        current_block_88 = 13359462558428291882;
                        break;
                    }
                } else {
                    memcpy(
...
unsafe extern "C" fn init_word_char(mut dfa: *mut re_dfa_t) {
        ...
        as libc::c_long != 0
    {
        ...
        if 64 as libc::c_int == 64 as libc::c_int {
            ...
            current_block = 839125782792710973;
        }
        match current_block {
            839125782792710973 => {}
            _ => {
        ...
        match c2_0 as libc::c_int {
            ...
            58 => {
                        ...
                        << 1 as libc::c_int != 0
                {
                    ...
                    current_block_28 = 5204611982189017374;
                }
            }
            _ => {
                current_block_28 = 5204611982189017374;
...
unsafe extern "C" fn parse_expression(
    ...
    match (*token).type_0() as libc::c_int {
        ...
        23 => {
            ...
            current_block_103 = 9548602284111555425;
        }
        11 | 18 | 19 => {
            current_block_103 = 9548602284111555425;
        }
        9 => {
            current_block_103 = 2643031677141173410;
        }
        24 => {
            current_block_103 = 8214096997035920065;
        }
        12 => {
    ...
    if (start > 0 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long != 0 {
        ...
        loop {
            ...
            if (elem.is_null() || tree.is_null()) as libc::c_int as libc::c_long != 0 {
                current_block = 15600887916123567992;
                break;
            }
            i += 1;
            i;
        ...
        as libc::c_long != 0
    {
        *err = _REG_BADPAT;
        ...
        if (*token).type_0() as libc::c_int == OP_NON_MATCH_LIST as libc::c_int {
            ...
            {
                *err = _REG_BADPAT;
                current_block = 11149527351725990618;
            } else {
                                ...
                                1 => {
                                        ...
                                        as libc::c_long != 0
                                    {
                                        ...
                                        if (new_mbchars == 0 as *mut libc::c_void as *mut wchar_t)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 9943575117110615375;
                                            break;
                                        }
        ...
        as libc::c_long != 0)
    {
            ...
            as libc::c_long != 0)
        {
                ...
                || (*dfa).has_mb_node() as libc::c_int != 0
            {
                ...
                {
                    err = _REG_ESPACE;
                    current_block = 2540743048622582281;
                } else {
                    mctx
                        .state_log = malloc(
                    ...
                    's_148: loop {
                        ...
                        match match_kind {
                            ...
                            7 => {
                                ...
                                current_block = 10367838102090264875;
                            }
                            6 => {
                                while (match_first < right_lim) as libc::c_int
                                    as libc::c_long != 0
...
unsafe extern "C" fn prune_impossible_nodes(
        ...
        as libc::c_int as libc::c_long != 0
    {
        ...
        if (*dfa).nbackref != 0 {
            ...
            {
                ret = _REG_ESPACE;
                current_block = 5095162669983815853;
            } else {
                's_62: loop {
                    memset(
...
unsafe extern "C" fn set_regs(
    ...
    if nmatch.wrapping_mul(::std::mem::size_of::<regmatch_t>() as libc::c_ulong)
        < 4032 as libc::c_int as libc::c_ulong
    {
        let mut fresh56 = ::std::vec::from_elem(
            0,
            nmatch.wrapping_mul(::std::mem::size_of::<regmatch_t>() as libc::c_ulong)
                as usize,
        );
        prev_idx_match = fresh56.leak().as_mut_ptr() as *mut regmatch_t;
    } else {
...
unsafe extern "C" fn sift_states_backward(
    ...
    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int as libc::c_long
        != 0
    {
        current_block = 11228048028914693991;
    } else {
        current_block = 6873731126896040597;
    }
    loop {
        match current_block {
            11228048028914693991 => {
                            ...
                            ) as libc::c_int != 0)
                        {
                            if (local_sctx.sifted_states).is_null() {
                                ...
                                if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                    as libc::c_int as libc::c_long != 0
                                {
                                    current_block = 2783557328197972944;
                                    break 's_22;
                                }
                            }
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if (err as libc::c_int != _REG_NOERROR as libc::c_int) as libc::c_int
                        as libc::c_long != 0
                    {
                        current_block = 7902405248713718401;
                        break;
                    }
...
unsafe extern "C" fn build_trtable(
    ...
    if (::std::mem::size_of::<dests_alloc>() as libc::c_ulong)
        < 4032 as libc::c_int as libc::c_ulong
    {
        let mut fresh78 = ::std::vec::from_elem(
            0,
            ::std::mem::size_of::<dests_alloc>() as libc::c_ulong as usize,
        );
        dests_alloc_0 = fresh78.leak().as_mut_ptr() as *mut dests_alloc;
    } else {
        dests_alloc_0 = malloc(
            (1 as libc::c_int as libc::c_ulong)
                .wrapping_mul(::std::mem::size_of::<dests_alloc>() as libc::c_ulong),
        ) as *mut dests_alloc;
        ...
        as libc::c_long != 0)
    {
        ndests_max = (18446744073709551615 as libc::c_ulong)
            .wrapping_sub(
                (::std::mem::size_of::<re_node_set>() as libc::c_ulong)
                    .wrapping_add(::std::mem::size_of::<bitset_t>() as libc::c_ulong)
                    .wrapping_mul(
                        (127 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int
                            + 1 as libc::c_int) as libc::c_ulong,
                    ),
        ...
        if !((ndests_max < ndests as libc::c_ulong) as libc::c_int as libc::c_long != 0)
        {
                ...
                ) < 4032 as libc::c_int as libc::c_ulong
            {
                ...
                dest_states = fresh79.leak().as_mut_ptr() as *mut *mut re_dfastate_t;
                ...
                if (dest_states == 0 as *mut libc::c_void as *mut *mut re_dfastate_t)
                    as libc::c_int as libc::c_long != 0
                {
                    current_block = 1781555034012719881;
                } else {
                                ...
                                if !(has_intersec == 0) {
                                    ...
                                    if not_subset != 0 {
                                        ...
                                        if (err as libc::c_int != _REG_NOERROR as libc::c_int)
                                            as libc::c_int as libc::c_long != 0
                                        {
                                            current_block = 8817499183660982189;
                                            break 's_20;
                                        }
                                        ndests += 1;
                                        ndests;
    ...
    if (*node).type_0() as libc::c_int == COMPLEX_BRACKET as libc::c_int {
        ...
        loop {
            ...
            if wc == *((*cset).mbchars).offset(i as isize) {
                match_len = char_len;
                current_block = 1360135982504767107;
                break;
            } else {
                i += 1;
                i;
...
unsafe extern "C" fn check_node_accept(
    ...
    match (*node).type_0() as libc::c_int {
        ...
        7 => {
            ...
            current_block_10 = 11490140262685877891;
        }
        5 => {
            current_block_10 = 11490140262685877891;
        }
