...
unsafe extern "C" fn random_bits(mut var: random_value) -> random_value {
    ...
    if getrandom(
        ...
        ::std::mem::size_of::<random_value>() as libc::c_ulong,
        0 as libc::c_int as libc::c_uint,
    ) as libc::c_ulong == ::std::mem::size_of::<random_value>() as libc::c_ulong
    {
        return r;
    }
...
pub unsafe extern "C" fn try_tempname_len(
    ...
    v = (&mut v as *mut random_value as uintptr_t)
        .wrapping_div(::std::mem::align_of::<max_align_t>() as libc::c_ulong);
