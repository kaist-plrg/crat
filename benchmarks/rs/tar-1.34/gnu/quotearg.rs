        ...
        } == 0
        {
            ...
            match c as libc::c_int {
                ...
                63 => {
                    match quoting_style as libc::c_uint {
                        2 => {
                            current_block = 1539840190201372084;
                            match current_block {
                                1539840190201372084 => {
                                    if elide_outer_quotes {
                                        current_block = 1591135554063658034;
                        ...
                        5 => {
                            current_block = 2499862200762890612;
                            match current_block {
                                1539840190201372084 => {
                                    if elide_outer_quotes {
                                        current_block = 1591135554063658034;
                ...
                7 => {
                    ...
                    current_block = 224235687410399782;
                }
                8 => {
                ...
                10 => {
                    ...
                    current_block = 14982948109990972751;
                }
                13 => {
                ...
                92 => {
                        ...
                        == shell_always_quoting_style as libc::c_int as libc::c_uint
                    {
                        ...
                        current_block = 14008454377391335571;
                ...
                123 | 125 => {
                    ...
                    } == 0
                    {
                        ...
                        current_block = 7282908690880421722;
                    }
                }
                35 | 126 => {
                    current_block = 7282908690880421722;
                ...
                32 => {
                    current_block = 16054785998287118542;
                }
                33 => {
                    current_block = 14940479649029852140;
                }
                34 | 36 | 38 | 40 | 41 | 42 | 59 | 60 | 61 => {
                    current_block = 17511492282867121744;
                }
                62 | 91 | 94 => {
                    current_block = 5545972317539803128;
                }
                96 | 124 => {
                    current_block = 1460062008737201577;
                }
                39 => {
            ...
            match current_block {
                14940479649029852140 => {
                    current_block = 17511492282867121744;
                }
                _ => {}
            }
            match current_block {
                17511492282867121744 => {
                    current_block = 5545972317539803128;
                }
                _ => {}
            }
