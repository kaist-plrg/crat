...
unsafe extern "C" fn extrapolate3(
    ...
    let mut index: libc::c_int = *permGradIndex3D
        .offset(
            (*perm
                .offset(
...
unsafe extern "C" fn fastFloor(mut x: libc::c_double) -> libc::c_int {
    let mut xi: libc::c_int = x as libc::c_int;
...
pub unsafe extern "C" fn open_simplex_noise(
    ...
    let mut i: libc::c_int = 0;
    let mut perm: *mut int16_t = 0 as *mut int16_t;
    let mut permGradIndex3D: *mut int16_t = 0 as *mut int16_t;
    *ctx = malloc(::std::mem::size_of::<osn_context>() as libc::c_ulong)
    ...
    while i >= 0 as libc::c_int {
        seed = (seed as libc::c_longlong * 6364136223846793005 as libc::c_longlong
            + 1442695040888963407 as libc::c_longlong) as int64_t;
        let mut r: libc::c_int = ((seed + 31 as libc::c_int as libc::c_long)
...
pub unsafe extern "C" fn open_simplex_noise2(
    ...
    let mut stretchOffset: libc::c_double = (x + y) * -0.211324865405187f64;
    let mut xs: libc::c_double = x + stretchOffset;
    let mut ys: libc::c_double = y + stretchOffset;
    let mut xsb: libc::c_int = fastFloor(xs);
    let mut ysb: libc::c_int = fastFloor(ys);
    let mut squishOffset: libc::c_double = (xsb + ysb) as libc::c_double
        * 0.366025403784439f64;
    let mut xb: libc::c_double = xsb as libc::c_double + squishOffset;
    let mut yb: libc::c_double = ysb as libc::c_double + squishOffset;
    let mut xins: libc::c_double = xs - xsb as libc::c_double;
    let mut yins: libc::c_double = ys - ysb as libc::c_double;
    let mut inSum: libc::c_double = xins + yins;
    let mut dx0: libc::c_double = x - xb;
    let mut dy0: libc::c_double = y - yb;
    ...
    let mut dx1: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
        - 0.366025403784439f64;
    let mut dy1: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
        - 0.366025403784439f64;
    let mut attn1: libc::c_double = 2 as libc::c_int as libc::c_double - dx1 * dx1
        - dy1 * dy1;
    ...
    let mut dx2: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
        - 0.366025403784439f64;
    let mut dy2: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
        - 0.366025403784439f64;
    let mut attn2: libc::c_double = 2 as libc::c_int as libc::c_double - dx2 * dx2
        - dy2 * dy2;
    ...
    if inSum <= 1 as libc::c_int as libc::c_double {
        let mut zins: libc::c_double = 1 as libc::c_int as libc::c_double - inSum;
        ...
        let mut zins_0: libc::c_double = 2 as libc::c_int as libc::c_double - inSum;
    ...
    let mut attn0: libc::c_double = 2 as libc::c_int as libc::c_double - dx0 * dx0
        - dy0 * dy0;
    if attn0 > 0 as libc::c_int as libc::c_double {
        attn0 *= attn0;
        value += attn0 * attn0 * extrapolate2(ctx, xsb, ysb, dx0, dy0);
    }
    let mut attn_ext: libc::c_double = 2 as libc::c_int as libc::c_double
...
pub unsafe extern "C" fn open_simplex_noise3(
    ...
    let mut stretchOffset: libc::c_double = (x + y + z) * (-1.0f64 / 6.0f64);
    let mut xs: libc::c_double = x + stretchOffset;
    let mut ys: libc::c_double = y + stretchOffset;
    let mut zs: libc::c_double = z + stretchOffset;
    let mut xsb: libc::c_int = fastFloor(xs);
    let mut ysb: libc::c_int = fastFloor(ys);
    let mut zsb: libc::c_int = fastFloor(zs);
    let mut squishOffset: libc::c_double = (xsb + ysb + zsb) as libc::c_double
        * (1.0f64 / 3.0f64);
    let mut xb: libc::c_double = xsb as libc::c_double + squishOffset;
    let mut yb: libc::c_double = ysb as libc::c_double + squishOffset;
    let mut zb: libc::c_double = zsb as libc::c_double + squishOffset;
    let mut xins: libc::c_double = xs - xsb as libc::c_double;
    let mut yins: libc::c_double = ys - ysb as libc::c_double;
    let mut zins: libc::c_double = zs - zsb as libc::c_double;
    let mut inSum: libc::c_double = xins + yins + zins;
    let mut dx0: libc::c_double = x - xb;
    let mut dy0: libc::c_double = y - yb;
    let mut dz0: libc::c_double = z - zb;
    ...
    let mut value: libc::c_double = 0 as libc::c_int as libc::c_double;
    if inSum <= 1 as libc::c_int as libc::c_double {
        let mut aPoint: int8_t = 0x1 as libc::c_int as int8_t;
        let mut aScore: libc::c_double = xins;
        let mut bPoint: int8_t = 0x2 as libc::c_int as int8_t;
        let mut bScore: libc::c_double = yins;
        ...
        let mut wins: libc::c_double = 1 as libc::c_int as libc::c_double - inSum;
        if wins > aScore || wins > bScore {
            ...
            let mut c_0: int8_t = (aPoint as libc::c_int | bPoint as libc::c_int)
                as int8_t;
        ...
        let mut dy1: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut dz1: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut attn1: libc::c_double = 2 as libc::c_int as libc::c_double - dx1 * dx1
            - dy1 * dy1 - dz1 * dz1;
        if attn1 > 0 as libc::c_int as libc::c_double {
        ...
        let mut dx3: libc::c_double = dx2;
        let mut dy3: libc::c_double = dy1;
        let mut dz3: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut attn3: libc::c_double = 2 as libc::c_int as libc::c_double - dx3 * dx3
            - dy3 * dy3 - dz3 * dz3;
        ...
        let mut aPoint_0: int8_t = 0x6 as libc::c_int as int8_t;
        let mut aScore_0: libc::c_double = xins;
        let mut bPoint_0: int8_t = 0x5 as libc::c_int as int8_t;
        let mut bScore_0: libc::c_double = yins;
        ...
        let mut wins_0: libc::c_double = 3 as libc::c_int as libc::c_double - inSum;
        if wins_0 < aScore_0 || wins_0 < bScore_0 {
            ...
            let mut c_2: int8_t = (aPoint_0 as libc::c_int & bPoint_0 as libc::c_int)
                as int8_t;
        ...
        let mut dx3_0: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut dy3_0: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut dz3_0: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut attn3_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx3_0 * dx3_0 - dy3_0 * dy3_0 - dz3_0 * dz3_0;
        ...
        let mut dx2_0: libc::c_double = dx3_0;
        let mut dy2_0: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut dz2_0: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut attn2_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx2_0 * dx2_0 - dy2_0 * dy2_0 - dz2_0 * dz2_0;
        ...
        let mut dx1_0: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut dy1_0: libc::c_double = dy3_0;
        let mut dz1_0: libc::c_double = dz2_0;
        let mut attn1_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx1_0 * dx1_0 - dy1_0 * dy1_0 - dz1_0 * dz1_0;
        ...
        dz0 = dz0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut attn0_0: libc::c_double = 2 as libc::c_int as libc::c_double - dx0 * dx0
            - dy0 * dy0 - dz0 * dz0;
        ...
        let mut p1: libc::c_double = xins + yins;
        ...
        let mut p2: libc::c_double = xins + zins;
        ...
        let mut p3: libc::c_double = yins + zins;
        if p3 > 1 as libc::c_int as libc::c_double {
            let mut score: libc::c_double = p3 - 1 as libc::c_int as libc::c_double;
            ...
            let mut score_0: libc::c_double = 1 as libc::c_int as libc::c_double - p3;
        ...
        if aIsFurtherSide == bIsFurtherSide {
            if aIsFurtherSide != 0 {
                ...
                ysv_ext0 = ysb + 1 as libc::c_int;
                zsv_ext0 = zsb + 1 as libc::c_int;
                let mut c_3: int8_t = (aPoint_1 as libc::c_int & bPoint_1 as libc::c_int)
                    as int8_t;
                ...
                ysv_ext0 = ysb;
                zsv_ext0 = zsb;
                let mut c_4: int8_t = (aPoint_1 as libc::c_int | bPoint_1 as libc::c_int)
                    as int8_t;
        ...
        let mut dx1_1: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut dy1_1: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut dz1_1: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut attn1_1: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx1_1 * dx1_1 - dy1_1 * dy1_1 - dz1_1 * dz1_1;
        ...
        let mut dx2_1: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut dy2_1: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut dz2_1: libc::c_double = dz1_1;
        let mut attn2_1: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx2_1 * dx2_1 - dy2_1 * dy2_1 - dz2_1 * dz2_1;
        ...
        let mut dx3_1: libc::c_double = dx2_1;
        let mut dy3_1: libc::c_double = dy1_1;
        let mut dz3_1: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 1.0f64 / 3.0f64;
        let mut attn3_1: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx3_1 * dx3_1 - dy3_1 * dy3_1 - dz3_1 * dz3_1;
        ...
        let mut dx4: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut dy4: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut dz4: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut attn4: libc::c_double = 2 as libc::c_int as libc::c_double - dx4 * dx4
            - dy4 * dy4 - dz4 * dz4;
        ...
        let mut dx5: libc::c_double = dx4;
        let mut dy5: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut dz5: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut attn5: libc::c_double = 2 as libc::c_int as libc::c_double - dx5 * dx5
            - dy5 * dy5 - dz5 * dz5;
        ...
        let mut dx6: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * (1.0f64 / 3.0f64);
        let mut dy6: libc::c_double = dy4;
        let mut dz6: libc::c_double = dz5;
        let mut attn6: libc::c_double = 2 as libc::c_int as libc::c_double - dx6 * dx6
            - dy6 * dy6 - dz6 * dz6;
    ...
    let mut attn_ext0: libc::c_double = 2 as libc::c_int as libc::c_double
    ...
    let mut attn_ext1: libc::c_double = 2 as libc::c_int as libc::c_double
...
pub unsafe extern "C" fn open_simplex_noise4(
    ...
    let mut stretchOffset: libc::c_double = (x + y + z + w) * -0.138196601125011f64;
    let mut xs: libc::c_double = x + stretchOffset;
    let mut ys: libc::c_double = y + stretchOffset;
    let mut zs: libc::c_double = z + stretchOffset;
    let mut ws: libc::c_double = w + stretchOffset;
    let mut xsb: libc::c_int = fastFloor(xs);
    let mut ysb: libc::c_int = fastFloor(ys);
    let mut zsb: libc::c_int = fastFloor(zs);
    let mut wsb: libc::c_int = fastFloor(ws);
    let mut squishOffset: libc::c_double = (xsb + ysb + zsb + wsb) as libc::c_double
        * 0.309016994374947f64;
    let mut xb: libc::c_double = xsb as libc::c_double + squishOffset;
    let mut yb: libc::c_double = ysb as libc::c_double + squishOffset;
    let mut zb: libc::c_double = zsb as libc::c_double + squishOffset;
    let mut wb: libc::c_double = wsb as libc::c_double + squishOffset;
    let mut xins: libc::c_double = xs - xsb as libc::c_double;
    let mut yins: libc::c_double = ys - ysb as libc::c_double;
    let mut zins: libc::c_double = zs - zsb as libc::c_double;
    let mut wins: libc::c_double = ws - wsb as libc::c_double;
    let mut inSum: libc::c_double = xins + yins + zins + wins;
    let mut dx0: libc::c_double = x - xb;
    let mut dy0: libc::c_double = y - yb;
    let mut dz0: libc::c_double = z - zb;
    let mut dw0: libc::c_double = w - wb;
    let mut dx_ext0: libc::c_double = 0.;
    let mut dy_ext0: libc::c_double = 0.;
    let mut dz_ext0: libc::c_double = 0.;
    ...
    if inSum <= 1 as libc::c_int as libc::c_double {
        ...
        let mut uins: libc::c_double = 1 as libc::c_int as libc::c_double - inSum;
        ...
        let mut dz1: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut dw1: libc::c_double = dw0 - 0 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut attn1: libc::c_double = 2 as libc::c_int as libc::c_double - dx1 * dx1
            - dy1 * dy1 - dz1 * dz1 - dw1 * dw1;
        if attn1 > 0 as libc::c_int as libc::c_double {
            attn1 *= attn1;
            value
                += attn1 * attn1
        ...
        let mut dy2: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut dz2: libc::c_double = dz1;
        let mut dw2: libc::c_double = dw1;
        let mut attn2: libc::c_double = 2 as libc::c_int as libc::c_double - dx2 * dx2
            - dy2 * dy2 - dz2 * dz2 - dw2 * dw2;
        if attn2 > 0 as libc::c_int as libc::c_double {
            attn2 *= attn2;
            value
                += attn2 * attn2
        ...
        let mut dz3: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut dw3: libc::c_double = dw1;
        let mut attn3: libc::c_double = 2 as libc::c_int as libc::c_double - dx3 * dx3
            - dy3 * dy3 - dz3 * dz3 - dw3 * dw3;
        if attn3 > 0 as libc::c_int as libc::c_double {
            attn3 *= attn3;
            value
                += attn3 * attn3
        ...
        let mut dx4: libc::c_double = dx2;
        let mut dy4: libc::c_double = dy1;
        let mut dz4: libc::c_double = dz1;
        let mut dw4: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut attn4: libc::c_double = 2 as libc::c_int as libc::c_double - dx4 * dx4
            - dy4 * dy4 - dz4 * dz4 - dw4 * dw4;
        if attn4 > 0 as libc::c_int as libc::c_double {
            attn4 *= attn4;
            value
                += attn4 * attn4
        ...
        let mut aPoint_0: int8_t = 0xe as libc::c_int as int8_t;
        let mut aScore_0: libc::c_double = xins;
        let mut bPoint_0: int8_t = 0xd as libc::c_int as int8_t;
        let mut bScore_0: libc::c_double = yins;
        if aScore_0 <= bScore_0 && zins < bScore_0 {
            bScore_0 = zins;
        ...
        let mut uins_0: libc::c_double = 4 as libc::c_int as libc::c_double - inSum;
        ...
        let mut dx4_0: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy4_0: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz4_0: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw4_0: libc::c_double = dw0
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn4_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx4_0 * dx4_0 - dy4_0 * dy4_0 - dz4_0 * dz4_0 - dw4_0 * dw4_0;
        ...
        let mut dx3_0: libc::c_double = dx4_0;
        let mut dy3_0: libc::c_double = dy4_0;
        let mut dz3_0: libc::c_double = dz0
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw3_0: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn3_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx3_0 * dx3_0 - dy3_0 * dy3_0 - dz3_0 * dz3_0 - dw3_0 * dw3_0;
        if attn3_0 > 0 as libc::c_int as libc::c_double {
            attn3_0 *= attn3_0;
            value
                += attn3_0 * attn3_0
        ...
        let mut dx2_0: libc::c_double = dx4_0;
        let mut dy2_0: libc::c_double = dy0
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz2_0: libc::c_double = dz4_0;
        let mut dw2_0: libc::c_double = dw3_0;
        let mut attn2_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx2_0 * dx2_0 - dy2_0 * dy2_0 - dz2_0 * dz2_0 - dw2_0 * dw2_0;
        if attn2_0 > 0 as libc::c_int as libc::c_double {
            attn2_0 *= attn2_0;
            value
                += attn2_0 * attn2_0
        ...
        let mut dx1_0: libc::c_double = dx0
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz1_0: libc::c_double = dz4_0;
        let mut dy1_0: libc::c_double = dy4_0;
        let mut dw1_0: libc::c_double = dw3_0;
        let mut attn1_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx1_0 * dx1_0 - dy1_0 * dy1_0 - dz1_0 * dz1_0 - dw1_0 * dw1_0;
        if attn1_0 > 0 as libc::c_int as libc::c_double {
            attn1_0 *= attn1_0;
            value
                += attn1_0 * attn1_0
        ...
        let mut aScore_1: libc::c_double = 0.;
        let mut aPoint_1: int8_t = 0;
        let mut aIsBiggerSide: libc::c_int = 1 as libc::c_int;
        let mut bScore_1: libc::c_double = 0.;
        let mut bPoint_1: int8_t = 0;
        let mut bIsBiggerSide: libc::c_int = 1 as libc::c_int;
        ...
        if xins + wins > yins + zins {
            let mut score: libc::c_double = xins + wins;
            ...
            let mut score_0: libc::c_double = yins + zins;
        ...
        let mut p1: libc::c_double = 2 as libc::c_int as libc::c_double - inSum + xins;
        ...
        let mut p2: libc::c_double = 2 as libc::c_int as libc::c_double - inSum + yins;
        ...
        let mut p3: libc::c_double = 2 as libc::c_int as libc::c_double - inSum + zins;
        ...
        let mut p4: libc::c_double = 2 as libc::c_int as libc::c_double - inSum + wins;
        ...
        if aIsBiggerSide == bIsBiggerSide {
            if aIsBiggerSide != 0 {
                let mut c1: int8_t = (aPoint_1 as libc::c_int | bPoint_1 as libc::c_int)
                    as int8_t;
                let mut c2: int8_t = (aPoint_1 as libc::c_int & bPoint_1 as libc::c_int)
                    as int8_t;
                if c1 as libc::c_int & 0x1 as libc::c_int == 0 as libc::c_int {
                    xsv_ext0 = xsb;
                    xsv_ext1 = xsb - 1 as libc::c_int;
        ...
        let mut dz1_1: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut dw1_1: libc::c_double = dw0 - 0 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut attn1_1: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx1_1 * dx1_1 - dy1_1 * dy1_1 - dz1_1 * dz1_1 - dw1_1 * dw1_1;
        if attn1_1 > 0 as libc::c_int as libc::c_double {
            attn1_1 *= attn1_1;
            value
                += attn1_1 * attn1_1
        ...
        let mut dy2_1: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut dz2_1: libc::c_double = dz1_1;
        let mut dw2_1: libc::c_double = dw1_1;
        let mut attn2_1: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx2_1 * dx2_1 - dy2_1 * dy2_1 - dz2_1 * dz2_1 - dw2_1 * dw2_1;
        if attn2_1 > 0 as libc::c_int as libc::c_double {
            attn2_1 *= attn2_1;
            value
                += attn2_1 * attn2_1
        ...
        let mut dz3_1: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut dw3_1: libc::c_double = dw1_1;
        let mut attn3_1: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx3_1 * dx3_1 - dy3_1 * dy3_1 - dz3_1 * dz3_1 - dw3_1 * dw3_1;
        if attn3_1 > 0 as libc::c_int as libc::c_double {
            attn3_1 *= attn3_1;
            value
                += attn3_1 * attn3_1
        ...
        let mut dx4_1: libc::c_double = dx2_1;
        let mut dy4_1: libc::c_double = dy1_1;
        let mut dz4_1: libc::c_double = dz1_1;
        let mut dw4_1: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 0.309016994374947f64;
        let mut attn4_1: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx4_1 * dx4_1 - dy4_1 * dy4_1 - dz4_1 * dz4_1 - dw4_1 * dw4_1;
        ...
        let mut dx5: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy5: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz5: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw5: libc::c_double = dw0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn5: libc::c_double = 2 as libc::c_int as libc::c_double - dx5 * dx5
            - dy5 * dy5 - dz5 * dz5 - dw5 * dw5;
        if attn5 > 0 as libc::c_int as libc::c_double {
            attn5 *= attn5;
            value
                += attn5 * attn5
        ...
        let mut dx6: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy6: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz6: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw6: libc::c_double = dw0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn6: libc::c_double = 2 as libc::c_int as libc::c_double - dx6 * dx6
            - dy6 * dy6 - dz6 * dz6 - dw6 * dw6;
        if attn6 > 0 as libc::c_int as libc::c_double {
            attn6 *= attn6;
            value
                += attn6 * attn6
        ...
        let mut dx7: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy7: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz7: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw7: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn7: libc::c_double = 2 as libc::c_int as libc::c_double - dx7 * dx7
            - dy7 * dy7 - dz7 * dz7 - dw7 * dw7;
        ...
        let mut dx8: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy8: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz8: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw8: libc::c_double = dw0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn8: libc::c_double = 2 as libc::c_int as libc::c_double - dx8 * dx8
            - dy8 * dy8 - dz8 * dz8 - dw8 * dw8;
        ...
        let mut dx9: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy9: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz9: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw9: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn9: libc::c_double = 2 as libc::c_int as libc::c_double - dx9 * dx9
            - dy9 * dy9 - dz9 * dz9 - dw9 * dw9;
        ...
        let mut dx10: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy10: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz10: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw10: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn10: libc::c_double = 2 as libc::c_int as libc::c_double - dx10 * dx10
            - dy10 * dy10 - dz10 * dz10 - dw10 * dw10;
        ...
        let mut aIsBiggerSide_0: libc::c_int = 1 as libc::c_int;
        let mut bScore_2: libc::c_double = 0.;
        let mut bPoint_2: int8_t = 0;
        let mut bIsBiggerSide_0: libc::c_int = 1 as libc::c_int;
        if xins + yins < zins + wins {
            aScore_2 = xins + yins;
        ...
        if xins + wins < yins + zins {
            let mut score_1: libc::c_double = xins + wins;
            ...
            let mut score_2: libc::c_double = yins + zins;
        ...
        let mut p1_0: libc::c_double = 3 as libc::c_int as libc::c_double - inSum + xins;
        ...
        let mut p2_0: libc::c_double = 3 as libc::c_int as libc::c_double - inSum + yins;
        ...
        let mut p3_0: libc::c_double = 3 as libc::c_int as libc::c_double - inSum + zins;
        ...
        let mut p4_0: libc::c_double = 3 as libc::c_int as libc::c_double - inSum + wins;
        ...
        if aIsBiggerSide_0 == bIsBiggerSide_0 {
            if aIsBiggerSide_0 != 0 {
                let mut c1_1: int8_t = (aPoint_2 as libc::c_int
                    & bPoint_2 as libc::c_int) as int8_t;
                let mut c2_1: int8_t = (aPoint_2 as libc::c_int
                    | bPoint_2 as libc::c_int) as int8_t;
                xsv_ext1 = xsb;
                xsv_ext0 = xsv_ext1;
                ysv_ext1 = ysb;
                ...
                dw_ext2 = dw0 - 1 as libc::c_int as libc::c_double
                    - 4 as libc::c_int as libc::c_double * 0.309016994374947f64;
                let mut c_4: int8_t = (aPoint_2 as libc::c_int & bPoint_2 as libc::c_int)
                    as int8_t;
                if c_4 as libc::c_int & 0x1 as libc::c_int != 0 as libc::c_int {
                    xsv_ext0 = xsb + 2 as libc::c_int;
                    xsv_ext1 = xsb + 1 as libc::c_int;
        ...
        let mut dx4_2: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy4_2: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz4_2: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw4_2: libc::c_double = dw0
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn4_2: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx4_2 * dx4_2 - dy4_2 * dy4_2 - dz4_2 * dz4_2 - dw4_2 * dw4_2;
        ...
        let mut dx3_2: libc::c_double = dx4_2;
        let mut dy3_2: libc::c_double = dy4_2;
        let mut dz3_2: libc::c_double = dz0
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw3_2: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn3_2: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx3_2 * dx3_2 - dy3_2 * dy3_2 - dz3_2 * dz3_2 - dw3_2 * dw3_2;
        ...
        let mut dx2_2: libc::c_double = dx4_2;
        let mut dy2_2: libc::c_double = dy0
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz2_2: libc::c_double = dz4_2;
        let mut dw2_2: libc::c_double = dw3_2;
        let mut attn2_2: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx2_2 * dx2_2 - dy2_2 * dy2_2 - dz2_2 * dz2_2 - dw2_2 * dw2_2;
        ...
        let mut dx1_2: libc::c_double = dx0
            - 3 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz1_2: libc::c_double = dz4_2;
        let mut dy1_2: libc::c_double = dy4_2;
        let mut dw1_2: libc::c_double = dw3_2;
        let mut attn1_2: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx1_2 * dx1_2 - dy1_2 * dy1_2 - dz1_2 * dz1_2 - dw1_2 * dw1_2;
        ...
        let mut dx5_0: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy5_0: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz5_0: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw5_0: libc::c_double = dw0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn5_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx5_0 * dx5_0 - dy5_0 * dy5_0 - dz5_0 * dz5_0 - dw5_0 * dw5_0;
        ...
        let mut dx6_0: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy6_0: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz6_0: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw6_0: libc::c_double = dw0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn6_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx6_0 * dx6_0 - dy6_0 * dy6_0 - dz6_0 * dz6_0 - dw6_0 * dw6_0;
        ...
        let mut dx7_0: libc::c_double = dx0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy7_0: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz7_0: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw7_0: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn7_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx7_0 * dx7_0 - dy7_0 * dy7_0 - dz7_0 * dz7_0 - dw7_0 * dw7_0;
        ...
        let mut dx8_0: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy8_0: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz8_0: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw8_0: libc::c_double = dw0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn8_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx8_0 * dx8_0 - dy8_0 * dy8_0 - dz8_0 * dz8_0 - dw8_0 * dw8_0;
        ...
        let mut dx9_0: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy9_0: libc::c_double = dy0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz9_0: libc::c_double = dz0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw9_0: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn9_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx9_0 * dx9_0 - dy9_0 * dy9_0 - dz9_0 * dz9_0 - dw9_0 * dw9_0;
        ...
        let mut dx10_0: libc::c_double = dx0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dy10_0: libc::c_double = dy0 - 0 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dz10_0: libc::c_double = dz0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut dw10_0: libc::c_double = dw0 - 1 as libc::c_int as libc::c_double
            - 2 as libc::c_int as libc::c_double * 0.309016994374947f64;
        let mut attn10_0: libc::c_double = 2 as libc::c_int as libc::c_double
            - dx10_0 * dx10_0 - dy10_0 * dy10_0 - dz10_0 * dz10_0 - dw10_0 * dw10_0;
    ...
    let mut attn_ext0: libc::c_double = 2 as libc::c_int as libc::c_double
        - dx_ext0 * dx_ext0 - dy_ext0 * dy_ext0 - dz_ext0 * dz_ext0 - dw_ext0 * dw_ext0;
    if attn_ext0 > 0 as libc::c_int as libc::c_double {
        attn_ext0 *= attn_ext0;
        value
            += attn_ext0 * attn_ext0
    ...
    let mut attn_ext1: libc::c_double = 2 as libc::c_int as libc::c_double
        - dx_ext1 * dx_ext1 - dy_ext1 * dy_ext1 - dz_ext1 * dz_ext1 - dw_ext1 * dw_ext1;
    if attn_ext1 > 0 as libc::c_int as libc::c_double {
        attn_ext1 *= attn_ext1;
        value
            += attn_ext1 * attn_ext1
    ...
    let mut attn_ext2: libc::c_double = 2 as libc::c_int as libc::c_double
        - dx_ext2 * dx_ext2 - dy_ext2 * dy_ext2 - dz_ext2 * dz_ext2 - dw_ext2 * dw_ext2;
