...
unsafe extern "C" fn transform_to_distance(mut sdf: *mut heman_image) {
    let mut width: libc::c_int = (*sdf).width;
    let mut height: libc::c_int = (*sdf).height;
    let mut size: libc::c_int = width * height;
    let mut ff: *mut libc::c_float = calloc(
        size as libc::c_ulong,
        ::std::mem::size_of::<libc::c_float>() as libc::c_ulong,
    ) as *mut libc::c_float;
    let mut dd: *mut libc::c_float = calloc(
        size as libc::c_ulong,
        ::std::mem::size_of::<libc::c_float>() as libc::c_ulong,
    ) as *mut libc::c_float;
    let mut zz: *mut libc::c_float = calloc(
        ((height + 1 as libc::c_int) * (width + 1 as libc::c_int)) as libc::c_ulong,
        ::std::mem::size_of::<libc::c_float>() as libc::c_ulong,
    ) as *mut libc::c_float;
    let mut ww: *mut uint16_t = calloc(
        size as libc::c_ulong,
    ...
    x = 0 as libc::c_int;
    while x < width {
        let mut f: *mut libc::c_float = ff.offset((height * x) as isize);
        let mut d: *mut libc::c_float = dd.offset((height * x) as isize);
        let mut z: *mut libc::c_float = zz
            .offset(((height + 1 as libc::c_int) * x) as isize);
    ...
    y_1 = 0 as libc::c_int;
    while y_1 < height {
        let mut f_0: *mut libc::c_float = ff.offset((width * y_1) as isize);
        let mut d_0: *mut libc::c_float = dd.offset((width * y_1) as isize);
        let mut z_0: *mut libc::c_float = zz
            .offset(((width + 1 as libc::c_int) * y_1) as isize);
...
unsafe extern "C" fn transform_to_coordfield(
    ...
    x = 0 as libc::c_int;
    while x < width {
        let mut pl1: *mut libc::c_float = calloc(
            (height * 2 as libc::c_int) as libc::c_ulong,
            ::std::mem::size_of::<libc::c_float>() as libc::c_ulong,
        ) as *mut libc::c_float;
        let mut pl2: *mut libc::c_float = calloc(
            (height * 2 as libc::c_int) as libc::c_ulong,
            ::std::mem::size_of::<libc::c_float>() as libc::c_ulong,
        ) as *mut libc::c_float;
        let mut f: *mut libc::c_float = ff.offset((height * x) as isize);
    ...
    y_1 = 0 as libc::c_int;
    while y_1 < height {
        let mut pl1_0: *mut libc::c_float = calloc(
            (width * 2 as libc::c_int) as libc::c_ulong,
            ::std::mem::size_of::<libc::c_float>() as libc::c_ulong,
        ) as *mut libc::c_float;
        let mut pl2_0: *mut libc::c_float = calloc(
            (width * 2 as libc::c_int) as libc::c_ulong,
            ::std::mem::size_of::<libc::c_float>() as libc::c_ulong,
        ) as *mut libc::c_float;
        let mut f_0: *mut libc::c_float = ff.offset((width * y_1) as isize);
...
pub unsafe extern "C" fn heman_distance_create_sdf(
    ...
    let mut positive: *mut heman_image = heman_image_create(
        (*src).width,
        (*src).height,
        1 as libc::c_int,
    );
    let mut negative: *mut heman_image = heman_image_create(
        (*src).width,
        (*src).height,
        1 as libc::c_int,
    );
    let mut size: libc::c_int = (*src).height * (*src).width;
    let mut pptr: *mut libc::c_float = (*positive).data;
    let mut nptr: *mut libc::c_float = (*negative).data;
    let mut sptr: *mut libc::c_float = (*src).data;
    ...
    let mut inv: libc::c_float = 1.0f32 / (*src).width as libc::c_float;
    pptr = (*positive).data;
    nptr = (*negative).data;
...
pub unsafe extern "C" fn heman_distance_identity_cpcf(
    ...
    let mut cdata: *mut libc::c_float = (*retval).data;
    let mut y: libc::c_int = 0 as libc::c_int;
    while y < height {
...
pub unsafe extern "C" fn heman_distance_create_cpcf(
    ...
    let mut i: libc::c_int = 0 as libc::c_int;
    while i < size {
        let mut val: libc::c_float = 0 as libc::c_int as libc::c_float;
    ...
    let mut coordfield: *mut heman_image = heman_distance_identity_cpcf(
        (*src).width,
        (*src).height,
    );
...
pub unsafe extern "C" fn heman_distance_from_cpcf(
    ...
    let mut udf: *mut heman_image = heman_image_create(
        (*cf).width,
        (*cf).height,
        1 as libc::c_int,
    );
    let mut dptr: *mut libc::c_float = (*udf).data;
    let mut sptr: *mut libc::c_float = (*cf).data;
    let mut scale: libc::c_float = (1.0f32 as libc::c_double
        / sqrt(
    ...
    while y < (*cf).height {
        ...
        while x < (*cf).width {
            let fresh7 = sptr;
            sptr = sptr.offset(1);
            let mut u: libc::c_float = *fresh7;
            let fresh8 = sptr;
            sptr = sptr.offset(1);
            let mut v: libc::c_float = *fresh8;
            let mut dist: libc::c_float = (sqrt(
