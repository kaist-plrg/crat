...
pub unsafe extern "C" fn kmQuaternionInverse(
    ...
    let mut l: libc::c_float = kmQuaternionLength(pIn);
...
pub unsafe extern "C" fn kmQuaternionNormalize(
    ...
    let mut length: libc::c_float = kmQuaternionLength(pIn);
...
pub unsafe extern "C" fn kmQuaternionRotationAxisAngle(
    ...
    let mut rad: libc::c_float = angle * 0.5f32;
    let mut scale: libc::c_float = sinf(rad);
    (*pOut).x = (*pV).x * scale;
    (*pOut).y = (*pV).y * scale;
    (*pOut).z = (*pV).z * scale;
    (*pOut).w = cosf(rad);
...
pub unsafe extern "C" fn kmQuaternionRotationMatrix(
    ...
    let mut pMatrix: *mut libc::c_float = 0 as *mut libc::c_float;
    ...
    let mut scale: libc::c_float = 0.0f32;
    let mut diagonal: libc::c_float = 0.0f32;
    if pIn.is_null() {
...
pub unsafe extern "C" fn kmQuaternionRotationPitchYawRoll(
    ...
    'c_3890: {
        if pitch <= 2 as libc::c_int as libc::c_float * 3.14159265358979323846f32
        {} else {
            __assert_fail(
                b"pitch <= 2*kmPI\0" as *const u8 as *const libc::c_char,
                b"kazmath/quaternion.c\0" as *const u8 as *const libc::c_char,
    ...
    'c_3803: {
        if roll <= 2 as libc::c_int as libc::c_float * 3.14159265358979323846f32
        {} else {
            __assert_fail(
                b"roll <= 2*kmPI\0" as *const u8 as *const libc::c_char,
                b"kazmath/quaternion.c\0" as *const u8 as *const libc::c_char,
    ...
    let mut sY: libc::c_float = sinf((yaw as libc::c_double * 0.5f64) as libc::c_float);
    let mut cY: libc::c_float = cosf((yaw as libc::c_double * 0.5f64) as libc::c_float);
    let mut sZ: libc::c_float = sinf((roll as libc::c_double * 0.5f64) as libc::c_float);
    let mut cZ: libc::c_float = cosf((roll as libc::c_double * 0.5f64) as libc::c_float);
    let mut sX: libc::c_float = sinf(
        (pitch as libc::c_double * 0.5f64) as libc::c_float,
    );
    let mut cX: libc::c_float = cosf(
        (pitch as libc::c_double * 0.5f64) as libc::c_float,
    );
...
pub unsafe extern "C" fn kmQuaternionSlerp(
    ...
    let mut dot: libc::c_float = kmQuaternionDot(q1, q2);
    let DOT_THRESHOLD: libc::c_double = 0.9995f64;
    ...
    let mut theta_0: libc::c_float = acos(dot as libc::c_double) as libc::c_float;
    let mut theta: libc::c_float = theta_0 * t;
...
pub unsafe extern "C" fn kmQuaternionRotationBetweenVec3(
    ...
    let mut v1: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
    let mut v2: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
    ...
    if a < 1e-6f32 - 1.0f32 {
        if fabs(kmVec3LengthSq(fallback) as libc::c_double) < 0.0001f64 {
            ...
            let mut axis: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
            let mut X: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
            ...
            if fabs(kmVec3LengthSq(&mut axis) as libc::c_double) < 0.0001f64 {
                let mut Y: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
        ...
        let mut s: libc::c_float = sqrtf(
            (1 as libc::c_int as libc::c_float + a) * 2 as libc::c_int as libc::c_float,
        );
        let mut invs: libc::c_float = 1 as libc::c_int as libc::c_float / s;
        let mut c: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
...
pub unsafe extern "C" fn kmQuaternionMultiplyVec3(
    ...
    let mut uv: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
    let mut uuv: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
    let mut qvec: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
    qvec.x = (*q).x;
    qvec.y = (*q).y;
    qvec.z = (*q).z;
...
pub unsafe extern "C" fn kmQuaternionGetPitch(
    ...
    let mut result: libc::c_float = atan2(
...
pub unsafe extern "C" fn kmQuaternionGetYaw(
    ...
    let mut result: libc::c_float = asin(
