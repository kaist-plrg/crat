...
pub unsafe extern "C" fn kmMat3Identity(mut pOut: *mut kmMat3) -> *mut kmMat3 {
    ...
    (*pOut).mat[4 as libc::c_int as usize] = (*pOut).mat[8 as libc::c_int as usize];
    (*pOut).mat[0 as libc::c_int as usize] = (*pOut).mat[4 as libc::c_int as usize];
    return pOut;
}
...
pub unsafe extern "C" fn kmMat3Inverse(
    ...
    let mut determinate: libc::c_float = kmMat3Determinant(pM);
...
pub unsafe extern "C" fn kmMat3RotationAxisAngle(
    ...
    let mut rcos: libc::c_float = cosf(radians);
    let mut rsin: libc::c_float = sinf(radians);
    (*pOut)
        .mat[0 as libc::c_int
        as usize] = rcos
