...
pub unsafe extern "C" fn kmAABB3Initialize(
    ...
    let mut origin: kmVec3 = kmVec3 { x: 0., y: 0., z: 0. };
...
pub unsafe extern "C" fn kmAABB3ContainsAABB(
    ...
    let mut result: libc::c_uint = 2 as libc::c_int as libc::c_uint;
    let mut found: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
    kmVec3Fill(
    ...
    let mut i: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
