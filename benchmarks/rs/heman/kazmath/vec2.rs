...
pub unsafe extern "C" fn kmVec2Normalize(
    ...
    let mut l: libc::c_float = 1.0f32 / kmVec2Length(pIn);
...
pub unsafe extern "C" fn kmVec2RotateBy(
    ...
    let radians: libc::c_float = kmDegreesToRadians(degrees);
    let cs: libc::c_float = cosf(radians);
    let sn: libc::c_float = sinf(radians);
...
pub unsafe extern "C" fn kmVec2DegreesBetween(
    ...
    let mut cross: libc::c_float = kmVec2Cross(&mut t1, &mut t2);
    let mut dot: libc::c_float = kmVec2Dot(&mut t1, &mut t2);
