...
pub unsafe extern "C" fn execv(
    ...
    snoopy_entrypoint_execve_wrapper_init(
        filename,
        argv,
...
pub unsafe extern "C" fn snoopy_entrypoint_execve_wrapper_init(
    mut filename: *const libc::c_char,
    mut argv: *const *mut libc::c_char,
    mut envp: *const *mut libc::c_char,
) {
...
pub unsafe extern "C" fn snoopy_entrypoint_execve_wrapper_exit() {
    snoopy_cleanup();
}
