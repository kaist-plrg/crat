...
extern "C" {
    ...
    fn snoopy_configfile_load(iniFilePath: *mut libc::c_char) -> libc::c_int;
    fn snoopy_tsrm_get_configuration() -> *mut snoopy_configuration_t;
...
pub static mut snoopy_configuration_configFileParsingEnabled: libc::c_int = 1
    as libc::c_int;
pub static mut snoopy_configuration_altConfigFilePath: *mut libc::c_char = 0
    as *const libc::c_char as *mut libc::c_char;
pub static mut snoopy_configuration_altConfigFilePathBuf: [libc::c_char; 4096] = unsafe {
    *::std::mem::transmute::<
        &[u8; 4096],
...
pub unsafe extern "C" fn snoopy_configuration_preinit_disableConfigFileParsing() {
    snoopy_configuration_configFileParsingEnabled = 0 as libc::c_int;
}
pub unsafe extern "C" fn snoopy_configuration_preinit_enableAltConfigFileParsing(
    altConfigFilePath: *mut libc::c_char,
) {
    if !altConfigFilePath.is_null() {
        snoopy_configuration_altConfigFilePath = altConfigFilePath;
    }
    snoopy_configuration_configFileParsingEnabled = 1 as libc::c_int;
}
pub unsafe extern "C" fn snoopy_configuration_preinit_setConfigFilePathFromEnv() {
    let mut valuePtr: *const libc::c_char = 0 as *const libc::c_char;
    valuePtr = getenv(b"SNOOPY_INI\0" as *const u8 as *const libc::c_char);
    if valuePtr.is_null() {
        return;
    }
    strncpy(
        snoopy_configuration_altConfigFilePathBuf.as_mut_ptr(),
        valuePtr,
        (4096 as libc::c_int - 1 as libc::c_int) as libc::c_ulong,
    );
    snoopy_configuration_altConfigFilePathBuf[(4096 as libc::c_int - 1 as libc::c_int)
        as usize] = 0 as libc::c_int as libc::c_char;
    if 0 as libc::c_int != access(valuePtr, 4 as libc::c_int) {
        snoopy_configuration_altConfigFilePathBuf[0 as libc::c_int
            as usize] = 0 as libc::c_int as libc::c_char;
        return;
    }
    snoopy_configuration_preinit_enableAltConfigFileParsing(
        snoopy_configuration_altConfigFilePathBuf.as_mut_ptr(),
    );
}
pub unsafe extern "C" fn snoopy_configuration_ctor() {
    if 0 as libc::c_int == snoopy_configuration_configFileParsingEnabled {
        return;
    }
    let mut CFG: *mut snoopy_configuration_t = snoopy_configuration_get();
    if !snoopy_configuration_altConfigFilePath.is_null() {
        snoopy_configfile_load(snoopy_configuration_altConfigFilePath);
    } else {
        snoopy_configfile_load((*CFG).configfile_path);
    };
}
pub unsafe extern "C" fn snoopy_configuration_dtor() {
    let mut CFG: *mut snoopy_configuration_t = 0 as *mut snoopy_configuration_t;
    CFG = snoopy_configuration_get();
    (*CFG)
        .configfile_path = b"/usr/local/etc/snoopy.ini\0" as *const u8
        as *const libc::c_char as *mut libc::c_char;
    if 1 as libc::c_int == (*CFG).message_format_malloced {
        free((*CFG).message_format as *mut libc::c_void);
        (*CFG).message_format_malloced = 0 as libc::c_int;
        (*CFG)
            .message_format = b"[uid:%{uid} sid:%{sid} tty:%{tty} cwd:%{cwd} filename:%{filename}]: %{cmdline}\0"
            as *const u8 as *const libc::c_char as *mut libc::c_char;
    }
    if 1 as libc::c_int == (*CFG).filter_chain_malloced {
        free((*CFG).filter_chain as *mut libc::c_void);
        (*CFG).filter_chain_malloced = 0 as libc::c_int;
        (*CFG)
            .filter_chain = b"\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char;
    }
    if 1 as libc::c_int == (*CFG).output_malloced {
        free((*CFG).output as *mut libc::c_void);
        (*CFG).output_malloced = 0 as libc::c_int;
        (*CFG)
            .output = b"devlog\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char;
    }
    if 1 as libc::c_int == (*CFG).output_arg_malloced {
        free((*CFG).output_arg as *mut libc::c_void);
        (*CFG).output_arg_malloced = 0 as libc::c_int;
        (*CFG)
            .output_arg = b"\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    }
    if 1 as libc::c_int == (*CFG).syslog_ident_format_malloced {
        free((*CFG).syslog_ident_format as *mut libc::c_void);
        (*CFG).syslog_ident_format_malloced = 0 as libc::c_int;
        (*CFG)
            .syslog_ident_format = b"snoopy\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char;
    }
}
pub unsafe extern "C" fn snoopy_configuration_setUninitialized(
    mut CFG: *mut snoopy_configuration_t,
) {
    (*CFG).initialized = 0 as libc::c_int;
}
pub unsafe extern "C" fn snoopy_configuration_setDefaults(
    mut CFG: *mut snoopy_configuration_t,
) {
    (*CFG).initialized = 1 as libc::c_int;
    (*CFG).configfile_enabled = 1 as libc::c_int;
    (*CFG)
        .configfile_path = b"/usr/local/etc/snoopy.ini\0" as *const u8
        as *const libc::c_char as *mut libc::c_char;
    (*CFG).configfile_found = 0 as libc::c_int;
    (*CFG).configfile_parsed = 0 as libc::c_int;
    (*CFG).error_logging_enabled = 0 as libc::c_int;
    (*CFG)
        .message_format = b"[uid:%{uid} sid:%{sid} tty:%{tty} cwd:%{cwd} filename:%{filename}]: %{cmdline}\0"
        as *const u8 as *const libc::c_char as *mut libc::c_char;
    (*CFG).message_format_malloced = 0 as libc::c_int;
    (*CFG).filtering_enabled = 1 as libc::c_int;
    (*CFG).filter_chain = b"\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    (*CFG).filter_chain_malloced = 0 as libc::c_int;
    (*CFG).output = b"devlog\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    (*CFG).output_malloced = 0 as libc::c_int;
    (*CFG).output_arg = b"\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    (*CFG).output_arg_malloced = 0 as libc::c_int;
...
pub unsafe extern "C" fn snoopy_configuration_get() -> *mut snoopy_configuration_t {
    let mut CFG: *mut snoopy_configuration_t = 0 as *mut snoopy_configuration_t;
    CFG = snoopy_tsrm_get_configuration();
    if 1 as libc::c_int != (*CFG).initialized {
