...
pub unsafe extern "C" fn BZ2_decompress(mut s: *mut DState) -> Int32 {
    ...
    match (*s).state {
        10 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as libc::c_int {
                    ...
                    retVal = 0 as libc::c_int;
                    current_block = 4607450712759353358;
                    break;
                } else {
                    (*s)
        ...
        12 => {
            current_block = 9958072204267899983;
        }
        13 => {
            current_block = 9687402154236457921;
        }
        14 => {
            current_block = 4205572633628121589;
        }
        15 => {
            current_block = 13434876886463901602;
        }
        16 => {
            current_block = 10011282279965471706;
        }
        17 => {
            current_block = 16788951267886524043;
        }
        18 => {
            current_block = 2812898005752719813;
        }
        19 => {
            current_block = 7768800475192486542;
        }
        20 => {
            current_block = 3042546053525465132;
        }
        21 => {
            current_block = 12253307996933714738;
        }
        22 => {
        ...
        28 => {
            current_block = 15899785762481701286;
        }
        29 => {
            current_block = 1319635546938210828;
        }
        30 => {
        ...
        33 => {
            current_block = 11622723065307320407;
        }
        34 => {
            current_block = 11096855422132564578;
        }
        35 => {
            current_block = 12551860512362278364;
        }
        36 => {
            current_block = 12071992436320021654;
        }
        37 => {
            current_block = 7839367399867461125;
        }
        38 => {
            current_block = 8218151169205044809;
        }
        39 => {
            current_block = 5293649487377342278;
        }
        40 => {
            current_block = 8449398242661280923;
        }
        41 => {
            current_block = 8827815838337934793;
        }
        42 => {
            current_block = 6165142913562364032;
        }
        43 => {
            current_block = 6027317434259729980;
        }
        44 => {
            current_block = 2794326842346554249;
        }
        45 => {
            current_block = 13862862630540390946;
        }
        46 => {
            current_block = 17252160251682948341;
        }
        47 => {
            current_block = 2042974208865915274;
        }
        48 => {
