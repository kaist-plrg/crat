    ...
    if !(ferror(stream) != 0) {
        if !(ferror(zStream) != 0) {
            ...
            if bzerr != 0 as libc::c_int {
                current_block = 7163659881829404556;
            } else {
                ...
                loop {
                    ...
                    if ferror(stream) != 0 {
                        current_block = 14972561737124701549;
                        break;
                    }
            ...
            match current_block {
                ...
                _ => {
                    ...
                    match bzerr {
                        -9 => {
                            current_block = 242536101439928150;
                            match current_block {
                                734694507375975489 => {
                                    panic(
                        ...
                        -3 => {
                            current_block = 12471658290238857871;
                            match current_block {
                                734694507375975489 => {
                                    panic(
                                        b"compress:unexpected error\0" as *const u8
                        ...
                        -6 => {}
                        _ => {
                            current_block = 734694507375975489;
                            match current_block {
                                734694507375975489 => {
                                    panic(
                                        b"compress:unexpected error\0" as *const u8
...
unsafe extern "C" fn uncompressStream(
    ...
    if !(ferror(stream) != 0) {
        if !(ferror(zStream) != 0) {
            's_37: loop {
                if !(1 as libc::c_int as Bool != 0) {
                    current_block = 8958916244828243863;
                    break;
                }
                bzf = BZ2_bzReadOpen(
                    &mut bzerr,
                ...
                if bzf.is_null() || bzerr != 0 as libc::c_int {
                    current_block = 2725182207652297546;
                    break;
                }
                streamNo += 1;
                streamNo;
                while bzerr == 0 as libc::c_int {
                    ...
                    if bzerr == -(5 as libc::c_int) {
                        current_block = 16719232878859844946;
                        break 's_37;
                    }
                    ...
                    if ferror(stream) != 0 {
                        current_block = 7106293986878879066;
                        break 's_37;
                    }
                }
                        ...
                        _ => {
                            match current_block {
                                2725182207652297546 => {
                                    ...
                                    match bzerr {
                                        -9 => {
                                            current_block = 3779556845191537975;
                                            match current_block {
                                                8018956737966028689 => {
                                                    panic(
                                        ...
                                        -6 => {}
                                        -4 => {
                                            current_block = 2830082839702427503;
                                            match current_block {
                                                8018956737966028689 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
                                        ...
                                        -3 => {
                                            current_block = 10904119327334279670;
                                            match current_block {
                                                8018956737966028689 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
                                        ...
                                        -7 => {
                                            current_block = 8802217481299164077;
                                            match current_block {
                                                8018956737966028689 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
                                        ...
                                        -5 => {
                                            current_block = 10470627358271391961;
                                            match current_block {
                                                8018956737966028689 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
                                        ...
                                        _ => {
                                            current_block = 8018956737966028689;
                                            match current_block {
                                                8018956737966028689 => {
                                                    panic(
                                                        b"decompress:unexpected error\0" as *const u8
...
unsafe extern "C" fn testStream(mut zStream: *mut FILE) -> Bool {
    ...
    if !(ferror(zStream) != 0) {
        's_29: loop {
            ...
            if bzf.is_null() || bzerr != 0 as libc::c_int {
                current_block = 9982622339874257398;
                break;
            }
            streamNo += 1;
            streamNo;
        ...
        match current_block {
            ...
            _ => {
                ...
                match bzerr {
                    ...
                    -6 => {}
                    -4 => {
                        current_block = 7396544619721570375;
                        match current_block {
                            578514208306663982 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
                    ...
                    -3 => {
                        current_block = 12538682772167414182;
                        match current_block {
                            578514208306663982 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
                    ...
                    -7 => {
                        current_block = 10684728594271327537;
                        match current_block {
                            578514208306663982 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
                    ...
                    -5 => {
                        current_block = 10742901966366957827;
                        match current_block {
                            578514208306663982 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
                    ...
                    _ => {
                        current_block = 578514208306663982;
                        match current_block {
                            578514208306663982 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8
    ...
    match srcMode {
        ...
        3 => {
            ...
            loop {
                ...
                {
                    current_block = 1209096710949571737;
                    break;
                }
                i += 1;
                i;
