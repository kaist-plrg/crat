...
pub unsafe extern "C" fn BZ2_bzCompressInit(
    ...
    if ((*s).arr1).is_null() || ((*s).arr2).is_null() || ((*s).ftab).is_null() {
        if !((*s).arr1).is_null() {
            ((*strm).bzfree).unwrap()((*strm).opaque, (*s).arr1 as *mut libc::c_void);
        }
        if !((*s).arr2).is_null() {
            ((*strm).bzfree).unwrap()((*strm).opaque, (*s).arr2 as *mut libc::c_void);
        }
        if !((*s).ftab).is_null() {
            ((*strm).bzfree).unwrap()((*strm).opaque, (*s).ftab as *mut libc::c_void);
        }
        if !s.is_null() {
            ((*strm).bzfree).unwrap()((*strm).opaque, s as *mut libc::c_void);
        }
        return -(3 as libc::c_int);
    }
...
pub unsafe extern "C" fn BZ2_bzCompressEnd(mut strm: *mut bz_stream) -> libc::c_int {
    ...
    ((*strm).bzfree).unwrap()((*strm).opaque, (*strm).state);
...
pub unsafe extern "C" fn BZ2_bzDecompressEnd(mut strm: *mut bz_stream) -> libc::c_int {
    ...
    if !((*s).tt).is_null() {
        ((*strm).bzfree).unwrap()((*strm).opaque, (*s).tt as *mut libc::c_void);
    }
    if !((*s).ll16).is_null() {
        ((*strm).bzfree).unwrap()((*strm).opaque, (*s).ll16 as *mut libc::c_void);
    }
    if !((*s).ll4).is_null() {
        ((*strm).bzfree).unwrap()((*strm).opaque, (*s).ll4 as *mut libc::c_void);
    }
    ((*strm).bzfree).unwrap()((*strm).opaque, (*strm).state);
    (*strm).state = 0 as *mut libc::c_void;
    return 0 as libc::c_int;
